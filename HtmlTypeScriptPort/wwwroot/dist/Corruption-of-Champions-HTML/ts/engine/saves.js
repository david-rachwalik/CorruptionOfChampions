    ...
    static loadGameObject(slot) {
        ...
        try {
            ...
            if (saveData.player.armor != undefined)
                liveData.player.armor = UTIL.lookupItem(saveData.player.armor.id);
            //Set items
            ...
            for (let i = 0; i < saveData.player.perks.length; i++) {
                if (UTIL.lookupPerk(saveData.player.perks[i].id) == undefined)
                    continue;
            ...
            for (let i = 0; i < saveData.player.statusEffects.length; i++) {
                liveData.player.createStatusEffect(UTIL.lookupStatusEffects(saveData.player.statusEffects[i].id), saveData.player.statusEffects[i].value1, saveData.player.statusEffects[i].value2, saveData.player.statusEffects[i].value3, saveData.player.statusEffects[i].value4);
            }
            //Key Items
            ...
            if (saveData.amilypregnancyIncubation == undefined) {
                ...
                liveData.amily.pregnancyIncubation = saveData.amilypregnancyIncubation;
            if (saveData.amilypregnancyType == undefined) {
                liveData.amily.pregnancyType = 0;
            }
            else
                liveData.amily.pregnancyType = saveData.amilypregnancyType;
            if (saveData.amilypregnancyEventArr == undefined) {
                liveData.amily.pregnancyEventArr = [];
            }
            else
                liveData.amily.pregnancyEventArr = saveData.amilypregnancyEventArr;
            if (saveData.amilybuttPregnancyIncubation == undefined) {
                liveData.amily.buttPregnancyIncubation = 0;
            }
            else
                liveData.amily.buttPregnancyIncubation = saveData.amilybuttPregnancyIncubation;
            if (saveData.amilybuttPregnancyType == undefined) {
                liveData.amily.buttPregnancyType = 0;
            }
            else
                liveData.amily.buttPregnancyType = saveData.amilybuttPregnancyType;
            if (saveData.amilypregnancyEventNum == undefined) {
                liveData.amily.pregnancyEventNum = 0;
            }
            else
                liveData.amily.pregnancyEventNum = saveData.amilypregnancyEventNum;
            //Spells
