    ...
    loadGameObject(slot) {
        ...
        try {
            ...
            if (saveData.player.weapon != undefined)
                liveData.player.weapon = lookupItem(saveData.player.weapon.id);
            if (saveData.player.armor != undefined)
                liveData.player.armor = lookupItem(saveData.player.armor.id);
            //Set items
            ...
            for (let i = 0; i < saveData.player.perks.length; i++) {
                if (lookupPerk(saveData.player.perks[i].id) == undefined)
                    continue;
            ...
            for (let i = 0; i < saveData.player.statusEffects.length; i++) {
                liveData.player.createStatusEffect(lookupStatusEffects(saveData.player.statusEffects[i].id), saveData.player.statusEffects[i].value1, saveData.player.statusEffects[i].value2, saveData.player.statusEffects[i].value3, saveData.player.statusEffects[i].value4);
            }
            //Key Items
