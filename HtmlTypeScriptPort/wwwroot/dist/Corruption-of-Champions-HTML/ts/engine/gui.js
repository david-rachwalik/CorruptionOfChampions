...
function displaySprite(spriteId = undefined) {
...
function addButton(pos, txt, func, arg1 = 0, arg2 = "", arg3 = "", tooltipText = "", tooltipHeader = "") {
    if (!tooltipHeader) {
        tooltipHeader = txt;
    }
...
export { getMousePosition, refreshStats, showStats, hideStats, hideUpDown, showUpDown, displaySprite, menu, addButton, addButtonDisabled, removeButton, doNext, doYesNo, isButtonVisible, showMenus, hideMenus, hideMenuButton, showMenuButton, setMenuButton };
