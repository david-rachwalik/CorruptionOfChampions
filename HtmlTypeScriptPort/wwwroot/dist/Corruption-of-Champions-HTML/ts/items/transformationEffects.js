...
ConsumableEffects.canineTFs = function (type) {
    ...
    if (type == 4) {
        ...
        if (player.cockTotal() > 0) {
            ...
            if (player.countCocksOfType(CockTypesEnum.DOG) > 0) {
                ...
                outputText("<br><br>");
                if (temp3 < .06)
                    outputText("Your " + Appearance.cockNoun(CockTypesEnum.DOG) + " feels unusually tight in your sheath as your knot grows.");
                if (temp3 >= .06 && temp3 <= .12)
                    outputText("Your " + Appearance.cockNoun(CockTypesEnum.DOG) + " pops free of your sheath, thickening nicely into a bigger knot.");
                if (temp3 > .12)
                    outputText("Your " + Appearance.cockNoun(CockTypesEnum.DOG) + " surges free of your sheath, swelling thicker with each passing second. Your knot bulges out at the base, growing far beyond normal.");
    ...
    if (type == 5) {
        if (player.balls <= 1) {
            ...
            if (player.ballSize <= 2)
                outputText("<br><br>A flash of warmth passes through you and a sudden weight develops in your groin. You pause to examine the changes and your roving fingers discover your " + player.ballsDescriptLight() + " have grown larger than a human's.");
            if (player.ballSize > 2)
    ...
    if (player.cocks.length > 0) {
        ...
        if (type != 4 && player.countCocksOfType(CockTypesEnum.DOG) > 0 && ((changes < changeLimit && rand(1.4) == 0) || type == 1)) {
            ...
            player.cocks[temp2].knotMultiplier += (temp3);
            if (temp3 < .06)
                outputText("<br><br>Your " + player.cockDescript(temp2) + " feels unusually tight in your sheath as your knot grows.");
            if (temp3 >= .06 && temp3 <= .12)
                outputText("<br><br>Your " + player.cockDescript(temp2) + " pops free of your sheath, thickening nicely into a bigger knot.");
            if (temp3 > .12)
                outputText("<br><br>Your " + player.cockDescript(temp2) + " surges free of your sheath, swelling thicker with each passing second. Your knot bulges out at the base, growing far beyond normal.");
            player.modStats("sen", .5, "lus", 5 * crit);
            changes++;
        }
        ...
        if (player.cumMultiplier < 2 && rand(2) == 0 && changes < changeLimit) {
            ...
            if (temp < player.cumMultiplier + .05 * crit) {
                ...
                if (player.balls > 0)
                    outputText("<br><br>You feel a churning in your " + player.ballsDescriptLight() + ". It quickly settles, leaving them feeling somewhat more dense.");
                if (crit > 1)
        ...
        if (type == 1) {
            ...
            if (temp2 > 2)
                outputText("<br><br>Your " + player.cockDescript(temp) + " tightens painfully, inches of bulging dick-flesh pouring out from your crotch as it grows longer. Thick pre forms at the pointed tip, drawn out from the pleasure of the change.");
            if (temp2 > 1 && temp2 <= 2)
                outputText("<br><br>Aching pressure builds within your crotch, suddenly releasing as an inch or more of extra dick-flesh spills out. A dollop of pre beads on the head of your enlarged " + player.cockDescript(temp) + " from the pleasure of the growth.");
            if (temp2 <= 1)
                outputText("<br><br>A slight pressure builds and releases as your " + player.cockDescript(temp) + " pushes a bit further out of your crotch.");
        }
    }
    //Female Stuff
    //Multiboobages
            ...
            if (player.breastRows.length < 3 && rand(2) == 0 && changes < changeLimit) {
                ...
                if (player.breastRows.length == 2) {
                    ...
                    if (player.breastRows[0].breastRating - 1 == 0)
                        ...
                        outputText("<br><br>A second set of breasts bulges forth under your current pair, stopping as they reach " + player.breastCup(temp) + "s.");
                ...
                if (player.breastRows.length > 2 && player.breastRows[0].breastRating > player.breastRows.length) {
                    ...
                    if (player.breastRows[temp].breastRating == 0)
                        ...
                        outputText("<br><br>Your abdomen tingles and twitches as a new row of " + player.breastCup(temp) + " " + player.breastDescript(temp) + " sprouts below your others.");
                    outputText(" A sensitive nub grows on the summit of each new tit, becoming a new nipple.");
                    changes++;
                }
                ...
                if (player.cor < 66)
                    ...
                    if (player.cor < 80) {
                        if (player.vaginas.length > 0)
                            ...
                            outputText("<br>You reluctantly pry your hand from your aching " + player.cockDescript(0) + " as you drag yourself out of your fantasy.");
                    }
                    else {
    ...
    if (type == 3 && player.hairColor != "midnight black") {
        if (player.skinType == SKIN_TYPE_FUR)
            ...
            outputText("<b><br><br>Your " + player.skinDesc + " itches like crazy as fur grows out from it, coating your body. It's incredibly dense and black as the middle of a moonless night.</b>");
...
ConsumableEffects.cowTFs = function (tainted, enhanced) {
    ...
    if (changes < changeLimit && rand(3) == 0) {
        ...
        if (temp <= 0)
            ...
            if (rand(2) == 0)
                outputText("<br><br>There is a slight pain as you feel your muscles shift somewhat.  Their appearance does not change much, but you feel much stronger.", false);
            else
                outputText("<br><br>You feel your muscles tighten and clench as they become slightly more pronounced.", false);
    ...
    if (changes < changeLimit && rand(3) == 0) {
        ...
        if (temp <= 0)
            ...
            if (rand(2) == 0)
                outputText("<br><br>You feel your insides toughening up; it feels like you could stand up to almost any blow.", false);
            else
                outputText("<br><br>Your bones and joints feel sore for a moment, and before long you realize they've gotten more durable.", false);
    ...
    if (player.cocks.length > 0 && rand(2) == 0 && !gameFlags[HYPER_HAPPY]) {
        ...
        if (player.cocks[temp].cockLength < 2) {
            ...
            if (player.cockTotal() == 1 && !player.hasVagina()) {
                ...
                if (player.balls > 0)
                    outputText("  At the same time, your " + player.ballsDescriptLight() + " fall victim to the same sensation; eagerly swallowed whole by your crotch.", false);
    ...
    if (((tainted && player.biggestTitSize() <= 11) || (!tainted && player.biggestTitSize() <= 5)) && changes < changeLimit && (rand(3) == 0 || enhanced)) {
        if (rand(2) == 0)
            outputText("<br><br>Your " + player.breastDescript(0) + " tingle for a moment before becoming larger.", false);
        else
            outputText("<br><br>You feel a little weight added to your chest as your " + player.breastDescript(0) + " seem to inflate and settle in a larger size.", false);
    ...
    if (changes < changeLimit && player.hairType == HAIR_FEATHER && rand(4) == 0) {
        //(long):
        if (player.hairLength >= 6)
            outputText("<br><br>A lock of your downy-soft feather-hair droops over your eye.  Before you can blow the offending down away, you realize the feather is collapsing in on itself.  It continues to curl inward until all that remains is a normal strand of hair.  <b>Your hair is no longer feathery!</b>", false);
        //(short)
        else
    ...
    if (enhanced) {
        ...
        if (player.breastRows[0].nipplesPerBreast == 1) {
            ...
            if (player.breastRows.length >= 3 && player.breastRows[2].nipplesPerBreast == 1) {
                ...
                if (player.bRows() == 3)
                    outputText("third row of " + player.breastDescript(2) + " mutates along with its sisters, sprouting into a wonderland of nipples.", false);
        ...
        //QUAD DAMAGE IF WEIRD SHIT BROKE BEFORE
            ...
            if (rand(2) == 0)
                outputText("<br><br>A wave of pleasure passes through your chest as your " + player.breastDescript(0) + " start leaking milk from a massive jump in production.", false);
            else
                outputText("<br><br>Something shifts inside your " + player.breastDescript(0) + " and they feel MUCH fuller and riper.  You know that you've started producing much more milk.", false);
    ...
    //If breasts are already lactating and the player is not lactating beyond a reasonable level, they start lactating more:
        ...
        if (tainted && player.breastRows[0].lactationMultiplier > 1 && player.breastRows[0].lactationMultiplier < 5 && changes < changeLimit && (rand(3) == 0 || enhanced)) {
            if (rand(2) == 0)
                outputText("<br><br>A wave of pleasure passes through your chest as your " + player.breastDescript(0) + " start producing more milk.", false);
            else
                outputText("<br><br>Something shifts inside your " + player.breastDescript(0) + " and they feel fuller and riper.  You know that you've started producing more milk.", false);
        ...
        if (!tainted) {
            ...
            if ((player.breastRows[0].lactationMultiplier > 2 && player.findStatusEffect(StatusEffects.Feeder) >= 0) || player.breastRows[0].lactationMultiplier > 5) {
                if (rand(2) == 0)
                    outputText("<br><br>Your breasts suddenly feel less full, it seems you aren't lactating at quite the level you were.", false);
                else
                    outputText("<br><br>The insides of your breasts suddenly feel bloated.  There is a spray of milk from them, and they settle closer to a more natural level of lactation.", false);
                changes++;
                player.dynStats("sen", .5);
    ...
    if (player.hasVagina()) {
        if (player.vaginas[0].vaginalLooseness < VAGINA_LOOSENESS_LOOSE && changes < changeLimit && rand(2) == 0) {
            ...
            if (player.findStatusEffect(StatusEffects.CuntStretched) < 0)
                player.createStatusEffect(StatusEffects.CuntStretched, 0, 0, 0, 0);
    ...
    if (tainted && player.tailType != TAIL_TYPE_COW && changes < changeLimit && rand(3) == 0) {
        if (player.tailType == TAIL_TYPE_NONE)
            outputText("<br><br>You feel the flesh above your " + player.buttDescript() + " knotting and growing.  It twists and writhes around itself before flopping straight down, now shaped into a distinctly bovine form.  You have a <b>cow tail</b>.", false);
        else {
    ...
    if (((enhanced && player.tallness < 96) || player.tallness < 84) && changes < changeLimit && rand(2) == 0) {
        ...
        if (temp < 5)
            outputText("<br><br>You shift uncomfortably as you realize you feel off balance.  Gazing down, you realize you have grown SLIGHTLY taller.", false);
        if (temp >= 5 && temp < 7)
            outputText("<br><br>You feel dizzy and slightly off, but quickly realize it's due to a sudden increase in height.", false);
        if (temp == 7)
            outputText("<br><br>Staggering forwards, you clutch at your head dizzily.  You spend a moment getting your balance, and stand up, feeling noticeably taller.", false);
    ...
    if (enhanced && (player.skinDesc != "fur" || player.furColor != "black and white spotted")) {
        if (player.skinDesc != "fur")
            outputText("<br><br>Your " + player.skinDesc + " itches intensely.  You scratch and scratch, but it doesn't bring any relief.  Fur erupts between your fingers, and you watch open-mouthed as it fills in over your whole body.  The fur is patterned in black and white, like that of a cow.  The color of it even spreads to your hair!  <b>You have cow fur!</b>", false);
        else
            outputText("<br><br>A ripple spreads through your fur as some patches darken and others lighten.  After a few moments you're left with a black and white spotted pattern that goes the whole way up to the hair on your head!  <b>You've got cow fur!</b>", false);
        player.skinDesc = "fur";
        player.skinAdj = "";
        player.skinType = SKIN_TYPE_FUR;
    ...
    if (rand(3) == 0)
        outputText(player.modFem(79, 3), false);
    if (rand(3) == 0)
        outputText(player.modThickness(70, 4), false);
    if (rand(5) == 0)
        outputText(player.modTone(10, 5), false);
...
ConsumableEffects.succubiDelight = function (tainted) {
    ...
    if (rand(1.5) == 0 && changes < changeLimit && player.balls > 0) {
        ...
        if (player.ballSize > 10)
            player.ballSize -= .5;
        //And MUCH slower
        if (player.ballSize > 24)
            player.ballSize -= .3;
        //Texts
        if (player.ballSize <= 2)
            outputText("<br><br>A flash of warmth passes through you and a sudden weight develops in your groin. You pause to examine the changes and your roving fingers discover your " + player.ballsDescriptLight() + " have grown larger than a human's.", false);
        if (player.ballSize > 2)
    ...
    if (changes < changeLimit && rand(2) == 0 && player.cocks.length > 0) {
        if (player.cumMultiplier < 6 && rand(2) == 0 && changes < changeLimit) {
            ...
            if (temp < player.cumMultiplier + .4 * crit) {
                ...
                //Flavor text
                if (player.balls == 0)
                    outputText("<br><br>You feel a churning inside your body as something inside you changes.", false);
                if (player.balls > 0)
                    outputText("<br><br>You feel a churning in your " + player.ballsDescriptLight() + ". It quickly settles, leaving them feeling somewhat more dense.", false);
                if (crit > 1)
            ...
            if (rand(2) == 0 && changes < changeLimit) {
                ...
                if (player.breastRows.length == 1) {
                    ...
                    if (player.breastRows[0].breastRating > 3) {
                        ...
                        if (temp == 1)
                            outputText("<br><br>You feel a weight lifted from you, and realize your " + player.breastDescript(0) + " have shrunk to a " + player.breastCup(0) + ".");
                        if (temp == 2)
                            outputText("<br><br>You feel significantly lighter. Looking down, you realize your breasts are MUCH smaller, down to " + player.breastCup(0) + "s.");
                        changes++;
                    }
                }
                //multiple
...
ConsumableEffects.felineTFs = function () {
            ...
            for (var k = 0; k < player.breastRows.length; k++) {
                ...
                if (player.breastRows[k].breastRating > temp2) {
                    ...
                    if (player.breastRows[k].breastRating > 10) {
                        ...
                        if (temp3 == 0)
                            outputText("<br><br>The " + player.breastDescript(0) + " on your chest wobble for a second, then tighten up, losing several cup-sizes in the process!");
                        else
                            outputText(" The change moves down to your " + num2Text2(k + 1) + " row of " + player.breastDescript(0) + ". They shrink greatly, losing a couple cup-sizes.");
                    }
                    //Small change
                    else {
                        player.breastRows[k].breastRating -= 1;
                        if (temp3 == 0)
                            outputText("<br><br>All at once, your sense of gravity shifts. Your back feels a sense of relief, and it takes you a moment to realize your " + player.breastDescript(k) + " have shrunk!");
                        else
                            outputText(" Your " + num2Text2(k + 1) + " row of " + player.breastDescript(k) + " gives a tiny jiggle as it shrinks, losing some off its mass.");
                    }
    ...
    if (player.countCocksOfType(CockTypesEnum.CAT) > 0 && rand(3) == 0 && changes < changeLimit && !hyperHappy) {
        ...
        if (temp == 1) {
            ...
            if (temp2 == 1)
                outputText(" Upon further inspection, all your " + Appearance.cockNoun(CockTypesEnum.CAT) + "s have shrunk!");
            changes++;
        }
    }
    //------------
    ...
    if (changes < changeLimit) {
        if (rand(2) == 0)
            outputText(player.modThickness(5, 2), false);
        if (rand(2) == 0)
            outputText(player.modTone(76, 2), false);
        if (player.gender < 2) {
            if (rand(2) == 0)
...
ConsumableEffects.goblinTFs = function () {
    ...
    if (player.skinType != SKIN_TYPE_PLAIN && changes < changeLimit && rand(4) == 0 && player.faceType == FACE_HUMAN) {
        ...
        if (player.skinType > SKIN_TYPE_SCALES)
            outputText("<br><br>Your " + player.skinDesc + " itches incessantly, and as you scratch it shifts and changes, becoming normal human-like skin. <b>Your skin is once again normal!</b>");
        player.skinAdj = "";
...
ConsumableEffects.humanTFs = function () {
    ...
    if ((player.skinTone != "tan" && player.skinTone != "olive" && player.skinTone != "dark" && player.skinTone != "light") && changes < changeLimit && rand(5) == 0) {
        ...
        if (player.skinType == SKIN_TYPE_FUR)
            outputText("the skin under your " + player.furColor + " " + player.skinDesc, false);
        else
    ...
    if (player.hasVagina() && rand(3) == 0 && changes < changeLimit) {
        ...
        if (player.fertility < 10 && player.gender >= 2)
            player.fertility = 10;
...
ConsumableEffects.impTFs = function () {
    ...
    if (changes < changeLimit && rand(10) == 0 && player.skinTone != "red") {
        if (player.skinType == SKIN_TYPE_FUR)
            ...
            outputText("<br><br>Your " + player.skinDesc + " ");
        if (rand(2) == 0)
            player.skinTone = "red";
        else
...
ConsumableEffects.lizardTFs = function () {
    ...
    if (player.lib < 100 && changes < changeLimit && rand(3) == 0) {
        ...
        //(COOCH)
            ...
            outputText("puddling in your " + player.vaginaDescript(0) + ".  An instinctive desire to mate and lay eggs spreads through you, increasing your lust and boosting your sex-drive.", false);
        //(TARDS)
        else
            outputText("puddling in your featureless crotch for a split-second before it slides into your " + player.assDescript() + ".  You want to be fucked, filled, and perhaps even gain a proper gender again.  Through the lust you realize your sex-drive has been permanently increased.", false);
        //+3 lib if less than 50
        if (player.lib < 50)
            player.dynStats("lib", 3);
    ...
    if (player.countCocksOfType(CockTypesEnum.LIZARD) == 0 && player.cockTotal() > 0 && changes < changeLimit && rand(4) == 0) {
        ...
        if (player.hasSheath()) {
            ...
            if (!player.hasSheath())
                outputText("<br><br>Your sheath tightens and starts to smooth out, revealing ever greater amounts of your " + player.cockDescript(temp2) + "'s lower portions.  After a few moments <b>your groin is no longer so animalistic – the sheath is gone.</b>", false);
        }
        else
            player.cocks[temp2].cockType = CockTypesEnum.LIZARD;
        changes++;
    ...
    if (player.biggestTitSize() >= 1 && player.gender == 1 && changes < changeLimit && rand(3) == 0) {
        ...
        //(NOT HUEG < 4)
            ...
            outputText("<br><br>In an instant, your chest compacts in on itself, consuming every ounce of breast-flesh.  You're left with a  smooth, masculine torso, though your nipples remain.", false);
        //(BOTH – no new PG)
    ...
    if (player.biggestLactation() >= 1 && changes < changeLimit && rand(4) == 0) {
        if (player.totalNipples() == 2)
            outputText("<br><br>Both of your", false);
        else
            outputText("<br><br>All of your many", false);
    ...
    if (player.lowerBody != LOWER_BODY_TYPE_LIZARD && changes < changeLimit && rand(5) == 0) {
        //Hooves -
        if (player.lowerBody == LOWER_BODY_TYPE_HOOFED)
            outputText("<br><br>You scream in agony as you feel your hooves crack and break apart, beginning to rearrange.  Your legs change to a digitigrade shape while your feet grow claws and shift to have three toes on the front and a smaller toe on the heel.", false);
        //TAURS -
        else if (player.isTaur())
            outputText("<br><br>Your lower body is wracked by pain!  Once it passes, you discover that you're standing on digitigrade legs with lizard-like claws.", false);
        //feet types -
            ...
            outputText("<br><br>You scream in agony as you feel the bones in your legs break and begin to rearrange. They change to a digitigrade shape while your feet grow claws and shift to have three toes on the front and a smaller toe on the heel.", false);
        //Else –
        else
            outputText("<br><br>Pain rips through your " + player.legs() + ", morphing and twisting them until the bones rearrange into a digitigrade configuration.  The strange legs have three-toed, clawed feet, complete with a small vestigial claw-toe on the back for added grip.", false);
    ...
    if (player.tailType != TAIL_TYPE_LIZARD && player.lowerBody == LOWER_BODY_TYPE_LIZARD && changes < changeLimit && rand(5) == 0) {
        //No tail
        if (player.tailType == TAIL_TYPE_NONE)
            outputText("<br><br>You drop onto the ground as your spine twists and grows, forcing the flesh above your " + player.assDescript() + " to bulge out.  New bones form, one after another, building a tapered, prehensile tail onto the back of your body.  <b>You now have a reptilian tail!</b>", false);
        //Yes tail
        else
            outputText("<br><br>You drop to the ground as your tail twists and grows, changing its shape in order to gradually taper to a point.  It flicks back and forth, prehensile and totally under your control.  <b>You now have a reptilian tail.</b>", false);
...
ConsumableEffects.harpyTFs = function (type) {
    ...
    if (player.spe < 100 && rand(3) == 0) {
        changes++;
        if (player.spe >= 75)
            outputText("<br><br>A familiar chill runs down your spine. Your muscles feel like well oiled machinery, ready to snap into action with lightning speed.", false);
        else
            outputText("<br><br>A chill runs through your spine, leaving you feeling like your reflexes are quicker and your body faster.", false);
    ...
    if (player.tou > 50 && rand(3) == 0 && changes < changeLimit) {
        changes++;
        if (rand(2) == 0)
            outputText("<br><br>A nice, slow warmth rolls from your gut out to your limbs, flowing through them before dissipating entirely. As it leaves, you note that your body feels softer and less resilient.", false);
        else
            outputText("<br><br>You feel somewhat lighter, but consequently more fragile.  Perhaps your bones have changed to be more harpy-like in structure?", false);
        player.dynStats("tou", -1);
    }
    //antianemone corollary:
    if (changes < changeLimit && player.hairType == 4 && rand(2) == 0) {
    ...
    if (player.str < 70 && rand(3) == 0 && changes < changeLimit) {
        ...
        //(low str)
        if (player.str < 40)
            outputText("<br><br>Shivering, you feel a feverish sensation that reminds you of the last time you got sick. Thankfully, it passes swiftly, leaving slightly enhanced strength in its wake.", false);
        //(hi str – 50+)
        else
            outputText("<br><br>Heat builds in your muscles, their already-potent mass shifting slightly as they gain even more strength.", false);
        //Faster until 40 str.
        if (player.str < 40)
    ...
    if ((player.lib < 90 || rand(3) == 0) && rand(3) == 0 && changes < changeLimit) {
        ...
        if (player.lib < 40) {
            ...
            if (player.hasVagina())
                outputText(" The moistness of your " + player.vaginaDescript() + " seems to agree.", false);
            else if (player.hasCock())
                outputText(" The hardness of " + player.sMultiCockDesc() + " seems to agree.", false);
            player.changeLust("lus", 5);
        }
        //(sub 75 lib)
        else if (player.lib < 75)
            outputText("<br><br>Heat, blessed heat, works through you from head to groin, leaving you to shudder and fantasize about the sex you could be having right now.<br><br>", false);
        //(hi lib)
        else if (player.lib < 90)
            outputText("<br><br>Sexual need courses through you, flushing your skin with a reddish hue while you pant and daydream of the wondrous sex you should be having right now.<br><br>", false);
        //(90+)
        else
            outputText("<br><br>You groan, something about the seed rubbing your libido in just the right way to make you horny. Panting heavily, you sigh and fantasize about the sex you could be having.<br><br>", false);
        //(fork to fantasy)
        if (player.lib >= 40) {
    ...
    if (player.gender == 0 || (!player.hasVagina() && changes < changeLimit && rand(3) == 0)) {
        ...
        //(balls)
        if (player.balls > 0)
            outputText("<br><br>An itch starts behind your " + player.ballsDescriptLight() + ", but before you can reach under to scratch it, the discomfort fades. A moment later a warm, wet feeling brushes your " + player.sackDescript() + ", and curious about the sensation, <b>you lift up your balls to reveal your new vagina.</b>", false);
        //(dick)
        else if (player.hasCock())
            outputText("<br><br>An itch starts on your groin, just below your " + player.multiCockDescriptLight() + ". You pull your manhood aside to give you a better view, and you're able to watch as <b>your skin splits to give you a new vagina, complete with a tiny clit.</b>", false);
        //(neither)
        else
            outputText("<br><br>An itch starts on your groin and fades before you can take action. Curious about the intermittent sensation, <b>you peek under your " + player.armor.equipmentName + " to discover your brand new vagina, complete with pussy lips and a tiny clit.</b>", false);
        player.createVagina();
        player.clitLength = .25;
    ...
    if (player.lowerBody != LOWER_BODY_TYPE_HARPY && changes < changeLimit && (type == 1 || player.tailType == TAIL_TYPE_HARPY) && rand(4) == 0) {
        //(biped/taur)
        if (!player.isGoo())
            outputText("<br><br>Your " + player.legs() + " creak ominously a split-second before they go weak and drop you on the ground. They go completely limp, twisting and reshaping before your eyes in ways that make you wince. Your lower body eventually stops, but the form it's settled on is quite thick in the thighs. Even your " + player.feet() + " have changed.  ", false);
        //goo
        else
            outputText("<br><br>Your gooey undercarriage loses some of its viscosity, dumping you into the puddle that was once your legs. As you watch, the fluid pulls together into a pair of distinctly leg-like shapes, solidifying into a distinctly un-gooey form. You've even regained a pair of feet!  ", false);
    ...
    if (player.tailType != TAIL_TYPE_HARPY && changes < changeLimit && (type == 1 || player.wingType == WING_TYPE_FEATHERED_LARGE) && rand(4) == 0) {
        //(tail)
        if (player.tailType > TAIL_TYPE_NONE)
            outputText("<br><br>Your tail shortens, folding into the crack of your " + player.buttDescript() + " before it disappears. A moment later, a fan of feathers erupts in its place, fluffing up and down instinctively every time the breeze shifts. <b>You have a feathery harpy tail!</b>", false);
        //(no tail)
        else
            outputText("<br><br>A tingling tickles the base of your spine, making you squirm in place. A moment later, it fades, but a fan of feathers erupts from your " + player.skinDesc + " in its place. The new tail fluffs up and down instinctively with every shift of the breeze. <b>You have a feathery harpy tail!</b>", false);
    ...
    if (player.wingType != WING_TYPE_FEATHERED_LARGE && player.wingType > WING_TYPE_NONE && changes < changeLimit && rand(4) == 0) {
        if (player.wingType != WING_TYPE_SHARK_FIN)
            outputText("<br><br>Sensation fades from your " + player.wingDesc + " wings slowly but surely, leaving them dried out husks that break off to fall on the ground. Your back closes up to conceal the loss, as smooth and unbroken as the day you entered the portal.", false);
        else
            outputText("<br><br>Sensation fades from your large fin slowly but surely, leaving it a dried out husk that breaks off to fall on the ground. Your back closes up to conceal the loss, as smooth and unbroken as the day you entered the portal.", false);
        player.wingType = WING_TYPE_NONE;
    ...
    if (changes == 0)
        outputText("<br><br>Aside from being a tasty treat, it doesn't seem to do anything to you this time.", false);
    player.refillHunger(10);
    gameFlags[TIMES_TRANSFORMED] += changes;
};
...
ConsumableEffects.minotaurTFs = function () {
        ...
        //Shrink boobages till they are normal
            ...
            if (player.breastRows.length == 1) {
                ...
                if (player.breastRows[0].breastRating >= 1) {
                    ...
                    //Talk about shrinkage
                    if (temp == 1)
                        outputText("<br><br>You feel a weight lifted from you, and realize your " + player.breastDescript(0) + " have shrunk to " + player.breastCup(0) + "s.", false);
                    if (temp == 2)
                        outputText("<br><br>You feel significantly lighter.  Looking down, you realize your breasts are MUCH smaller, down to " + player.breastCup(0) + "s.", false);
                    changes++;
                }
            }
            //multiple
                ...
                if (temp2 == 2)
                    outputText("<br>You feel so much lighter after the change.", false);
                if (temp2 == 3)
                    outputText("<br>Without the extra weight you feel particularly limber.", false);
                if (temp2 >= 4)
                    outputText("<br>It feels as if the weight of the world has been lifted from your shoulders, or in this case, your chest.", false);
                if (temp2 > 0)
                    changes++;
            }
        }
    ...
    if (changes < changeLimit && rand(2) == 0 && player.cocks.length > 0) {
        ...
        if (selectedCock != -1) {
            ...
            if (player.cocks[selectedCock].cockThickness < 5) {
                ...
                if (temp > 6)
                    outputText("<br><br>Gasping in sudden pleasure, your " + player.cockDescript(selectedCock) + " surges free of its sheath, emerging with over half a foot of new dick-flesh.", false);
                if (temp <= 6 && temp >= 3)
                    outputText("<br><br>You pant in delight as a few inches of " + player.cockDescript(selectedCock) + " pop free from your sheath, the thick new horse-flesh still slick and sensitive.", false);
                if (temp < 3)
                    outputText("<br><br>Groaning softly, you feel a pleasurable change in your groin.  Looking down, you see [oneCock] grow slightly longer.", false);
            ...
            if (player.hornType == HORNS_COW_MINOTAUR) {
                ...
                //Males horns get 'uge.
                    ...
                    if (temp == 0)
                        changes--;
                    if (temp == 1)
                        outputText("<br><br>An aching pressure builds in your temples as you feel your horns push another inch of length from your skull.  ", false);
                    if (temp == 2)
                        outputText("<br><br>A powerful headache momentarily doubles you over.  With painful slowness, you feel your horns push another two inches of length out from your brow, gradually thickening as they grow.  ", false);
                    if (temp == 3)
    ...
    if (rand(4) == 0)
        outputText(player.modFem(5, 10), false);
    if (rand(4) == 0)
        outputText(player.modTone(85, 3), false);
    if (rand(4) == 0)
        outputText(player.modThickness(70, 4), false);
    //Default
    if (changes == 0) {
...
ConsumableEffects.snakeTFs = function () {
    ...
    if (player.wingType > WING_TYPE_NONE && rand(3) == 0 && changes < changeLimit) {
        if (player.wingType == WING_TYPE_SHARK_FIN)
            outputText("<br><br>A wave of tightness spreads through your back, and it feels as if someone is stabbing a dagger into your spine.  After a moment the pain passes, though your fin is gone!", false);
        else
            outputText("<br><br>A wave of tightness spreads through your back, and it feels as if someone is stabbing a dagger into each of your shoulder-blades.  After a moment the pain passes, though your wings are gone!", false);
        player.wingType = WING_TYPE_NONE;
        changes++;
    }
    //Removes antennae
    ...
    //Default change - blah
    if (changes == 0)
        outputText("<br><br>Remakarbly, the snake-oil has no effect.  Should you really be surprised at snake-oil NOT doing anything?", false);
...
ConsumableEffects.slimeTFs = function () {
    ...
    if (player.wingType > WING_TYPE_NONE) {
        if (player.wingType == WING_TYPE_SHARK_FIN)
            ...
            outputText("<br><br>You sigh, feeling a hot wet tingling down your back.  It tickles slightly as you feel your wings slowly turn to sludge, dripping to the ground as your body becomes more goo-like.", false);
        player.wingType = WING_TYPE_NONE;
    }
    //Goopy hair
    ...
    if (player.vaginalCapacity() < 9000) {
        if (player.findStatusEffect(StatusEffects.BonusVCapacity) < 0)
            player.createStatusEffect(StatusEffects.BonusVCapacity, 9000, 0, 0, 0);
        else
    ...
    if (rand(2) == 0)
        outputText(player.modFem(85, 3), false);
    if (rand(2) == 0)
        outputText(player.modThickness(20, 3), false);
    if (rand(2) == 0)
        outputText(player.modTone(15, 5), false);
};
...
function restoreArms(tfSource) {
    ...
    if (tfSource == "gooGasmic") {
        ...
        if (hasClaws || player.armType == ARM_TYPE_HARPY)
