...
class ReductoMenu {
    ...
    static reductoClit() {
        clearOutput();
        outputText("You carefully apply the paste to your " + liveData.player.clitDescript() + ", being very careful to avoid getting it on your " + liveData.player.vaginaDescript(0) + ".  It burns with heat as it begins to make its effects known...\n\n");
    ...
    static reductoCock() {
        ...
        if (liveData.player.cocks[0].cockType == ENUM.CockType.BEE) {
            outputText("The gel produces an odd effect when you rub it into your " +
            ...
            outputText("You smear the repulsive smelling paste over your " +
            ...
            if (liveData.player.cocks.length == 1) {
                ...
                //MULTI
                outputText("Your " + liveData.player.multiCockDescriptLight() + " twitch and shrink, each member steadily disappearing into your " + (liveData.player.hasSheath() ? "sheath" : "crotch") + " until they've lost about a third of their old size.");
