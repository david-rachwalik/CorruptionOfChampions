...
class CombatTeases {
    static teaseMain(justText = false) {
        ...
        if (liveData.player.findPerk(PerkLib.Seduction) >= 0)
            chance += 10;
        //10% for sexy armor types
        if (liveData.player.findPerk(PerkLib.SluttySeduction) >= 0)
            chance += 10;
        //10% for bimbo shits
        ...
        //+ slutty armor bonus
        if (liveData.player.findPerk(PerkLib.SluttySeduction) >= 0)
            damage += liveData.player.perkValue(PerkLib.SluttySeduction, 1);
        //10% for bimbo shits
        if (bimbo || bro || futa) {
            damage += 5;
            bimbo = true;
        }
        if (liveData.player.level < 30)
            damage += liveData.player.level;
        else if (liveData.player.level < 60)
            damage += 30 + (liveData.player.level - 30) / 2;
        else
            damage += 45 + (liveData.player.level - 60) / 5;
        ...
        if ((futa || bimbo) && liveData.player.gender == 3) {
            ...
            if (liveData.player.buttRating >= 7)
                choices[choices.length] = 4;
            if (liveData.player.buttRating >= 10)
                choices[choices.length] = 4;
            if (liveData.player.buttRating >= 14)
                choices[choices.length] = 4;
            if (liveData.player.buttRating >= 20)
                choices[choices.length] = 4;
            if (liveData.player.buttRating >= 25)
                choices[choices.length] = 4;
            //Breast jiggle!
            ...
            if (liveData.player.biggestTitSize() >= 8)
                choices[choices.length] = 5;
            if (liveData.player.biggestTitSize() >= 15)
                choices[choices.length] = 5;
            if (liveData.player.biggestTitSize() >= 30)
                choices[choices.length] = 5;
            if (liveData.player.biggestTitSize() >= 50)
                choices[choices.length] = 5;
            if (liveData.player.biggestTitSize() >= 75)
                choices[choices.length] = 5;
            if (liveData.player.biggestTitSize() >= 100)
                choices[choices.length] = 5;
            //Pussy Flash!
            if (liveData.player.hasVagina()) {
                ...
                if (liveData.player.vaginalCapacity() >= 30)
                    choices[choices.length] = 6;
                if (liveData.player.vaginalCapacity() >= 60)
                    choices[choices.length] = 6;
                if (liveData.player.vaginalCapacity() >= 75)
                    choices[choices.length] = 6;
            }
            //Adj special!
            ...
            if (futa && liveData.player.hasCock()) {
                ...
                if (liveData.player.cockTotal() >= 2)
                    choices[choices.length] = 11;
                if (liveData.player.biggestCockArea() >= 10)
                    choices[choices.length] = 10;
                if (liveData.player.biggestCockArea() >= 25)
                    choices[choices.length] = 11;
                if (liveData.player.biggestCockArea() >= 50)
                    choices[choices.length] = 11;
                if (liveData.player.biggestCockArea() >= 75)
                    choices[choices.length] = 10;
                if (liveData.player.biggestCockArea() >= 100)
                    choices[choices.length] = 11;
                if (liveData.player.biggestCockArea() >= 300)
                    choices[choices.length] = 10;
            }
        }
        else if (bro) {
            ...
            if (liveData.player.biggestTitSize() < 1 && liveData.player.tone >= 60) {
                ...
                if (liveData.player.tone >= 70)
                    choices[choices.length] = 8;
                if (liveData.player.tone >= 80)
                    choices[choices.length] = 8;
                if (liveData.player.tone >= 90)
                    choices[choices.length] = 8;
                if (liveData.player.tone == 100)
                    choices[choices.length] = 8;
            }
            //9 Heroic Pose
        ...
        if (liveData.player.pregnancyIncubation <= 216 && liveData.player.pregnancyIncubation > 0) {
            ...
            if (liveData.player.biggestLactation() >= 1)
                choices[choices.length] = 13;
            if (liveData.player.pregnancyIncubation <= 180)
                choices[choices.length] = 13;
            if (liveData.player.pregnancyIncubation <= 120)
                choices[choices.length] = 13;
            if (liveData.player.pregnancyIncubation <= 100)
                choices[choices.length] = 13;
            if (liveData.player.pregnancyIncubation <= 50)
                choices[choices.length] = 13;
            if (liveData.player.pregnancyIncubation <= 24)
                choices[choices.length] = 13;
            if (liveData.player.pregnancyIncubation <= 24)
                choices[choices.length] = 13;
            if (liveData.player.pregnancyIncubation <= 24)
        ...
        //14 Brood Mother
        if (liveData.monster.hasCock() && liveData.player.hasVagina() && liveData.player.findPerk(PerkLib.BroodMother) >= 0 && (liveData.player.pregnancyIncubation <= 0 || liveData.player.pregnancyIncubation > 216)) {
        ...
        if (liveData.player.hasFuckableNipples()) {
            ...
            if (liveData.player.biggestTitSize() >= 3)
                choices[choices.length] = 15;
            if (liveData.player.nippleLength >= 3)
                choices[choices.length] = 15;
        }
        //16 Anal gape
        ...
        if (liveData.player.findPerk(PerkLib.Feeder) >= 0 && liveData.player.biggestTitSize() >= 4) {
            ...
            choices[choices.length] = 27;
            choices[choices.length] = 27;
            if (liveData.player.biggestTitSize() >= 10)
                choices[choices.length] = 27;
            if (liveData.player.biggestTitSize() >= 15)
                choices[choices.length] = 27;
            if (liveData.player.biggestTitSize() >= 25)
                choices[choices.length] = 27;
            if (liveData.player.biggestTitSize() >= 40)
                choices[choices.length] = 27;
            if (liveData.player.biggestTitSize() >= 60)
                choices[choices.length] = 27;
            if (liveData.player.biggestTitSize() >= 80)
                choices[choices.length] = 27;
        }
        //28 FEMALE TEACHER COSTUME TEASE
        ...
        if (liveData.player.hasVagina() && liveData.player.lactationQ() >= 500 && liveData.player.biggestTitSize() >= 6 && liveData.player.cowScore() >= 3 && liveData.player.tailType == ENUM.TailType.TAIL_TYPE_COW) {
        ...
        //45 - Lethicite armor
        if (liveData.player.armor == Items.Armor.LethiciteArmor /* && player.upperGarment == UndergarmentLib.NOTHING && player.lowerGarment == UndergarmentLib.NOTHING*/) {
        ...
        switch (select) {
            ...
            case 0:
                ...
                if (liveData.player.buttRating >= 10 && liveData.player.tone < 60)
                    GUI.outputText(", making it jiggle delightfully.");
                else
                    GUI.outputText(".");
                //Mod success
                ass = true;
            ...
            case 1:
                ...
                if (liveData.player.breastRows.length == 1) {
                    ...
                    GUI.outputText("Your lift your top, exposing your " + liveData.player.breastDescript(0) + " to " + liveData.monster.a + liveData.monster.refName + ". You shake them from side to side enticingly.");
                ...
                if (liveData.player.breastRows.length > 1) {
                    ...
                    GUI.outputText("You lift your top, freeing your rows of " + liveData.player.breastDescript(0) + " to jiggle freely. You shake them from side to side enticingly");
                    if (liveData.player.lust >= 50)
                        GUI.outputText(", your " + liveData.player.nippleDescript(0) + "s painfully visible.");
                    else
                        GUI.outputText(".");
                    chance++;
                }
            ...
            case 4:
                ...
                if (liveData.player.buttRating >= 10) {
                    GUI.outputText(", making it jiggle delightfully. " + UTIL.capitalizeFirstLetter(liveData.monster.a) + liveData.monster.refName + " even gets a few glimpses of the " + liveData.player.assholeDescript() + " between your cheeks.");
                    chance += 3;
                }
                //Small butts = less damage, still high success
                else {
                    GUI.outputText(", letting " + liveData.monster.a + liveData.monster.refName + " get a good look at your " + liveData.player.assholeDescript() + " and " + liveData.player.vaginaDescript(0) + ".");
                    chance += 1;
                    vagina = true;
                }
                ass = true;
            ...
            //5 breast jiggle
            case 5:
                GUI.outputText("You lean forward, letting the well-rounded curves of your " + liveData.player.allBreastsDescript() + " show to " + liveData.monster.a + liveData.monster.refName + ".");
                GUI.outputText(" You cup them in your palms and lewdly bounce them, putting on a show and giggling the entire time. An inch at a time, your " +
                ...
                if (liveData.player.lust >= 50) {
                    if (liveData.player.hasFuckableNipples()) {
                        ...
                        GUI.outputText(" Your hard nipples seem to demand " + liveData.monster.hisHer + " attention.");
                    chance += 1;
                    damage += 2;
                }
                //Damage boosts!
            ...
            case 6:
                if (liveData.player.findPerk(PerkLib.BimboBrains) >= 0 || liveData.player.findPerk(PerkLib.FutaFaculties) >= 0) {
                    ...
                    if (futa)
                        GUI.outputText("futanari ");
                    else if (liveData.player.findPerk(PerkLib.BimboBody) >= 0)
                        GUI.outputText("bimbo ");
                    else
                        GUI.outputText("sexy ");
                    GUI.outputText('body turn you on?</i>" ');
                }
                if (liveData.monster.plural)
                    GUI.outputText(UTIL.capitalizeFirstLetter(liveData.monster.a) + liveData.monster.refName + "' gazes are riveted on your groin as you run your fingers up and down your folds seductively.");
                else
                    GUI.outputText(UTIL.capitalizeFirstLetter(liveData.monster.a) + liveData.monster.refName + "'s gaze is riveted on your groin as you run your fingers up and down your folds seductively.");
                if (liveData.player.clitLength > 3)
                    ...
                    GUI.outputText(" You smile and pull apart your lower-lips to expose your " + liveData.player.clitDescript() + ", giving the perfect view.");
            ...
            //7 special Adjatha-crafted bend over bimbo times
            case 7:
                GUI.outputText("The glinting of light catches your eye and you whip around to inspect the glittering object, turning your back on " +
                    liveData.monster.a +
                ...
                GUI.outputText("The clear, warm fluid of your happy excitement trickles down from your loins, polishing your " +
            ...
            case 8:
                ...
                if (liveData.player.findPerk(PerkLib.BroBrains) >= 0)
                    ...
                    GUI.outputText(UTIL.capitalizeFirstLetter(liveData.monster.a) + liveData.monster.refName + " will probably enjoy the show, but you feel a bit silly doing this.");
            ...
            case 9:
                ...
                if (liveData.player.findPerk(PerkLib.BroBrains) >= 0)
                    ...
                    GUI.outputText("At least the physical changes to your body are proving useful!");
                chance += (liveData.player.tone - 75) / 5;
                damage += (liveData.player.tone - 70) / 5;
                auto = false;
                break;
            //10 Bulgy groin thrust
            case 10:
                GUI.outputText("You lean back and pump your hips at " +
                    liveData.monster.a +
                    liveData.monster.refName +
                ...
                if (liveData.player.findPerk(PerkLib.BroBrains) >= 0)
                    GUI.outputText("No way could " + liveData.monster.heShe + " resist your huge cock!");
                else
                    GUI.outputText("This is so crude, but at the same time, you know it'll likely be effective.");
            ...
            case 11:
                if (liveData.silly && UTIL.rand(2) == 0)
                    GUI.outputText('You strike a herculean pose and flex, whispering, "<i>Do you even lift?</i>" to ' + liveData.monster.a + liveData.monster.refName + ".");
                else {
                    GUI.outputText("You open your " +
                        liveData.player.armor.equipmentName +
                    ...
                    if (liveData.player.findPerk(PerkLib.BroBrains) >= 0)
                        GUI.outputText("Bitches love a cum-leaking cock.");
                    else
                        GUI.outputText("You've got to admit, you look pretty good down there.");
                }
                if (liveData.player.findPerk(PerkLib.BulgeArmor) >= 0)
                    damage += 5;
                penis = true;
            ...
            case 12:
                ...
                GUI.outputText("Reaching down, you grab an ankle and pull it backwards, looping it up and over to touch the foot to your " +
                ...
                vagina = true;
                if (liveData.player.thickness < 33)
                    chance++;
                else if (liveData.player.thickness >= 66)
                    chance--;
            ...
            case 13:
                //PREG
                GUI.outputText("You lean back, feigning a swoon while pressing a hand on the small of your back. The pose juts your huge, pregnant belly forward and makes the shiny spherical stomach look even bigger. With a teasing groan, you rub the protruding tummy gently, biting your lip gently as you stare at " +
                    liveData.monster.a +
                    liveData.monster.refName +
                ...
                //if lactating]
                if (liveData.player.biggestLactation() >= 1) {
                    GUI.outputText(" Your other hand moves to expose your " + liveData.player.chestDesc() + ", cupping and squeezing a stream of milk to leak down the front of your " + liveData.player.armor.equipmentName + '. "<i>Help a mommy out.</i>"<br><br>');
                    chance += 2;
                    damage += 4;
                }
                if (liveData.player.pregnancyIncubation < 100) {
            ...
            case 14:
                if (UTIL.rand(2) == 0)
                    GUI.outputText("You tear open your " +
                        liveData.player.armor.equipmentName +
                    ...
                    GUI.outputText("You wiggle your " +
                        liveData.player.hipDescript() +
            ...
            case 15:
                ...
                if (liveData.player.biggestTitSize() > 1 && liveData.player.hasVagina() && UTIL.rand(2) == 0) {
                    GUI.outputText("Closing your eyes, you lean forward and slip a hand under your " +
                        liveData.player.armor.equipmentName +
                        ...
                        liveData.monster.refName +
                        ".<br><br>");
                    GUI.outputText("Drawing your lust-slick hand to your " +
                        liveData.player.nippleDescript(0) +
                    ...
                    GUI.outputText("Despite how quiet you were, it's clear that every lewd, desperate noise you made was heard by " + liveData.monster.a + liveData.monster.refName + ".");
                    chance += 2;
                    damage += 4;
                }
                else if (liveData.player.biggestTitSize() > 1 && UTIL.rand(2) == 0) {
                    GUI.outputText("You yank off the top of your " +
                        liveData.player.armor.equipmentName +
                        ", revealing your " +
                        liveData.player.chestDesc() +
                    ...
                    GUI.outputText("You remove the front of your " +
                        liveData.player.armor.equipmentName +
                        " exposing your " +
                        liveData.player.chestDesc() +
            ...
            //16 Anal gape
            case 16:
                GUI.outputText("You quickly strip out of your " +
                    liveData.player.armor.equipmentName +
            ...
            //17 Bee abdomen tease
            case 17:
                GUI.outputText("You swing around, shedding the " +
                    liveData.player.armor.equipmentName +
            ...
            case 18:
                ...
                if (liveData.player.hasVagina())
                    GUI.outputText("parted cunt-lips");
                else
                    GUI.outputText("puckered asshole, hanging, erect maleness,");
                GUI.outputText(' and your hands on the ground in front of you. You pant heavily with your tongue out and promise, "<i>I\'ll be a good little bitch for you</i>."');
                vagina = true;
                chance += 1;
                damage += 2;
                break;
            ...
            //TALL WOMAN TEASE
            case 25:
                GUI.outputText("You move close to your enemy, handily stepping over " +
                    liveData.monster.hisHer +
            ...
            //Magic Tease
            case 26:
                GUI.outputText("Seeing a lull in the battle, you plant your " +
            ...
            //Feeder
            case 27:
                GUI.outputText("You present your swollen breasts full of milk to " + liveData.monster.a + liveData.monster.refName + ' and say "<i>Wouldn\'t you just love to lie back in my arms and enjoy what I have to offer you?</i>"');
                breasts = true;
                chance++;
                damage++;
                break;
            //28 FEMALE TEACHER COSTUME TEASE
            case 28:
                GUI.outputText("You turn to the side and give " + liveData.monster.a + liveData.monster.refName + " a full view of your body. You ask them if they're in need of a private lesson in lovemaking after class.");
                ass = true;
                break;
            //29 Male Teacher Outfit Tease
            case 29:
                GUI.outputText("You play with the strings on your outfit a bit and ask " + liveData.monster.a + liveData.monster.refName + " just how much do they want to see their teacher pull them off?");
                chance++;
                damage += 3;
                break;
            //30 Naga Fetish Clothes
            ...
            //32 Genderless servant clothes
            case 32:
                GUI.outputText("You turn your back to your foe, and flip up your butt flap for a moment.  Your " + liveData.player.buttDescript() + " really is all you have to offer downstairs.");
                ass = true;
                chance++;
                damage += 2;
                break;
            //33 Crotch Revealing Clothes (herm only?)
            case 33:
                GUI.outputText("You do a series of poses to accentuate what you've got on display with your crotch revealing clothes, while asking if your " + liveData.player.mf("master", "mistress") + " is looking to sample what is on display.");
                chance += 2;
                damage += 4;
                break;
            //34 Maid Costume (female only)
            case 34:
                GUI.outputText("You give a rather explicit curtsey towards " + liveData.monster.a + liveData.monster.refName + " and ask them if your " + liveData.player.mf("master", "mistress") + " is interested in other services today.");
                chance++;
                damage += 2;
                breasts = true;
                break;
            //35 Servant Boy Clothes (male only)
            case 35:
                GUI.outputText("You brush aside your crotch flap for a moment, then ask " +
                    liveData.monster.a +
                    liveData.monster.refName +
                    " if, " +
            ...
            case 36:
                GUI.outputText('You pull back one of the straps on your bondage cloths and let it snap back. "<i>I need some medical care, feeling up for it?</i>" you tease.');
                damage += 2;
                chance++;
                break;
            default:
                ...
                break;
            case 37:
                GUI.outputText("You purse your lips coyly, narrowing your eyes mischievously and beckoning to " +
                    liveData.monster.a +
                    liveData.monster.refName +
                ...
                break;
            case 38:
                GUI.outputText("You wet your lips, narrowing your eyes into a smoldering, hungry gaze. Licking the tip of your index finger, you trail it slowly and sensually down the front of your " +
                    liveData.player.armor.equipmentName +
                ...
                break;
            case 39:
                GUI.outputText("Leaning forward, you bow down low, raising a hand up to your lips and blowing " +
                    liveData.monster.a +
                    liveData.monster.refName +
                ...
                if (liveData.player.tailVenom == 1)
                    ...
                    GUI.outputText("a");
                GUI.outputText(" bushy tail curls up around your " + liveData.player.leg() + ", uncoiling with a whipping motion that makes an audible crack in the air.");
                ass = true;
                chance++;
                damage += 1;
                break;
            case 40:
                GUI.outputText("Turning around, you stare demurely over your shoulder at " + liveData.monster.a + liveData.monster.refName + ", batting your eyelashes amorously.");
                if (liveData.player.tailVenom == 1)
                    GUI.outputText(" Your tail twists and whips about, sliding around your " + liveData.player.hipDescript() + " in a slow arc and framing your rear nicely as you slowly lift your " + liveData.player.armor.equipmentName + ".");
                else
                    GUI.outputText(" Your tails fan out, twisting and whipping sensually, sliding up and down your " + liveData.player.legs() + " and framing your rear nicely as you slowly lift your " + liveData.player.armor.equipmentName + ".");
                GUI.outputText(" As your [butt] comes into view, you brush your tail" + (liveData.player.tailVenom > 1 ? "s" : "") + " across it, partially obscuring the view in a tantalizingly teasing display.");
                ass = true;
                anus = true;
                chance++;
                damage += 2;
                break;
            case 41:
                GUI.outputText("Smirking coyly, you sway from side to side, running your tongue along your upper teeth seductively. You hook your thumbs into your " + liveData.player.armor.equipmentName + " and pull them away to partially reveal ");
                if (liveData.player.cockTotal() > 0)
                ...
                GUI.outputText(". Your bushy tail" + (liveData.player.tailVenom > 1 ? "s" : "") + " cross" + (liveData.player.tailVenom > 1 ? "" : "es") + " in front, wrapping around your genitals and obscuring the view teasingly.");
                vagina = true;
                penis = true;
                damage += 2;
                chance++;
            ...
            case 42:
                //Tease #1:
                if (UTIL.rand(2) == 0) {
                    GUI.outputText('You lift your skirt and flash your king-sized stallionhood, already unsheathing itself and drooling pre, at your opponent. "<i>Come on, then; I got plenty of girlcock for you if that\'s what you want!</i>" you cry.');
                    penis = true;
                    damage += 3;
                    chance--;
                }
                ...
                break;
            case 43:
                let cows = UTIL.rand(7);
                if (cows == 0) {
                    GUI.outputText("You tuck your hands under your chin and use your arms to squeeze your massive, heavy breasts together. Milk squirts from your erect nipples, filling the air with a rich, sweet scent.");
                    breasts = true;
                    chance += 2;
                    damage++;
                }
                else if (cows == 1) {
                    GUI.outputText('Moaning, you bend forward, your full breasts nearly touching the ground as you sway your [hips] from side to side. Looking up from under heavily-lidded eyes, you part your lips and lick them, letting out a low, lustful "<i>Mooooo...</i>"');
                    breasts = true;
                    chance += 2;
                    damage += 2;
                }
                    ...
                    GUI.outputText("You heft your breasts, fingers splayed across your [nipples] as you SQUEEZE. Milk runs in rivulets over your hands and down the massive curves of your breasts, soaking your front with sweet, sticky milk.");
                    breasts = true;
                    chance += 3;
                    damage++;
                }
                else if (cows == 4) {
                    GUI.outputText("You lift a massive breast to your mouth, suckling loudly at yourself, finally letting go of your nipple with a POP and a loud, satisfied gasp, milk running down your chin.");
                    breasts = true;
                    chance++;
                    damage += 3;
                }
                else if (cows == 5) {
                    GUI.outputText("You crouch low, letting your breasts dangle in front of you. Each hand caresses one in turn as you slowly milk yourself onto your thighs, splashing white, creamy milk over your hips and sex.");
                    vagina = true;
                    breasts = true;
                    chance++;
                }
                else {
                    GUI.outputText("You lift a breast to your mouth, taking a deep draught of your own milk, then tilt your head back. With a low moan, you let it run down your front, winding a path between your breasts until it drips sweetly from your crotch.");
                    vagina = true;
                    breasts = true;
                    damage += 2;
                }
            ...
            case 44:
                ...
                if (maiden == 0) {
                    ...
                    GUI.outputText("You flip up the barely-modest chain you call a skirt and expose your g-string to " +
                        liveData.monster.a +
                        liveData.monster.refName +
                    ...
                    if (liveData.player.hasVirginVagina())
                        GUI.outputText("Think you can handle a virgin's infinite lust?");
                    else
                        GUI.outputText("Think you have what it takes to satisfy this perfect pussy?");
                    GUI.outputText('</i>"');
                    vagina = true;
                    damage += 3;
                }
                else if (maiden == 3) {
                    GUI.outputText("You seductively wiggle your way up to " +
                        liveData.monster.a +
                        liveData.monster.refName +
                        ", and before " +
                        liveData.monster.heShe +
                    ...
                    GUI.outputText("Bending over, you lift your [butt] high in the air. Most of your barely-covered tush is exposed, but the hem of your chainmail skirt still protects some of your anal modesty. That doesn't last long. You start shaking your [butt] up, down, back, and forth to an unheard rhythm, flipping the pointless covering out of the way so that " +
                        liveData.monster.a +
                        liveData.monster.refName +
            ...
            case 45:
                ...
                if (liveData.player.gender == 1 && !liveData.player.isTaur())
                    partChooser[partChooser.length] = 1;
                if (liveData.player.gender == 2 && !liveData.player.isTaur())
                    partChooser[partChooser.length] = 2;
                if (liveData.player.gender == 3 && liveData.player.hasVagina() && !liveData.player.isTaur())
                    partChooser[partChooser.length] = 3;
                //Let's do this!
                switch (partChooser[UTIL.rand(partChooser.length)]) {
                    case 0:
                        GUI.outputText("You place your hand on your lethicite-covered belly, move your hand up across your belly and towards your [chest]. Taking advantage of the small openings in your breastplate, you pinch and tweak your exposed [nipples].");
                        breasts = true;
                        chance += 3;
                        damage += 1;
                        break;
                    case 1:
                        GUI.outputText("You move your hand towards your [cocks], unobstructed by the lethicite. You give your [cock] a good stroke and sway your hips back and forth, emphasizing your manhood.");
                        penis = true;
                        chance += 1;
                        damage += 2;
                        break;
                    case 2:
                        GUI.outputText("You move your hand towards your [pussy], unobstructed by the lethicite. You give your [clit] a good tease, finger your [pussy], and sway your hips back and forth, emphasizing your womanhood.");
                        vagina = true;
                        chance += 1;
                        damage += 2;
                        break;
                    case 3:
                        GUI.outputText("You move your hand towards your [cocks] and [pussy], unobstructed by the lethicite. You give your [cock] a good stroke, tease your [clit], and sway your hips back and forth, emphasizing your hermaphroditic gender.");
                        penis = true;
                        vagina = true;
                        chance += 1;
                        damage += 3;
        ...
        if (UTIL.rand(100) <= chance + UTIL.rand(bonusChance)) {
            ...
            /*else */ if (!justText)
                liveData.monster.teased(damage);
            if (liveData.gameFlags[FLAG.PC_FETISH] >= 1 /* && !urtaQuest.isUrta()*/) {
                if (liveData.player.lust < 75)
                    GUI.outputText("<br>Flaunting your body in such a way gets you a little hot and bothered. ");
                else
                    GUI.outputText("<br>If you keep exposing yourself you're going to get too horny to fight back. This exhibitionism fetish makes it hard to resist just stripping naked and giving up. ");
                if (!justText)
                    liveData.player.changeLust(2 + UTIL.rand(3));
            }
            // Similar to fetish check, only add XP if the player IS the player...
            if (!justText /* && !urtaQuest.isUrta()*/)
                COMBAT.teaseXP(1);
        }
        //Nuttin honey
        else {
            ...
            /*else*/ if (!justText)
                GUI.outputText("<br>" + UTIL.capitalizeFirstLetter(liveData.monster.a) + liveData.monster.refName + " seems unimpressed.");
        }
        GUI.outputText("<br><br>");
    }
}
export { CombatTeases };
//# sourceMappingURL=combatTeases.js.map