...
GiacomoScene.eroticaMenu = function () {
    ...
    if (player.hasVagina())
        addButton(1, "Stim-Belt", GiacomoScene.pitchSelfStimulationBelt);
    if (player.hasVagina())
        addButton(2, "AN Stim-Belt", GiacomoScene.pitchAllNaturalSelfStimulationBelt);
    if (player.hasCock())
        addButton(3, "Onahole", GiacomoScene.pitchOnahole);
    if (player.hasCock())
        addButton(4, "D Onahole", GiacomoScene.pitchDeluxeOnahole);
    if (player.hasCock() && player.hasVagina())
        addButton(5, "Dual Belt", GiacomoScene.pitchDualStimulationBelt);
    if (player.hasCock() && player.hasVagina())
        addButton(6, "AN Onahole", GiacomoScene.pitchAllNaturalOnahole);
...
GiacomoScene.wormRemoval = function () {
    ...
    if (player.HP > player.maxHP() * 0.15)
        player.changeHP(-(player.HP - (player.maxHP() * 0.15)), false);
