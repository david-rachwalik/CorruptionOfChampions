...
class AmilyScene {
    ...
    static amilyStandardMeeting() {
        ...
        switch (liveData.amily.pregnancyEventNum) {
            ...
            case 5: //Amily is slightly pregnant
                ...
                //[High Affection]
                    ...
                    outputText("\"<i>Thank you, thank you! I couldn't have done this without you!</i>\" She exclaims. \"<i>You've done a wonderful, noble thing, and I'm glad I found you to be their father. So, not that it isn't great to see you again, but why did you come to visit?</i>\"<br><br>");
                break;
            case 6:
            case 7: //Amily is heavily pregnant
                ...
                //[Low Affection]
                if (liveData.gameFlags[FLAG.AMILY_AFFECTION] < 15 || liveData.player.gender == 0)
                    outputText('She seems to be paying more attention to her gravid midriff than to you, and it\'s several long moments before she finally speaks. "<i>These children will be born soon. I guess I owe you my thanks for being willing to father them.</i>"<br><br>');
                //[Medium Affection]
                else if (liveData.gameFlags[FLAG.AMILY_AFFECTION] < 40)
                    outputText("She groans softly. \"<i>This isn't an easy task, you know. But I still want to thank you. Maybe, when these ones are born, you'll be willing to help me make some more?</i>\" She asks, her tail gently waving behind her.<br><br>");
                //[High Affection]
                else
                    outputText('"<i>I should have known you were coming; they always start kicking up a storm when you\'re here – did you know that?</i>" She smiles beatifically. "<i>They know their daddy already, they do. With your help, a new generation of my people will have a chance to grow up free from the taint of demons. Was there something on your mind?</i>"<br><br>');
                break;
            default:
        ...
        if (liveData.gameFlags[FLAG.AMILY_AFFECTION] < 15 || liveData.player.gender == 0) {
            ...
            if (liveData.gameFlags[FLAG.AMILY_MET_AS] == 2 && liveData.player.gender == 2)
                outputText('She crosses her arms and smiles at you. "<i>So you came back huh?  Did you want to chat with little old me?</i>" she asks.<br><br>');
            // Otherwise she doesn't trust you.
            else
                outputText('She crosses her arms and taps her fingers on her shoulder. "<i>So, why are you here? What do you want?</i>" she asks.<br><br>');
        }
    ...
    static makeAmilyAHerm() {
        ...
        outputText("Amily looks crestfallen, then finally nods her head, slowly. \"<i>I... I'm not really sure about this, but... if it's for you, " +
            liveData.player.name +
        ...
        outputText("Catching her breath, she " +
    ...
    static amilyNewGenderConfrontation() {
            ...
            //[Female to Herm]
                ...
                if (liveData.gameFlags[FLAG.AMILY_WANG_LENGTH] == 0) {
                    ...
                    //Medium Affection:
                        ...
                        outputText("\"<i>I... don't take this the wrong way, " +
                            liveData.player.name +
        ...
        //Genderless tooo
            ...
            if (liveData.gameFlags[FLAG.AMILY_AFFECTION] < 15) {
                ...
                if (liveData.player.hasVagina())
                    outputText(liveData.player.vaginaDescript());
            ...
            //[High Affection]
                ...
                if (liveData.player.hasCock())
                    outputText("bringing your " + liveData.player.cockDescript(0) + " to erection");
                if (liveData.player.hasVagina() && liveData.player.hasCock())
                    outputText(" and ");
                if (liveData.player.hasVagina())
                    outputText("earning a clench from your " + liveData.player.vaginaDescript(0));
    ...
    static talkToAmily() {
        ...
        if (liveData.gameFlags[FLAG.AMILY_MET_AS] == 2 && liveData.player.gender == 2)
            ...
            outputText("You tell Amily that you came here because you wanted to talk with her, and you have no desire to approach her sexually on this encounter.<br><br>");
        //[Low Affection]
        if (liveData.gameFlags[FLAG.AMILY_AFFECTION] < 15) {
            switch (liveData.amily.pregnancyEventNum) {
                case 1:
    ...
    static amilyConversationStart() {
        ...
        //Conversation: Imps
            ...
            if (this.sexForced)
                outputText("to regain her composure before your sexplay.<br><br>");
            else {
        ...
        //Conversation: Goblins
            ...
            if (!this.sexForced) {
                if (liveData.gameFlags[FLAG.AMILY_FOLLOWER] == 0)
                    outputText("Thanking her for her time, and the warning, you head back to your own camp.<br><br>");
                else
                    outputText("Thanking her for her time, and the warning, you sit back down in your camp.<br><br>");
            }
            else
                outputText("You thank her for her time as the conversation winds down.<br><br>");
        }
        //Conversation: What was life in her village like?
            ...
            if (!this.sexForced)
                ...
                outputText(", before giving you a warm smile.<br><br>");
        }
        //Conversation: Who was she before it was all lost?
            ...
            if (!this.sexForced)
                outputText("  Then you leave her, giving her the chance to mourn her lost family.<br><br>");
        }
        //Conversation: How did it fall?
            ...
            if (this.sexForced)
                ...
                outputText(", then excuse yourself once you are certain she is okay.<br><br>");
        }
        //Conversation: How did she survive?
            ...
            if (!this.sexForced) {
                if (liveData.gameFlags[FLAG.AMILY_FOLLOWER] == 0)
                    outputText("\", politely excuse yourself, and head back to your own camp. It sounds like she's doing better at keeping a steady supply of food and water going than you are.  But if that's the case... why does she look so thin?<br><br>");
                else
                    outputText("\", politely excuse yourself, and sit back down in camp.  It sounds like she's doing better at keeping a steady supply of food and water going than you are.  But if that's the case... why does she look so thin?<br><br>");
            }
            else
                outputText('."');
        }
        ...
        //Conversation: How will she care for her children?
            ...
            if (!this.sexForced) {
                if (liveData.gameFlags[FLAG.AMILY_FOLLOWER] == 0)
                    outputText("  Then, as if realising you are still here, she waves at you to go, getting up and leaving herself.  Wondering what that was about, you return to camp.<br><br>");
                else
                    outputText("  Then, as if realising you are still here, she waves at you to go, getting up and leaving herself.  Wondering what that was about, you sit down in camp.<br><br>");
            }
        }
    ...
    static amilySexPlaytimeFirst() {
        ...
        outputText('"<i>Fair is fair.</i>" She growls, but she\'s blushing faintly. Clumsy with unfamiliarity, she nonetheless does her best to remove your ' +
            liveData.player.armor.equipmentName +
    ...
    static amilySexSitAndWatch() {
        clearOutput();
        var x = liveData.player.cockThatFits(61);
        outputText("You stay right where you are, not wanting to spoil the show. By the time that she is visibly starting to drip girlcum and approaches you, clearly ready to move on to the main event, your " +
    ...
    static amilySexGetTheFunStarted() {
        clearOutput();
        var x = liveData.player.cockThatFits(61);
        outputText("Too horny to think of anything else than what lies ahead, you hastily remove your " +
            liveData.player.armor.equipmentName +
    ...
    static amilyHighAffectionSex() {
        ...
        outputText("<br><br>");
        outputText("Once inside, the two of you get to work undoing each others clothes, tossing the garments across the room with little care for them. Amily bites her lower lip as she examines your naked form again, before practically jumping you. She wraps her small hands around your stiff " +
    ...
    static fuckAmilyPreg() {
        ...
        if (liveData.gameFlags[FLAG.AMILY_WANG_LENGTH] > 0)
            outputText(", her own mouse-cock spewing futa-cum all over her belly");
        outputText(".<br><br>");
        if (liveData.gameFlags[FLAG.AMILY_WANG_LENGTH] > 0)
    ...
    static girlyGirlMouseSex() {
        ...
        if (liveData.gameFlags[FLAG.AMILY_TIMES_FUCKED_FEMPC] == 0)
            ...
            outputText('"<i>Remember how you had to take charge the first time?</i>" She grins. "<i>Care to see if you\'ve still got it?</i>"<br><br>');
        ...
        outputText('Slowly you lead her to her bedding, and it is only when she is on her back that you break off the kiss. Amily looks dazed for a few moments, and then grins at you. "<i>Wow.</i>" You smile in response and start to remove your ' +
            liveData.player.armor.equipmentName +
        ...
        if (liveData.gameFlags[FLAG.AMILY_TIMES_FUCKED_FEMPC] == 0)
            ...
            outputText("Amily needs no instructions and plunges her tongue as deeply as it can go into your sex. You yelp in shock, which makes Amily's tail wave happily, and, grinning mischievously, you return the favor.<br><br>");
        ...
        outputText("Her juices are flowing strong and thick, now, leaving you lapping at the wetness with audible slurps. Your tongue reaches into every crevice, every fold that you can find, and Amily moans and squeaks incoherently as she savors your ministrations. Emboldened, she suddenly thrusts her " +
        ...
        if (liveData.gameFlags[FLAG.AMILY_TIMES_FUCKED_FEMPC] == 0)
            outputText('"<i>...I didn\'t know it could feel so good with another woman.... But I was never attracted to women before.</i>" Amily murmurs to herself.<br><br>');
        else
            outputText('"<i>...Does it make me a lesbian, that I love this so much? Or am I just so lonely for company that even another woman is good?</i>" Amily asks. Then she musters the energy to shake her head. "<i>It doesn\'t matter. I love you.</i>"<br><br>');
    ...
    static amilyHermOnFemalePC() {
        ...
        if (liveData.gameFlags[FLAG.AMILY_HERM_TIMES_FUCKED_BY_FEMPC] == 0)
            outputText("\"<i>I can't believe this is actually happening... I've grown a cock and I'm about to use it on another woman.</i>\" Amily mutters to herself, though it's very evident that she likes what she sees, unable to resist staring at your " +
                liveData.player.chestDesc() +
                " or your " +
                liveData.player.vaginaDescript() +
                ".<br><br>");
        else
            outputText("\"<i>I still can't believe that I'm burying this hot, throbbing thing in another woman's pussy... More than that, I think I'm actually starting to like it.</i>\" Amily comments to herself, staring unabashedly at your curves.<br><br>");
        //(If first time & player is herm:
        if (liveData.player.gender == 3) {
            if (liveData.gameFlags[FLAG.AMILY_HERM_TIMES_FUCKED_BY_FEMPC] == 0)
                outputText("\"<i>How on earth did I let myself get talked into this? If you've got both a cock and a pussy, then what's wrong with you just filling me with that cock?</i>\" Amily mutters to herself. Despite her words, though, her gaze is fixed squarely on your " +
                    liveData.player.vaginaDescript() +
                    ".<br><br>");
            //else
            else
                outputText('"<i>You know, it\'s not all bad, us both being this way... but remember that I want a turn at that, too.</i>" She states, staring hungrily at your ' + liveData.player.multiCockDescriptLight() + ".<br><br>");
        }
        ...
        if (liveData.player.isBiped())
            outputText(liveData.player.legs() + " in readiness for her.");
        else
        ...
        if (liveData.gameFlags[FLAG.AMILY_HERM_TIMES_FUCKED_BY_FEMPC] == 0)
            outputText('"<i>Er... are you really sure about this? I mean...</i>" Amily murmurs uncertainly, until, irritated, you suddenly wrap your ' +
        ...
        outputText("Amily's ministrations are hardly the most expert of sexual techniques you've seen in Mareth, but her intentions to make it as pleasant as possible for you are obvious, and what she lacks in expertise she makes up for in enthusiasm, " +
        ...
        //(First time:
        if (liveData.gameFlags[FLAG.AMILY_HERM_TIMES_FUCKED_BY_FEMPC] == 0)
            outputText('"<i>...I had no idea it would feel like that,</i>" she gasps softly.<br><br>');
        else
            outputText('"<i>It gets me every time when that happens. Is this what it\'s like for men?</i>" she wonders.<br><br>');
        outputText("You smile and reach up to stroke her cheek. She smiles back and reaches down to pat you on your belly.");
        //(If player is preg
        if (liveData.player.isPregnant()) {
            if (liveData.player.pregnancyType == PREGNANCY_AMILY)
    ...
    static amilySexFirstTimeKiss() {
        ...
        if (liveData.player.cocks[0].cockLength >= 14)
            ...
            outputText("She looks down between your legs and, blushing, smiles. \"<i>It's nice to see a " +
    ...
    static pcBirthsAmilysKidsQuestVersion() {
        ...
        if (liveData.gameFlags[FLAG.PC_TIMES_BIRTHED_AMILYKIDS] + liveData.gameFlags[FLAG.AMILY_BIRTH_TOTAL] >= 5) {
            ...
            outputText((liveData.gameFlags[FLAG.AMILY_NOT_FURRY] == 0 ? ", naked, pink, and totally hairless" : "") +
    ...
    static meetAmilyAsACorruptAsshat() {
        ...
        if (liveData.player.inte >= 40)
            outputText("You begin to formulate a plan, but to put this plan into motion you'll require a Lust Draft and some Goblin Ale. That damn rat is going to rue the day she denied you.<br><br>");
        //-(else)
        else
    ...
    static cookAmilyASnack() {
        ...
        if (liveData.gameFlags[FLAG.CREATE_POTENT_MIXTURE] > 0) {
            ...
            //(else)
                ...
                if (liveData.player.hasVagina())
                    outputText("your " + liveData.player.vaginaDescript() + " moistens itself ");
                ...
                //[Male]
                if (liveData.player.hasCock()) {
                    outputText("You begin to stroke your " +
        ...
        //First Time Cooking the Drug
            ...
            //(else)
                ...
                if (liveData.player.hasCock())
                    outputText(liveData.player.cockDescript(0) + " jumps up to attention");
                if (liveData.player.hasCock() && liveData.player.hasVagina())
                    outputText(", and your ");
                if (liveData.player.hasVagina())
                    outputText(liveData.player.vaginaDescript() + " nearly juices itself");
    ...
    static amilyCorrupt1() {
        ...
        //(if PC's intelligence >= 50)
            ...
            outputText("You cautiously survey the surroundings, and finally spot some recent tracks made by Amily. It's clear she tried to hide them, but using your superior wits, you not only find the routes leading to all of her hideouts, but deduce which hideout she'll use next and decide to hide inside; now, all that's left to do is wait...<br><br>");
            outputText("You wait for quite some time, but eventually you hear Amily approaching; she checks the hideout for any signs of intrusions, but you have concealed your presence well and she finds nothing. Satisfied, she sets down a bag with some fruits she gathered and sits down on a stool, letting out a sigh of relief.<br><br>");
            outputText("This is your cue to act; you quickly burst out of your hideout and swipe her blowpipe away. Amily jumps away in surprise and reaches for her knife, assuming a fighting stance. You ready your " +
    ...
    static amilyCorrupt2() {
        ...
        //(else)
            ...
            if (liveData.player.hasVagina())
                outputText(liveData.player.vaginaDescript() + " growing wet");
            outputText(".<br><br>");
            ...
            if (liveData.player.hasVagina())
                outputText(" dripping " + liveData.player.vaginaDescript());
    ...
    static amilyCorrupt3() {
        ...
        if (liveData.player.hasVagina())
            outputText(" moistening your " + liveData.player.vaginaDescript());
        ...
        outputText('Amily plants her head on the ground and starts. "<i>' +
    ...
    static rapeCorruptAmily1() {
        ...
        if (liveData.player.cockTotal() > 0) {
            if (liveData.player.cockTotal() > 1)
                outputText(liveData.player.multiCockDescriptLight() + " are");
            else
                outputText(liveData.player.cockDescript(0) + " is");
            outputText(" already hard");
            if (liveData.player.hasVagina())
                outputText(", and your ");
        }
        if (liveData.player.hasVagina())
            outputText(liveData.player.vaginaDescript() + " is already wet");
    ...
    static rapeCorruptAmily1Male() {
        ...
        liveData.player.removeKeyItem(KeyItems.PotentMixture);
        clearOutput();
        outputText("You smile and say, \"<i>Fine, but you're gonna have to work for it.</i>\" Amily's answer is to open her mouth wide. The invitation clear, you scoot closer to her mouth, and her lips touch the tip of your " +
            liveData.player.cockDescript(x) +
        ...
        if (liveData.player.balls > 0)
            outputText(liveData.player.ballsDescriptLight() + " churn");
        else
            outputText(liveData.player.cockDescript(x) + " throb");
    ...
    static rapeCorruptAmily1Female() {
        clearOutput();
        liveData.player.removeKeyItem(KeyItems.PotentMixture);
        outputText("You smile and say, \"<i>Fine, but you're gonna have to work for it.</i>\" Amily's answer is to open her mouth wide. The invitation clear, you advance and lower your " +
            liveData.player.vaginaDescript() +
    ...
    static rapeCorruptAmily2Male() {
        ...
        //[(If PC is huge.)
        if (liveData.player.cockThatFits(61) < 0)
            outputText("  One of Amily's hands settles on your " + liveData.player.cockDescript(x) + ", stroking whatever she doesn't manage to swallow.");
        outputText("<br><br>");
        ...
        //(else if PC has a pussy)
            ...
            outputText("Amily shoves her fingers into your " + liveData.player.vaginaDescript() + ".  ");
    ...
    static rapeCorruptAmily2Female() {
        ...
        //[(if PC is a squirter)
        if (liveData.player.wetness() >= 5)
            outputText("  Your juices rocket into her face, painting her " + (liveData.gameFlags[FLAG.AMILY_NOT_FURRY] == 0 ? "muzzle" : "face") + " in your femcum as she giggles with happiness and pleasure.");
        outputText("  Amily begins licking and slurping, her nose bumping into your clit every once in a while; she eats your " +
            liveData.player.vaginaDescript() +
        ...
        outputText("Amily herself moans once in a while, sending pleasurable ripples throughout your " +
            liveData.player.vaginaDescript() +
        ...
        //[(if PC is a squirter)
        if (liveData.player.wetness() >= 5)
            outputText("  Your orgasm lasts much longer than usual. Eventually you release Amily and finish off on top of her head.<br><br>");
        this.rapeCorruptAmily2Epilogue();
    }
    // COMPLETE
    ...
    static rapeCorruptAmily3Male() {
        clearOutput();
        outputText("You strip while Amily watches hungrily. Finally naked, you order the mouse to come closer and use her breasts to pleasure you. Amily quickly scoots closer on her knees and press her breasts around your " +
            liveData.player.cockDescript(0) +
            ".");
        //[(if PC is huge)
        ...
        outputText("Amily complies without a word; then you drive your " +
            liveData.player.cockDescript(0) +
        ...
        if (liveData.player.balls > 0)
            outputText("your " + liveData.player.ballsDescriptLight());
        else if (liveData.player.hasVagina())
            outputText("your " + liveData.player.vaginaDescript());
        else
        ...
        //[(if PC has balls)
        if (liveData.player.balls > 0)
            outputText("  Your " + liveData.player.ballsDescriptLight() + " churn with cum, growing heavier with every nasty detail that goes through your mind.");
    ...
    static rapeCorruptAmily3Female() {
        ...
        outputText("<br><br>");
        outputText("With a final push of your fingers against your " +
            liveData.player.vaginaDescript() +
        ...
        outputText('Amily springs up and rushes to nuzzle your still leaking vagina. "<i>Thank you! Thank you! Thank you!</i>" she says excitedly. Then, with a lick of her lips, she opens wide and engulfs your whole ' +
            liveData.player.vaginaDescript() +
            ".");
        //[(if PC is a squirter)
        if (liveData.player.wetness() >= 5)
        ...
        outputText("You flood her maw at an alarming rate. Someone not practiced in the art of juice guzzling would surely choke and drown on the amazing amount of femcum that you're dumping into Amily's maw; yet she not only manages to chug it all down, she even continues licking to draw out more. Even more surprising than that is the fact that her mouth seems to have formed a perfect seal around your " +
            liveData.player.vaginaDescript() +
    ...
    static rapeCorruptAmily4Meeting() {
        ...
        outputText("As soon as she realizes you're there, she drops the dildo and rushes towards you; kneeling submissively in front of you, she nuzzles your crotch and asks, \"<i>" +
            liveData.player.mf("Master", "Mistress") +
    ...
    static rapeCorruptAmily4Male() {
        ...
        //[(if pc has balls)
        if (liveData.player.balls > 0)
            outputText(" and " + liveData.player.ballsDescriptLight());
        outputText(".<br><br>");
        outputText('"<i>Get to it,</i>" you order her.<br><br>');
        outputText("She backs off and gives your tip a light kiss, which quickly turns into a slurp as you feel your " +
            liveData.player.cockDescript(0) +
            " slip into her throat; there is barely any resistance, your cock glides down her throat, Amily doesn't gag at all.");
        //[(if PC is huge)
        if (liveData.player.cockArea(0) > 50)
            outputText("  You smirk, pleased; with your size, you'd probably choke whomever tried to swallow your " +
                liveData.player.cockDescript(0) +
        ...
        if (liveData.player.isNaga())
            ...
            outputText("put a " + liveData.player.foot() + " on her head.");
        outputText(' She falls silent and you say. "<i>Very well. From now on I am your one and only ' +
            liveData.player.mf("master", "mistress") +
        ...
        outputText("Black spunk comes out of your " +
            liveData.player.cockDescript(0) +
    ...
    static rapeCorruptAmily4Female() {
        ...
        outputText("  Amily digs into your " +
            liveData.player.vaginaDescript() +
        ...
        outputText("Finally, Amily's tongue penetrates deep into your " +
            liveData.player.vaginaDescript() +
        ...
        outputText('"<i>Stop and stand still. It\'s time to baptise you,</i>" you tell her, panting.<br><br>');
        outputText("Amily closes her eyes and bows slightly, giving you a clear shot of her head.  Finally, you let go.<br><br>");
        outputText("Black juices squirt from your " +
            liveData.player.vaginaDescript() +
    ...
    static rapeCorruptAmily4Epilogue() {
        ...
        outputText('She looks herself over, examining and enjoying her new sensitive body; every movement is accompanied with a pleasured sigh or a moan. She looks at you and kneels in front of you, a rush of fluids escapes her pussy as she does so. "<i>' +
            liveData.player.mf("Master", "Mistress") +
        ...
        if (liveData.player.pregnancyType == PREGNANCY_AMILY)
            liveData.player.knockUpForce(PREGNANCY_MOUSE, liveData.player.pregnancyIncubation);
    ...
    static amilyBecomesFollower() {
        ...
        outputText("But as I got to know you, you became more to me. I love you, " +
            liveData.player.name +
