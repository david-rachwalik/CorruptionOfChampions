...
class RathazulScene {
    ...
    static craftCarapace() {
        ...
        if (liveData.player.biggestTitSize() >= 8)
            outputText("Your " + liveData.player.chestDesc() + " barely fit into the breastplate, leaving you displaying a large amount of jiggling cleavage.<br><br>");
    ...
    static craftDragonscaleArmor() {
        ...
        if (liveData.player.hasItem(Items.Materials.DragonScale, 5)) {
            ...
            outputText("<br><br>You realize you're still a bit short on dragonscales for the armor but you can have undergarments made instead.");
    ...
    static craftMaraeArmor(divine) {
        ...
        if (!divine) {
            ...
            if (liveData.player.mf("m", "f") == "f")
                outputText(" with stockings and garters");
