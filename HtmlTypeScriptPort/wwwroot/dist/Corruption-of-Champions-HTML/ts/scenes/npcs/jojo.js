...
class Jojo extends Creature {
    constructor() {
        ...
        if (this.cor < 0)
            this.cor = 0; //Ensure it doesn't goes into negative if you proceed to unlock sex scenes.
        //Advancement
        this.level = 4;
    ...
    selfCorruption() {
        ...
        else if (liveData.monster.lust >= 85)
            GUI.outputText("The mouse is panting and softly whining, each movement seeming to make his bulge more pronounced. You don't think he can hold out much longer. ");
        else if (liveData.monster.lust >= 70)
            GUI.outputText("The mouse is having trouble moving due to the rigid protrusion from his groin. ");
        else if (liveData.monster.lust >= 60)
            GUI.outputText("The mouse's eyes constantly dart over your most sexual parts, betraying his lust. ");
        else if (liveData.monster.lust >= 50)
            GUI.outputText("The mouse's skin remains flushed with the beginnings of arousal. ");
    }
}
//------------
// SCENES
...
class JojoScene {
    ...
    static routeJojoEncounter() {
        ...
        if (liveData.gameFlags[FLAG.JOJO_CAMP] > 0 || liveData.gameFlags[FLAG.JOJO_DEAD_OR_GONE] > 0) {
            ...
            else if (liveData.player.inte < 75)
        ...
        if (liveData.gameFlags[FLAG.JOJO_CORRUPTION_STAGE] == 0) {
            ...
            if (liveData.player.cor < 25)
                this.lowCorruptionJojoEncounter();
            else
                this.highCorruptionJojoEncounter();
        }
    ...
    static lowCorruptionJojoEncounter() {
        GUI.clearOutput();
        this.jojoSprite();
        GUI.outputText("Tired of exploring the forest for the moment, you decide to head back to camp. Not feeling like taking the scenic route, you move to step through some bushes, but immediately your mind registers a yelp. The instant you move to look at the source of the noise, a white blur smacks you right on your head.");
        //Variant checks
        if (liveData.player.tou >= 50 && liveData.player.isBiped())
            GUI.outputText(" You take a few steps back, momentarily dazed. Shaking it off, you ready your [weapon] and assume a fighting stance.<br><br>");
        else if (liveData.player.tou < 50 && liveData.player.isBiped())
            GUI.outputText("The force of the blow knocks you flat on your [ass]. Shaking it off, you immediately climb to your feet and take on a fighting stance.<br><br>");
        else if (liveData.player.isTaur())
            GUI.outputText("The blow does little more than leave you momentarily dazed but isn't enough to knock you over. You shake it off and ready your [weapon] as you assume a fighting stance.<br><br>");
        // Was originally isNaga() only, but this will also cover Drider just as well
        else
            GUI.outputText("You recoil as you are struck, but the force of the blow does little more than leave you momentarily dazed. You assume a fighting stance, ready to defend yourself.<br><br>");
    ...
    static refuseJojosApology() {
        GUI.clearOutput();
        GUI.outputText("With a smile you curl up a fist and knock the unsuspecting mouse morph upside the head, causing him drop his staff and rub the spot where you slugged him. As he looks up at you you give his angry expression a shrug, telling him that now the two of you are even.<br><br>");
    ...
    static lowCorruptionIntro() {
        ...
        GUI.outputText("Now that you have the opportunity to take a good look at him, you notice that he is dressed in simple garbs reminiscent of a monk. A light-blue robe covers his flat chest, tied with a simple sash around his waist. His pants, similar to his robes, fit him snugly as well.<br><br>");
        GUI.outputText("His build is lithe, though you detect he isn't weak by any means. His handshake is firm and transmits confidence; it's clear that this mouse has trained well, though you can't see any hint of muscles with his robes covering him. His hair is short and as white as his fur, you'd guess he's an albino if not for his brown eyes. Surprisingly, he doesn't seem to be carrying anything on his person, save for a necklace made of beads.<br><br>"); // Can't really presume that they're holy without knowing much more about him, rite?
        GUI.outputText("He smiles knowingly, “<i>Yes I am a monk, and yes this is a strange place for one such as I... this world was not always this way. Long ago this world was home to many villages, including my own. But then the demons came. I'm not sure if they were summoned, created, or simply a perversion of magic or breeding, but they came swarming out of the mountains to destroy everything in their path.</i>”<br><br>");
    ...
    static highCorruptionJojoEncounter() {
        this.jojoSprite();
        GUI.outputText("While marvelling at the strange trees and vegetation of the forest, the bushes ruffle ominously. A bush seems to explode into a flurry of swirling leaves and movement. Before you can react you feel your " +
    ...
    static meditateInForest() {
        ...
        if (liveData.gameFlags[FLAG.JOJO_MEDITATION_COUNTER] >= 5) {
            ...
            if (liveData.gameFlags[FUCK_FLOWER_LEVEL] >= 4 && liveData.gameFlags[FUCK_FLOWER_KILLED] == 0 && liveData.gameFlags[FLAG.JOJO_MEDITATION_COUNTER] % 5 == 0) {
                ...
                if (liveData.player.hasKeyItem("Jojo's Talisman") >= 0) {
                    ...
                    GUI.outputText("<br><br>As much as you'd like to, you can't stay in the forest, and you can't invite him back with you right now. Reluctantly, you mention the stubborn, demonic godseed's presence on the borders of your camp. Jojo's eyebrows furrow in concentration.");
                    GUI.outputText("<br><br>\"<i>Yes, that's a problem. Oh, that we did not have to resist the very spirit of the land! [name], take this. Use it to call me if the demon gives you trouble; I will come and render what aid I can.</i>\" The monk fishes in his robe and places a small talisman into your hand.<br><br>(Gained Key Item: Jojo's Talisman)");
                ...
                GUI.outputText('"<i>It seems you have quite a talent for this. We should meditate together more often.</i>"');
        }
        ...
        if (liveData.gameFlags[FLAG.JOJO_MEDITATION_COUNTER] % 5 == 0) {
            ...
            GUI.outputText("<br><br>He bows his head sadly and dismisses you.");
        GUI.doNext(Camp.returnToCampUseTwoHours);
    }
    static acceptJojoIntoYourCamp() {
        ...
        if (liveData.gameFlags[FLAG.JOJO_RAPE_COUNTER] > 0 || liveData.gameFlags[JOJO_MOVE_IN_DISABLED] == 1) {
            ...
            GUI.clearOutput();
            GUI.outputText("You offer Jojo the chance to stay at your camp. He cocks his head to the side and thinks, stroking his mousey whiskers.<br><br>\"<i>Yes, it would be wise. We would be safer together, and if you like I could keep watch at night to keep some of the creatures away. I'll gather my things and be right there!</i>\"<br><br>Jojo scurries into the bushes, disappearing in a flash. Knowing him, he'll be at camp before you!");
    ...
    static jojoCamp() {
        ...
        if (liveData.player.cor > 10 && liveData.gameFlags[FLAG.JOJO_LAST_MEDITATION] != liveData.time.days) {
            ...
            if (liveData.player.cor >= 40)
                GUI.outputText('You walk toward the boulder where Jojo usually sits, and as soon as you\'re close Jojo approaches you with urgency. "<i>By Marae! [name], we must do something! I feel the corruption surrounding you like a dense fog. We need to meditate or I’m going to lose you!</i>" Jojo pleads.<br><br>');
            else
                GUI.outputText("You walk up to the boulder where Jojo usually sits, and see him sitting cross legged with his eyes closed. He seems to be deep in meditation, but when you approach his eyes open suddenly and he gets up appearing slightly distressed, “<i>Uh... [name], I can feel a bit of corruption within you. It is not much, but I think you should be concerned about it before it gets out of hand and you do something you might regret. If you want to I'd be happy to meditate with you as you rid yourself of it.</i>” he offers with a concerned look on his face.<br><br>");
            GUI.outputText("Do you accept Jojo's help?<br><br>");
            GUI.doYesNo(this.acceptOfferOfHelp, this.refuseOfferOfHelp);
            if (liveData.player.lust >= 33 && liveData.player.gender > 0 && liveData.gameFlags[FLAG.JOJO_CORRUPTION_STAGE] >= 0)
                GUI.addButton(4, "Rape", this.jojoAtCampRape);
        }
        else {
            //Normal shit
            if (liveData.player.cor > 10)
                GUI.outputText("You walk up to the boulder where Jojo usually sits, and see him sitting cross legged with his eyes closed. He seems to be deep in meditation, but when you approach his eyes open suddenly and he gets up appearing slightly distressed, “<i>Uh... [name], " +
                ...
                switch (UTIL.rand(3)) {
                    case 0:
                        GUI.outputText("You walk toward the boulder where Jojo usually sits, and see him cross legged with his eyes closed. At first he seems to be deep in meditation, but when you approach his mouth curls into a smile; he gets up and opens his eyes regarding you with a welcoming expression. “<i>Greetings [name], is there anything I can assist you with?</i>”<br><br>");
                        break;
                    case 1:
                        GUI.outputText("You walk up to the boulder where Jojo usually sits and find him a few paces behind it. He is standing and practicing his form, gracefully moving from one pose to the next. As you approach him you see his ears visibly perk and he turns his head towards you without breaking his stance, saying, “<i>Greetings [name], is there anything I can assist you with?</i>”<br><br>");
                        break;
                    default:
                        GUI.outputText('You find Jojo sitting cross-legged on a flat rock with his staff leaning against his shoulder, thinking. He looks to you and nods, "<i>Greetings, ' +
    ...
    static jojoCampMenu() {
        ...
        if (liveData.gameFlags[FLAG.UNLOCKED_JOJO_TRAINING] > 0)
            GUI.addButton(2, "Train", this.apparantlyJojoDOESlift, null, null, null, "Join him in a training session.");
        GUI.addButton(3, "Meditate", this.jojoFollowerMeditate);
        GUI.addButton(4, "N.Watch: " + (liveData.gameFlags[FLAG.JOJO_NIGHT_WATCH] > 0 ? "On" : "Off"), this.jojoDefenseToggle, null, null, null, liveData.gameFlags[FLAG.JOJO_NIGHT_WATCH] > 0 ? "Request him to stop guarding the camp." : "Request him to guard the camp at night.");
        if (liveData.player.findStatusEffect(StatusEffects.Infested) >= 0)
            GUI.addButton(5, "Purge", this.wormRemoval, null, null, null, "Request him to purge the worms from your body.");
        ...
        if (liveData.player.lust >= 33 && liveData.gameFlags[FLAG.JOJO_CORRUPTION_STAGE] <= -3)
            GUI.addButton(8, "Sex", this.pureJojoSexMenu, null, null, null, "Initiate sexy time with the mouse-morph.");
    ...
    static talkMenu() {
        ...
        if (liveData.gameFlags[TIMES_TALKED_WITH_JOJO] >= 4)
            GUI.addButton(4, "You", this.jojoTalkYourOrigin, null, null, null, "Tell him about Ingnam and your history.");
        if (liveData.gameFlags[FACTORY_SHUTDOWN] > 0)
            GUI.addButton(5, "Factory", this.jojoTalkFactory, null, null, null, "Tell him about how you've shut down the factory.");
        ...
        if (liveData.gameFlags[FLAG.UNLOCKED_JOJO_TRAINING] == 0 && liveData.gameFlags[TIMES_TALKED_WITH_JOJO] >= 4)
            GUI.addButton(7, "Training", this.apparantlyJojoDOESlift, null, null, null, "Ask him if he's willing to train you.");
        ...
        if (liveData.player.cor <= 10 && liveData.player.lust >= 33) {
            ...
            if (liveData.gameFlags[TIMES_TALKED_WITH_JOJO] < 4)
                GUI.addButtonDisabled(9, "Sex?", "You should socialize with Jojo a bit more.");
            if (liveData.gameFlags[FLAG.JOJO_RAPE_COUNTER] > 0)
                GUI.addButtonDisabled(9, "Sex?", "You've raped Jojo in the past, now you can't ask him out. Ya dun goofed.");
        }
        if (liveData.player.cor <= 10 && liveData.player.lust >= 33 && liveData.gameFlags[FLAG.JOJO_CORRUPTION_STAGE] == -1)
            GUI.addButtonDisabled(9, "Sex?", "You need to spend more time with Jojo. <br><br>Talk sessions: " +
    ...
    static jojoTalkVillage() {
        ...
        GUI.outputText("“Most of the people of Belridge were either fishers or farmers with huge families that stayed near the village. There were a few hunters and a few craftsmen. We made enemies of no one and sought to do no harm to others,</i>” Jojo says, his smile fading.<br><br>");
        ...
        GUI.outputText("“<i>My father was a fisherman. He was this calm, strong man with a lot of silver whiskers that always smelled like fish. I remember I used to go out on the boat with him and a few of my brothers and he'd always make sure to pick me up and put me on his shoulders... that is until I got too big. He always made everything look so easy, like the world was just there to shake his hand and make him smile. No one could cook seafood like he did, no one.</i>”<br><br>");
        GUI.outputText("“<i>Then there was my mother who was a little high strung, but no one could hug you more fiercely or love you more dearly. She was a small woman with a big soul who loved her family more than anything. She was a seamstress before she met my dad and was always the brightest one in the room, which is hard when you have seventeen loud children clamoring for your attention.</i>”<br><br>");
        GUI.outputText("“<i>Even with 19 people living under one roof my family wasn't the biggest family in town, but there was always plenty work and plenty food. It was a nice simple existence and I am thankful for the time I had with everyone in that village,</i>” he finishes with a serene smile.<br><br>");
        if (liveData.player.cor < 40)
            GUI.outputText("Looks like Jojo's childhood wasn't so bad... you thank the mouse morph monk for sharing his treasured memories with you now that the conversation is over.<br><br>");
        else
            GUI.outputText("Looks like Jojo's childhood wasn't so bad. A little sickly sweet and void of wet pussies and drooling dicks but not bad. You tell him you're happy to have him near you and he smiles for ear to ear, ignorant of your thoughts.<br><br>");
    ...
    static jojoTalkYourOrigin() {
        ...
        if (liveData.player.findPerk(PerkLib.HistoryAlchemist) >= 0) {
            ...
            if (liveData.silly)
                GUI.outputText("Savin");
            else
                GUI.outputText("Sellet");
    ...
    static jojoTalkSandCave() {
        ...
        //if PC spoke to Sand Mother after Fighting her, FRIENDLY is the overall victory flag (theres a separate flag used to indicate you dun wanna be attacked by sandbitches in the desert anymore)
            ...
            GUI.outputText("Jojo's head tils to the side as he says, “<i>Maybe the whole thing didn't need to come to an altercation in the first place, a little diplomacy on both sides....</i>” He gives you a pointed look, “<i>Might have gone a long way.</i>”<br><br>");
        }
        //if PC just spoke to the Sand Mother
            ...
            GUI.outputText("He marvels at the way you handled the situation, “<i>Many would have expected her trying to talk to them to be a trap [name] and hurried to attack her but not you... that is... wow [name], you are truly a great individual.</i>”<br><br>");
        }
        //if PC met bath slut
        if (liveData.gameFlags[FLAG.MET_MILK_SLAVE] == 1) {
            ...
            // [if {PC has bath slut in camp}
                ...
                GUI.outputText("He slaps his own forehead and says, “<i>Oh... yeah... right.</i>” Obviously embarrassed by not putting two and two together. He smiles good naturedly though, “<i>I don't know I guess I just assumed you found some poor mind addled soul and decided to save her.</i>” Jojo says as he looks over at " +
                ...
                if (liveData.gameFlags[FLAG.MILK_SIZE] == 0) {
                    ...
                    GUI.outputText("“<i>The coven wouldn't have done what you've done for her. You've given her a much, much better life and even aided in fixing her condition, you truly are a champion, [name],</i>” he says, giving you a fond smile and a pat on the back.<br><br>");
                }
            }
        }
        ...
        if (liveData.gameFlags[FLAG.CUM_WITCH_DEFEATED] == 1 || liveData.gameFlags[FLAG.BEEN_BLESSED_BY_CUM_WITCH] == 1) {
            GUI.outputText("You tell Jojo about the cum witch, the herm witch responsible for inseminating the witches there, acting as a father to the others. When you do he scratches his ear, “<i>Like I said, I don't get why sex is so overly important to these creatures but whatever, continue.</i>”<br><br>");
            ...
            if (liveData.gameFlags[FLAG.MORE_CUM_WITCHES] == 1) {
                ...
                GUI.outputText("He whistles low, “<i>That's a bold move [name]. It seems like they would want that though, it'd allow them to, er, you know... more often, and make more sand witches in the long run wouldn't it?</i>” As the question sound rhetorical you plow on ahead.<br><br>");
            }
            //[if {PC allowed Cum Witches to rome}
            else if (liveData.gameFlags[FLAG.CUM_WITCHES_FIGHTABLE] == 1) {
                GUI.outputText("You describe to him how you convinced the Sand Mother to allow her cum witches to rome the desert along with the sand witches and he looks at you with astonishment, “<i>You are a generous spirit [name] and this Sand Mother doesn’t seem entirely unreasonable.</i>”<br><br>");
            }
    ...
    static apparantlyJojoDOESlift() {
        ...
        if (liveData.player.findPerk(PerkLib.ControlledBreath) < 0 && liveData.player.findPerk(PerkLib.CleansingPalm) < 0 && liveData.player.findPerk(PerkLib.Enlightened) < 0) {
            ...
            if (liveData.gameFlags[TIMES_TRAINED_WITH_JOJO] == 5) {
                ...
                GUI.outputText("Jojo's constantly repeated words resonate within you as you realize you've learned to control your breathing. It takes you less time to rest than normal and you feel as though you are bursting with energy because of it. Your [fullChest]");
                if (liveData.player.biggestTitSize() == 0)
                    GUI.outputText(" rises and falls");
                else
                    GUI.outputText(" rise and fall");
        ...
        //{after PC has gained the Enlightened Perk}
            ...
            if (liveData.gameFlags[MARBLE_CAMP] > 0)
        ...
        if (liveData.player.str < 80)
            liveData.player.modStats(["str", 0.5]);
        if (liveData.player.inte < 50)
            liveData.player.modStats(["inte", 0.5]);
        if (liveData.player.inte < 80)
            liveData.player.modStats(["inte", 0.5]);
        GUI.menu();
        GUI.doNext(Camp.returnToCampUseOneHour);
    }
    static jojoFollowerMeditate(doClear = false) {
        ...
        if (liveData.gameFlags[FLAG.JOJO_LAST_MEDITATION] == liveData.time.days) {
            ...
            if (liveData.player.str < 45)
                liveData.player.modStats(["str", 1]); //Str boost to 45
            if (liveData.player.tou < 45)
                liveData.player.modStats(["tou", 1]); //Tou boost to 45
            if (liveData.player.spe < 75)
                liveData.player.modStats(["spe", 1]); //Speed boost to 75
            if (liveData.player.inte < 80)
                liveData.player.modStats(["int", 1]); //Int boost to 80
            if (liveData.player.lib > 0)
                liveData.player.modStats(["lib", -1]); //Libido lower to 15
    ...
    static wormRemoval() {
        ...
        if (liveData.player.HP > liveData.player.maxHP() * 0.5)
            liveData.player.HP = Math.floor(liveData.player.maxHP() * 0.5);
    ...
    static offerSexFirstTime() {
        ...
        GUI.outputText("<br><br>\"<i>I-I can't... I made a vow of chastity... I can't simply break my vows... please understand, [name]...</i>\" he says gazing at you apologetically, though you detect just the slightest hint of desire in his eyes before he averts his gaze and shakes his head of whatever thoughts could be plaguing it.");
        GUI.outputText('<br><br>You acknowledge his position and excuse yourself, but before you can leave he calls out to you. "<i>Wait, [name]!</i>" he says getting up and moving towards you. "<i>While I can\'t really have sex with you, that doesn\'t mean I can\'t help you. If you want we could meditate to help you... umm... restrain your needs?</i>" he suggests.');
        liveData.gameFlags[FLAG.JOJO_CORRUPTION_STAGE] = -1;
    ...
    static offerSexFirstTimeHighAffection() {
        ...
        if (liveData.player.inte >= 60 && liveData.player.cor <= 10)
            GUI.addButton(2, "Confront", this.confrontChastity);
    }
    static confrontChastity() {
        GUI.clearOutput();
        GUI.outputText("He cannot keep his vows forever. After all, he's missing out on the pleasure! He probably never knew how he would feel if he has a perfect cock that fits perfectly in his butthole or his cock that fits perfectly in a vagina or an anus. He should be fine as long as he stays faithful to you.");
        ...
        GUI.outputText("<br><br>\"<i>Well... young one, you're right. You did spend time together with me. We've meditated, I've taught you some important lessons and now we're here,</i>\" Jojo says hesitantly but he starts to smile, \"<i>Let's have sex; I want to experience.</i>\"");
        ...
        if (liveData.silly)
            GUI.outputText("<b> Jojo can only learn four moves. Delete a move to learn a new one? Yes. 1... 2... 3... Poof! Jojo has forgot Chastity and learned Sex!</b>");
    ...
    static pureJojoSexMenu() {
        //Capacity
        var capacity = 40;
        if (liveData.gameFlags[FLAG.JOJO_ANAL_XP] < 10)
            capacity += liveData.gameFlags[FLAG.JOJO_ANAL_XP] * 3;
        else
        ...
        if (liveData.gameFlags[FLAG.JOJO_SEX_COUNTER] < 3)
            GUI.outputText('Jojo looks into your eyes and says, "<i>Only if you\'re going to be gentle.</i>"');
        else
            GUI.outputText('Jojo looks into your eyes and says, "<i>Yes, young one. Let\'s go.</i>"');
        ...
        GUI.menu();
        if (liveData.player.hasCock() && liveData.player.cockThatFits(capacity) >= 0)
            GUI.addButton(0, "Anal Pitch", this.anallyFuckTheMouseButtSlut, null, null, null, "Fuck the monk mouse-morph's butt.");
        ...
        if (liveData.player.hasVagina())
            GUI.addButton(2, "Vaginal Catch", this.getVagFuckedByMouse, null, null, null, "Have Jojo penetrate you vaginally.");
    ...
    static anallyFuckTheMouseButtSlut() {
        ...
        if (liveData.gameFlags[FLAG.JOJO_ANAL_XP] == 0)
            GUI.outputText("You finally make up your mind; you want to stuff your cock into that tight ass of his. " + liveData.player.clothedOrNaked("You remove your [armor] and ") + "Jojo hesitantly strips out of his robe, revealing his naked form.");
            ...
            GUI.outputText("You decide that you want to stuff your cock into that tight ass of his again. " + liveData.player.clothedOrNaked("You remove your [armor] and ") + "Jojo without hesitation strips out of his robe, revealing his naked form.");
        //First and second time
        if (liveData.gameFlags[FLAG.JOJO_ANAL_XP] < 3) {
            //Intro
            if (liveData.gameFlags[FLAG.JOJO_ANAL_XP] < 1)
                GUI.outputText('<br><br>"<i>Just go gentle,</i>" Jojo says with a whimpered look on his face as he gets down on all fours.');
            else
                GUI.outputText('<br><br>"<i>Even though we\'ve done it before, still, just go gentle please,</i>" Jojo says with a whimpered look on his face as he gets down on all fours.');
            ...
            if (liveData.gameFlags[FLAG.JOJO_ANAL_XP] < 1)
                GUI.outputText("It's a bit too tight to suddenly insert your " +
                ...
                GUI.outputText('You decide to test it out again. You warn Jojo that you\'ll be inserting your hand in first. Jojo says, "<i>If you have to.</i>" You slick your fingers up with some saliva, and then gently start to probe Jojo’s pucker, testing out the looseness.');
            ...
            if (liveData.gameFlags[FLAG.JOJO_ANAL_XP] < 1)
                GUI.outputText("You stretch out Jojo's bowels as much as you can and it should be just enough for insertion. ");
            else
                GUI.outputText("Hmm... his ass seems more stretched out compared to last time; you should be able to insert without worry. ");
            //Get lubed up and get your cock into Jojo's anus.
            GUI.outputText("<br><br>You spit on your hands and apply saliva evenly all over your " +
                liveData.player.cockDescript(x) +
            ...
            if (liveData.gameFlags[FLAG.JOJO_ANAL_XP] < 1) {
                ...
                GUI.outputText("<br><br>Now spent, you lay next to Jojo. There's small trail of cum leaking out of Jojo's ass. \"<i>It's a new experience. I'm willing to try it again,</i>\" Jojo says smilingly. You smile knowingly; you knew the two of you will do this often.");
            }
            else {
                ...
                GUI.outputText("<br><br>Now spent, you lay next to Jojo. There's small trail of cum leaking out of Jojo's ass. You tell Jojo that he's seems to really like anal. Jojo blushes. You laugh, telling your little butt slut that there more in store for him.");
            }
        }
        //Third+ time
        else {
            ...
            //Check anal tightness
            GUI.outputText("<br><br>His eagerness makes your " +
            ...
            GUI.outputText("<br><br>Jojo starts panting in arousal. You ask him is he's ok. Jojo gives you a thumbs-up. \"<i>I'm... fine. Keep going.</i>\" His cock reaches full erection, ready to cum at any time. You smile at him and start to pick up the pace while keeping it at comfortable level. As you feel his loosening up, you decide to go faster and harder. Jojo starts moaning in both ecstasy and pain, releasing a shrill squeak with every thrust. ");
            //ORGASM!
            GUI.outputText("<br><br>Eventually, you can't hold back any more and you unleash your seed right into his bowels. ");
        ...
        //The End
        if (liveData.gameFlags[FLAG.JOJO_SEX_COUNTER] >= 4)
            GUI.outputText("He plants a kiss on your lips.");
    ...
    static getAnallyFuckedByMouseYouSlut() {
        ...
        GUI.clearOutput();
        GUI.outputText("You finally make up your mind; you want his mouse-cock in your [ass]. " +
        ...
        GUI.outputText('<br><br>"<i>Get down on all fours and I can begin,</i>" Jojo instructs. You nod and get down on all fours, presenting your [butt] to Jojo. His cock grows to full erection. "<i>I\'m going to need to get this lubricated first,</i>" Jojo says. He spits on his hands and applies the saliva evenly across his cock.');
        ...
        if (isVirgin)
            GUI.outputText(" \"<i>That's really tight; I'm going to enjoy your tightness while it lasts,</i>\" Jojo remarks. ");
        else if (liveData.player.looseness(false) < 2)
            GUI.outputText(' "<i>That\'s tight,</i>" Jojo says. ');
        else
            GUI.outputText(' "<i>That\'s nice,</i>" Jojo remarks. ');
        GUI.outputText("Slowly, he begins to rock his hips back and forth, placing his hands on your [hips] for support. ");
        GUI.outputText('<br><br>"<i>Does it feel good, [name]?</i>" Jojo asks. You reply that you wish he would go a little faster. Wanting to please you, Jojo start thrusting his erect cock into you farther and faster than before. You start moaning in pleasure as his penis hollows out your insides.');
        GUI.outputText('<br><br>As the tension builds, Jojo keeps thrusting faster and faster. Not wanting him to be left out, you start moving in time with him and taking his cock up to the hilt. Jojo moans louder and shouts, "<i>I’m going to cum!</i>" Jojo rams you one last time hitting your prostate with all he’s got. He starts dumping his massive load into you' +
        ...
        if (liveData.player.hasCock())
            GUI.outputText("[EachCock] twitches with pleasure, soaking the ground beneath you with a small lake of cum. ");
        if (liveData.player.hasVagina())
            GUI.outputText("Your [pussy] spontaneously " + (liveData.player.averageVaginalWetness() >= 4 ? "sprays" : "leaks") + " juices all over the ground. ");
        if (liveData.player.gender == 0)
            GUI.outputText("Your body rocks with ecstasy. ");
        GUI.outputText('<br><br>His cock slides out of your [ass] with a pop. Cum start dripping out of your [ass]. "<i>That was... You were amazing, [name].</i>" You smile at him while rubbing your inflated belly and tell him he wasn’t too bad himself. ' +
    ...
    static getVagFuckedByMouse() {
        ...
        if (liveData.gameFlags[JOJO_VAGINAL_CATCH_COUNTER] == 0) {
            ...
            GUI.outputText("<br><br>You orgasm at the same time, spraying girlcum all over Jojo" +
    ...
    static suckJojosCock() {
        ...
        GUI.outputText('<br><br>You lick your lips in anticipation. "<i>Thank you for the meal,</i>" you say as you start licking his shaft from the cock head all the way to the balls. The first thing that hits you is the taste. Jojo’s cock tasted like sweat and old cheese which, surprisingly, tasted arousing. Combined with the heady scent of musk, it took all your self-control not to pounce on him. ');
        GUI.outputText("<br><br>Jojo starts moaning around the time you got to his balls. When you look up, you notice some pre coming out. You let go of his wet balls and started lapping up his precum. It tasted salty, making a great appetizer. You start massaging Jojo’s balls to keep the precum coming. Unnoticed to you, Jojo had been slowly moving his hands behind you. He suddenly grabs hold of your [hair] and forces your head back all the way to his hilt. Surprised and almost choking, you try to force your head back, but Jojo holds you firmly. You look up at Jojo see him panting in arousal, his eyes unfocused. Damn, you pushed him too far. Oh well, you kind of like it rough anyway.");
        GUI.outputText('<br><br>Instead of resisting him, you start moving in time with him, deep-throating his tasty cock. Jojo start moaning louder and started rocking his hips back and forth rapidly. It felt like he was raping your throat. Jojo didn’t seem to be cumming anytime soon and you were getting impatient. You suddenly jab your finger into Jojo’s ass and stimulate his prostate. Panting, Jojo shouts, "<i>I’m gonna cum!</i>" and pull your head forward as much as possible. Hot cum came gushing out like a hose, instantly ' +
        ...
        if (liveData.gameFlags[FLAG.JOJO_BLOWJOB_XP] <= 0)
            GUI.outputText('<br><br>Jojo collapses on his back, winded. When he comes up, he says, "<i>I can\'t feel my legs... I don\'t know what came over me, sorry [name].</i>" You rub your full belly and smile and tell him he’ll have to make it up to you. He asks “How, I’ll do anything.” You tell him that the next time they eat it’s his treat. You lean in close and tell him that you prefer mouse-spunk. Jojo blushes and you lean back and says with a smile, "<i>Um... sure. Since I made a promise, I’ll have to fulfill it.</i>"');
        else
            GUI.outputText("<br><br>Jojo collapses on his back, winded. When he comes up, you say that was delicious and to treat you next time as well. Jojo's too tired to say anything, but smiles in response.");
        GUI.outputText("<br><br>After a good while of rest, " + liveData.player.clothedOrNaked("the two of you get redressed and", "Jojo gets redressed and the two of you") + " return to your camp.");
        if (this.jojoCumQ() < 2500)
            liveData.player.refillHunger(this.jojoCumQ() / 25);
        else
            liveData.player.refillHunger(100);
        ...
        if (liveData.gameFlags[FLAG.JOJO_CORRUPTION_STAGE] <= 3) {
            ...
            if (liveData.player.lust >= liveData.player.maxLust()) {
                if (liveData.player.gender == 1) {
                    GUI.outputText("Too aroused to think, you just bend over, displaying your bum and letting your " +
                        liveData.player.multiCockDescriptLight() +
                    ...
                    if (liveData.player.cockTotal() == 1)
                        GUI.outputText("Pre and cum drip from your " +
                ...
                if (liveData.player.gender >= 2) {
                    GUI.outputText("Too aroused to think, you bend over, displaying your bum and " +
                    ...
                    if (liveData.player.cockTotal() > 1)
                        GUI.outputText("Your " + liveData.player.cockDescript(0) + " splatters the ground with cum repeatedly, until both your genders are raw and sore. ");
                    else
                        GUI.outputText("Your " + liveData.player.vaginaDescript(0) + " cums on him many more times it until it is sore and tender, dripping with spunk. ");
                ...
                if (liveData.player.gender == 0) {
                    GUI.outputText("Too aroused to think, you just bend over, displaying your bum and wiggling enticingly. The mouse doesn't hesitate, and he thrusts his " +
                        liveData.monster.cockDescriptShort(0) +
                        " with painful force. You stagger from the size and struggle to stay conscious as he fucks you like a mad beast, hammering your ass with incredible force.");
                    liveData.player.buttChange(liveData.monster.cockArea(0), true);
                    GUI.outputText("You feel a flash of warm wetness inside you, and realize Jojo is cumming. A sense of relief washes over you as the last burst of cum squirts out from your cheeks, only to be replaced with a dawning sense of horror as he continues fucking you harder than ever.<br><br>");
    ...
    static defeatedJojo(hpVictory) {
        if (liveData.player.lust > 33 && liveData.player.gender > 0) {
            GUI.clearOutput();
            GUI.outputText("You smile in satisfaction as Jojo" +
    ...
    static postCombatRape() {
        ...
        if (liveData.gameFlags[FLAG.JOJO_CORRUPTION_STAGE] == 5)
            GUI.outputText("fuck your violent little slut senseless. ");
        else
            GUI.outputText("teach the uppity monk a lesson...<br><br>");
    ...
    static jojosFirstRape() {
        ...
        if (liveData.player.gender == 1) {
            //Males
            GUI.outputText("You push him hard, following through to pin his small frame. He struggles but you twist his arm expertly and hold him down with your larger bodyweight. He squirms as you tear off the bottom of his outfit, protesting mightily as you force him into the dirt and expose his toned bottom.<br><br>");
            if (liveData.player.cockTotal() == 1) {
                GUI.outputText("You grin and press your " +
                    liveData.player.cockDescript(0) +
                ...
                GUI.outputText("With a satisfied sigh, you pull your " +
                    liveData.player.cockDescript(0) +
            ...
            //Females
            GUI.outputText("You smack the back of his head hard, dazing him. You spin him around as you take his feet out from under him, one hand pulling his pants while the other slashes his belt. He literally 'falls out of his pants' and onto the soft earth of the forest. You pounce on the stunned monk, " +
            ...
            if (liveData.player.wetness() < 2)
                GUI.outputText("but the sensation of you grinding your folds against him momemtarily breaks his will. ");
            else
                GUI.outputText("but the feeling of your " + liveData.player.vaginaDescript(0) + " grinding against his hardening cock robs him of any will. ");
            ...
            GUI.outputText("He lets out little grunts and whines of protest as you ride him hard, but quickly cums. The flood of warmth inside your canal only serves to spur you on, slamming your " +
                liveData.player.vaginaDescript(0) +
            ...
            if (liveData.player.biggestLactation() >= 1 && liveData.player.biggestLactation() < 2)
                GUI.outputText(" Milk squirts from your nipples, spraying him down with small droplets of your creamy tit-treat.");
            ...
            if (liveData.player.biggestLactation() >= 3)
                GUI.outputText(" Gouts of milk erupt from your nipples, spraying continually as you cum. The poor mouse is soaked from head to toe, your cream utterly drenching the monk.");
            ...
            if (liveData.player.cockTotal() == 1) {
                ...
                if (liveData.player.biggestLactation() >= 3)
                    GUI.outputText(" Gouts of milk erupt from your nipples, spraying continually as you cum. The poor mouse is soaked from head to toe, your cream utterly drenching the monk. ");
                GUI.outputText("<br><br>With a satisfied sigh, you pull your " +
                    liveData.player.cockDescript(0) +
                    " out with an audible 'pop'. Your cum begins leaking out, pooling under him and mixing with his own. The little guy must have cum hard, he seems fairly comatose. As you leave your senseless victim, you realize you feel more satisfied than you have in a while, almost like you've cum so hard it took some of your libido with it.");
            }
            else {
    ...
    static jojosSecondRape() {
        ...
        if (liveData.player.gender == 1) {
            GUI.outputText("You force Jojo over a log, running your hands through his fur and slapping his ass. He grunts, but it's impossible to tell if it's in frustration, anger, or arousal. You quickly force yourself back into his ass, finding it noticably stretched from your last incursion. ");
            if (liveData.player.averageCockThickness() >= 3)
                GUI.outputText("It makes little difference to your " + liveData.player.cockDescript(0) + ", he still feels tight as a virgin's cunt to you. ");
            GUI.outputText("You grab him by the waist and fuck him powerfully, slamming your " +
                liveData.player.cockDescript(0) +
            ...
            if (liveData.player.cockTotal() > 1)
                GUI.outputText(" Your remaining equipment showers him with jizz, more than you ever thought you could produce.");
            ...
            GUI.outputText("Eventually it ends, and you drop him into the puddled spooge like a used condom. He lays there, idly stroking himself in a daze, his prick still swollen with need and dripping fluids. You can't wait to corrupt him some more.");
        }
        if (liveData.player.gender == 2 || liveData.player.gender == 3) {
            GUI.outputText("You throw him on the soft soil of the forest and mount him, skillfully guiding his member towards your now dripping wet hole. As you slide down you marvel at how he feels larger and thicker than before, deliciously so. Your " +
                liveData.player.vaginaDescript(0) +
            ...
            if (liveData.player.biggestLactation() >= 3)
                GUI.outputText("Gouts of milk erupt from your nipples, spraying continually as you cum. The poor mouse is soaked from head to toe, your cream utterly drenching the monk. ");
            if (liveData.player.averageVaginalWetness() == 5)
                GUI.outputText("Your " + liveData.player.vaginaDescript(0) + " drenches him with your squirting girl-cum, mixed with his own seed.");
            if (liveData.player.cockTotal() == 1)
                GUI.outputText("Jizz sprays onto his chest from your " + liveData.player.cockDescript(0) + ". ");
            if (liveData.player.cockTotal() == 2)
                GUI.outputText("A hail of jizz splatters over Jojo from your " + liveData.player.multiCockDescriptLight() + ". ");
            if (liveData.player.cockTotal() == 3)
                GUI.outputText("A multitude of thick cum-streams splatter over Jojo from head to waist as your " + liveData.player.multiCockDescriptLight() + " hose him down. ");
    ...
    static jojosThirdRape() {
        ...
        if (liveData.player.gender == 1) {
            ...
            if (liveData.player.cockTotal() == 1) {
                ...
                GUI.outputText("presenting your " + liveData.player.multiCockDescriptLight() + " to him. ");
            ...
            if (liveData.player.cockTotal() == 1)
                GUI.outputText("to ram your " + liveData.player.cockDescript(0) + " deep into his maw. You roughly grab his ears, facefucking him hard, his tongue working hard to please. ");
            if (liveData.player.cockTotal() > 1)
                GUI.outputText("to cram two cocks deep into his maw, making his jaw stretch obscenely. You roughly grab his ears, facefucking him hard, his tongue working hard to please you. ");
            GUI.outputText("One of Jojo's paws is buried in his groin, stroking his " +
                liveData.monster.cockDescriptShort(0) +
            ...
            if (liveData.player.cockTotal() == 1)
                GUI.outputText("Your " + liveData.player.cockDescript(0) + " clenches tightly, erupting ");
            if (liveData.player.cockTotal() > 1)
                GUI.outputText("Your twin dicks clench tightly, erupting ");
            GUI.outputText("hot seed into the now meek and subdued bitch-boy. His throat squeezes around you as he presses his nose tightly against your crotch, pulling as much of you in as he can. Mouse-spunk spatters your legs as he cums with you.<br><br>");
            if (liveData.player.lib > 60 && liveData.player.cor > 40) {
                ...
                if (liveData.player.cockTotal() == 1)
                    GUI.outputText("violating his loosened sphincter, and begin to fuck him hard. He whimpers with a mixture of pain and pleasure, your spit-lubed " +
                        liveData.player.cockDescript(0) +
        ...
        if (liveData.player.gender == 2) {
            ...
            if (liveData.player.isBiped())
                GUI.outputText("You spread your legs and crook your finger");
            else
                GUI.outputText("You crook your finger");
            GUI.outputText(", beckoning him towards your " +
                liveData.player.vaginaDescript(0) +
            ...
            if (liveData.player.lowerBody == LOWER_BODY_TYPE_NAGA)
                GUI.outputText("your coils ");
            else if (liveData.player.lowerBody == LOWER_BODY_TYPE_GOO)
                GUI.outputText("your jiggling goo ");
            else
                GUI.outputText("your thighs ");
            GUI.outputText("around his head and quiver with passion, ");
            if (liveData.player.averageVaginalWetness() <= 1)
                GUI.outputText("squeezing him tightly into your " + liveData.player.vaginaDescript(0) + ".");
            if (liveData.player.averageVaginalWetness() > 1 && liveData.player.averageVaginalWetness() <= 3)
                GUI.outputText("creaming his tongue liberally with girlcum.");
            if (liveData.player.averageVaginalWetness() == 4)
                GUI.outputText("creaming all over him with your slobbering pussy.");
            if (liveData.player.averageVaginalWetness() == 5)
                GUI.outputText("splattering him with girlcum from your " + liveData.player.vaginaDescript(0) + ".");
            GUI.outputText("<br><br>You pull the cunt-dazed mouse away reluctantly, and bend over,");
            if (liveData.player.isBiped())
                GUI.outputText(" spreading your legs and");
            GUI.outputText(" shaking your rump. ");
            if (liveData.player.hasLongTail() > 0)
                GUI.outputText("Your tail swishes back and forth teasingly. ");
            GUI.outputText("Your tantalizing backside is too much for him. He pounces your ass in a second, penetrating your " +
                liveData.player.vaginaDescript(0) +
        ...
        if (liveData.player.gender == 3) {
            ...
            if (liveData.player.isBiped())
                ...
                GUI.outputText("You crook your finger");
            GUI.outputText(", beckoning him towards your " + liveData.player.vaginaDescript(0) + ". He looks disheartened, but obediently kneels before you, his whiskers tickling, his wet nose bumping your clit, his tongue taking long licks between your lips. ");
            if (liveData.player.cockTotal() == 1)
                GUI.outputText("You sigh as your " + liveData.player.cockDescript(0) + " droops over his head. ");
            if (liveData.player.cockTotal() > 1)
                GUI.outputText("You sigh as your " + liveData.player.multiCockDescriptLight() + " pile atop his head. ");
            if (liveData.player.biggestTitSize() >= 2) {
            ...
            if (liveData.player.averageVaginalWetness() <= 1)
                GUI.outputText("squeezing him tightly into your " + liveData.player.vaginaDescript(0) + ".");
            if (liveData.player.averageVaginalWetness() > 1 && liveData.player.averageVaginalWetness() < 4)
                GUI.outputText("creaming his tongue liberally with girlcum.");
            if (liveData.player.averageVaginalWetness() == 4)
                GUI.outputText("creaming all over him with your slobbering pussy.");
            if (liveData.player.averageVaginalWetness() >= 5)
                GUI.outputText("splattering him with you girlcum from your " + liveData.player.vaginaDescript(0) + ".");
            if (liveData.player.cockTotal() > 0)
                GUI.outputText(" Thick runners of your pre dribble down his neck, sticking to his fur. ");
            GUI.outputText("<br><br>You pull the cunt-dazed mouse away reluctantly, and bend over,");
            if (liveData.player.isBiped())
                GUI.outputText(" spreading your legs and");
            GUI.outputText(" shaking your rump. ");
            ...
            liveData.player.cuntChange(2, true);
            if (liveData.player.cockTotal() == 1)
                GUI.outputText("Your " + liveData.player.cockDescript(0) + " trembles in orgasm, squirting your load into the thick forest loam. ");
            if (liveData.player.cockTotal() > 1)
                GUI.outputText("Your " + liveData.player.multiCockDescriptLight() + " tremble in orgasm, squirting their hot loads all over the thick forest loam. ");
            GUI.outputText("<br><br>");
            GUI.outputText("You let the drained mouse pop free, reveling in the sensation of cum pouring from ");
            if (liveData.player.isBiped())
                GUI.outputText("between your thighs");
    ...
    static jojosFourthRape() {
        GUI.outputText("Jojo flops down, eyes filled with anticipation. His self-control has really slipped away. The corrupted and horny mouse on display here is anathema to the studious monk you met before. His cock is close to a foot long and over two inches thick, veiny with arousal.<br><br>");
        if (liveData.player.gender == 1) {
            //Male Version
            GUI.outputText("The mousy former-monk kneels as you disrobe, his will nearly broken by desire. ");
            if (liveData.player.cockTotal() == 1)
                GUI.outputText("You touch his head softly and guide him to your " +
                    liveData.player.cockDescript(0) +
            ...
            if (liveData.player.cumQ() > 25)
                GUI.outputText("Your constant stream of heavy pre practically chokes the poor mouse as he edges you mercilessly, his own equipment drizzling in sympathetic lust. ");
            GUI.outputText("Jojo presses his paw hard into your ass, squeezing your prostate tightly as his hot muzzle dives deeply over your cock. You feel the building tightness of your orgasm and pull him tightly against you as the pressure builds. ");
            if (liveData.player.cumQ() < 25)
                GUI.outputText("You buck against him as you orgasm, your small squirts of cum eagerly devoured by the slutty mouse.");
            if (liveData.player.cumQ() >= 25 && liveData.player.cumQ() < 250)
                GUI.outputText("You buck against him as you orgasm, the slutty mouse's throat squeezing against you as he works to swallow your seed.");
        ...
        if (liveData.player.gender == 2 || liveData.player.gender == 3) {
            ...
            GUI.outputText("You touch his head softly, guiding him to your " +
                liveData.player.vaginaDescript(0) +
            ...
            if (liveData.player.isBiped())
                GUI.outputText(" brushes against your calf");
            else
                GUI.outputText(" brushes against your [leg]");
            GUI.outputText(". You get a devilish idea, ");
            if (liveData.player.lowerBody == LOWER_BODY_TYPE_GOO)
                GUI.outputText("and push his " +
                    liveData.monster.cockDescriptShort(0) +
            ...
            if (liveData.player.averageVaginalWetness() <= 1)
                GUI.outputText("You clamp down on his muzzle as you writhe in orgasm. ");
            if (liveData.player.averageVaginalWetness() > 1 && liveData.player.averageVaginalWetness() <= 3)
                GUI.outputText("Your legs trap his muzzle in your " + liveData.player.vaginaDescript(0) + " as orgasm wracks your body. ");
            if (liveData.player.averageVaginalWetness() == 4)
                GUI.outputText("Your legs trap his muzzle in your " + liveData.player.vaginaDescript(0) + ", slicking his muzzle with girlcum as you spasm with bliss. ");
            if (liveData.player.averageVaginalWetness() == 5)
                GUI.outputText("Your legs squeeze him against your " + liveData.player.vaginaDescript(0) + ", girlcum erupting over his face and soaking him as you bliss out with orgasm ");
            if (liveData.player.cockTotal() == 1)
                GUI.outputText("Your " + liveData.player.cockDescript(0) + " drizzles cum in his hair, some dripping off by his ear. ");
            if (liveData.player.cockTotal() > 1)
                GUI.outputText("Your " + liveData.player.cockDescript(0) + "s drizzle him with cum, covering his head with thick white streams of your jizz. ");
            GUI.outputText("Twitching weakly with pleasure, you fall back.<br><br>");
            //Fux!
            GUI.outputText("The pleasure was magnificent... but you want MORE. You push yourself up, feeling pleased as you spy Jojo stroking his cum-slick " +
                liveData.monster.cockDescriptShort(0) +
                ...
                liveData.monster.cockDescriptShort(0) +
                ". ");
            if (liveData.player.averageVaginalLooseness() == 0)
                GUI.outputText("He is painfully large, so much so that you feel more pain than pleasure. ");
            if (liveData.player.averageVaginalLooseness() == 1)
                GUI.outputText("He stretches you around him like a latex glove, pulling your " +
                    liveData.player.vaginaDescript(0) +
                    " taught with his " +
                    liveData.monster.cockDescriptShort(0) +
                    ", the sensation riding a razor's edge between pleasure and pain. ");
            if (liveData.player.averageVaginalLooseness() == 2)
                GUI.outputText("His " + liveData.monster.cockDescriptShort(0) + " stuffs you completely, filling your " + liveData.player.vaginaDescript(0) + " to capacity. ");
            if (liveData.player.averageVaginalLooseness() == 3)
                GUI.outputText("His " + liveData.monster.cockDescriptShort(0) + " fits you perfectly, burying deep inside your folds. ");
            if (liveData.player.averageVaginalLooseness() == 4)
                GUI.outputText("You easily accomadate his member into your " + liveData.player.vaginaDescript(0) + ". ");
            if (liveData.player.averageVaginalLooseness() == 5)
                GUI.outputText("His " + liveData.monster.cockDescriptShort(0) + " slips inside your " + liveData.player.vaginaDescript(0) + ' with little resistance, easily sinking in to the hilt. You muse to yourself, "<i>If only he were thicker...</i>" ');
            GUI.outputText("You ride him slowly, gyrating your hips in tiny grinding circles while you run your hands through his fur. His hips bounce you gently with tiny twitching thrusts, cum pooling out of your " +
                liveData.player.vaginaDescript(0) +
                " as it continues to drip from him. ");
            GUI.outputText("He gradually ups the tempo, and you are forced to go along for the ride as you begin to bounce on his " +
                liveData.monster.cockDescriptShort(0) +
            ...
            if (liveData.player.cockTotal() > 0) {
                ...
                if (liveData.player.cockTotal() == 1) {
                    ...
                    //Else
                    if (liveData.player.normalCocks() == 1)
                        GUI.outputText("Your " + liveData.player.cockDescript(0) + " twitches, muscle contractions slowly working their way up from the base. ");
                    //CUMSPLOISION
                    if (liveData.player.cumQ() < 25)
                        GUI.outputText("Your body tenses and cums, spraying spurts of jizz over the mouse. ");
                    if (liveData.player.cumQ() >= 25 && liveData.player.cumQ() < 250) {
                        if (liveData.player.countCocksOfType(ENUM.CockType.HORSE) == 1)
                            GUI.outputText(" Your " + liveData.player.cockDescript(0) + " flares wildly as musky horse-cum erupts from it, splattering over Jojo. ");
                        if (liveData.player.countCocksOfType(ENUM.CockType.DOG) == 1)
                            GUI.outputText("The terrible pressure in your " +
                                liveData.player.cockDescript(0) +
            ...
            if (liveData.player.biggestLactation() >= 1 && liveData.player.biggestTitSize() > 3) {
                ...
                if (liveData.player.biggestTitSize() * liveData.player.biggestLactation() * liveData.player.breastRows.length >= 35)
                    GUI.outputText("Milk fountains from your " +
            ...
            //The end
            if (liveData.player.lib > 50 && liveData.player.cor > 80) {
                GUI.outputText('<br><br><b>You feel a familiar power growing within you and decide to unleash it.</b> You grab the prayer beads from his outfit and spit on them, making them slick and wet. Holding them below his flagging cock, you focus on the demonic visions in your mind, slowly but constantly milking larger and larger dollops of cum onto the once holy beads. Jojo moans as he comes to understand your intent, and turns around, shaking his lithe mouse-bum at you. You lean over him, whispering into his ear, "<i>Each defiled bead I push into you is going to make you more of a willing slut. More of a willing receptacle for demon cum. More of a fountain of desire waiting to be tapped by Succubi. More my toy.</i>"<br><br>');
                GUI.outputText('He whimpers as you slide the first bead in, his eyes growing foggy and his bum wiggling more eagerly. You push the second bead inside him, and feel his asshole stretch and loosen, welcoming the corruption. The third bead slips right in, and he moans, "<i>sluuuut</i>," His cock grows longer and thicker throughout the moan, stopping at over a foot long and 3 inches thick, dribbling cum. You whisper, "<i>Cum, my Toy,</i>" and push the remaining beads inside him. His eyes roll back as his paws frantically milk his ' +
                    liveData.monster.cockDescriptShort(0) +
                    ", cum spraying from him like a fountain. Jojo trembles, losing complete control and falling away from you. You still hold the end of his beads, and smile as they pop out, stained almost as dark as the poor mouse's soul.<br><br>");
                GUI.outputText("You walk away, leaving your new pet to explore his outlook on life, and to test your awakened powers. ");
    ...
    static jojoCampCorrupt() {
        ...
        if (liveData.player.lust >= 33)
            GUI.addButton(0, "Sex", this.corruptJojoSexMenu);
    ...
    static corruptJojoSexMenu() {
        ...
        if (liveData.player.biggestTitSize() >= 2)
            GUI.addButton(6, liveData.player.biggestLactation() > 1 ? "Suckle" : "Breasts", this.corruptJojoBreasts); //All ya need is bewbs
        GUI.addButton(14, "Back", this.jojoCampCorrupt);
    }
    static corruptJojoBJCruel() {
        GUI.clearOutput();
        var x = liveData.player.biggestCockIndex();
        GUI.outputText('You yell out into the jungle, "<i>Slut!</i>" Minutes later Jojo slips into your camp from the jungle\'s shadows, dropping to his knees with a timid look of fear in his eyes. You step forward and grip the fur between his shell-like ears firmly, hissing angrily, "<i>When I call for you, you need to be here. Do I need to teach you your place again?</i>"  ');
        GUI.outputText("He shakes his head as you say this, trying to marshal up the strength to resist you. You draw your teeth back in a snarl of anger at this resistance and punch the mouse in the gut, dropping him to his knees gasping for breath.  ");
        if (liveData.player.cocks[x].cArea() < 10)
            GUI.outputText("You grip the fur on his head tightly in one hand and pull his mouth over your " +
                liveData.player.cockDescript(x) +
        ...
        GUI.outputText("His eyes turn to you in fear and his body shudders for lack of breath, but it does nothing more than stoke the fires of your lust. You groan in pleasure as your balls draw up tight, churning with your corrupted seed, and in a rush you feed it to him, your orgasm overtaking you as surge after hot surge of cum flares through your flesh and into his throat.  " +
        ...
        GUI.outputText("Your orgasm seems to last forever, filling his belly with your corrupted essence, causing his stomach to bulge slightly with the sheer volume of it. You pull away at last, letting him gasp for breath and fall to the ground, curling around his bloated belly.  ");
    ...
    static corruptJojoBJGentle() {
        ...
        if (liveData.player.cocks[x].cArea() < 10)
            GUI.outputText("He opens his mouth to protest, but you never give him the chance, sliding your " +
                liveData.player.cockDescript(x) +
            ...
            GUI.outputText("He opens his mouth to protest, but you never give him the chance, forcing your " +
                liveData.player.cockDescript(x) +
            ...
            GUI.outputText("He opens his mouth to protest, only to have your " +
                liveData.player.cockDescript(x) +
        ...
        GUI.outputText("His eyes turn to you in fear and awe, pleading for release, and a slip of your foot to his own straining erection lets you know how in need of an orgasm he is, but this time is yours. You groan in pleasure as your balls draw up tight, churning with your corrupted seed, and in a rush you feed it to him, your orgasm overtaking you as surge after hot surge of cum flares through your flesh and into his throat.  " +
            (liveData.player.hasVagina() ? "A sympathetic orgasm hits your pussy, causing a surge of feminine juices to splash against his chest and dribble down your thighs lewdly.  " : ""));
        GUI.outputText("Your orgasm seems to last forever, filling his belly with your corrupted essence, causing his stomach to bulge slightly with the sheer volume of it. You pull away at last, letting him gasp for breath and fall to the ground, curling around his bloated belly.  ");
        if (liveData.player.biggestTitSize() >= 2)
            GUI.outputText("You draw him to your bosom and kiss his forehead and then stand and go about your duties, leaving him to recover from the intense encounter and then retreat back into the jungle.  ");
        else
            GUI.outputText("You give him one last fond caress, running your fingers through his fur in an almost patronizing petting motion, then turn without another word and leave him to retreat back into the jungle.  ");
        liveData.player.orgasm();
    ...
    static corruptJojoCunnilingus() {
        GUI.clearOutput();
        GUI.outputText("You decide to finally reward your slut for all his service to you, summoning him to your camp for pleasure. He meekly appears at your bidding and you direct him to lie down on the ground before you. He does as you ask and you gently spread his legs, settling down between them.  ");
        ...
        switch (UTIL.rand(3)) {
            case 0:
                GUI.outputText("You take the tip of his member into your mouth, suckling at it as your tongue curls at the crown and teases at the tiny slit at the tip. You take your time with him, letting your hands rub up and down his length, masturbating him slowly and giving his needy balls the occasional caress.  ");
                break;
            case 1:
                GUI.outputText("You take the tip of his member into your mouth and slowly start to bob your head, one hand squeezing at his balls tenderly as your other hand strokes the length of his cock that your lips don't reach. You let your pace quicken over time, mimicking a vigorous fucking.  ");
                break;
            default:
                GUI.outputText("You take the tip of his member into your mouth, and then take a deep breath through your nose, before dropping your head down, listening to him gasp as his cock slides all the way into your mouth and down your throat, until your nose presses against his musky sheath.  Your hands tease and squeeze at his balls, urging him to cum as your throat rhythmically swallows at his length in a milking motion.  ");
        }
        GUI.outputText("You work until your slut explodes, and then, keeping all his seed in your mouth, you lift your head and press your lips to his in a firm kiss, feeding him the load of cum that he just released. He blushes as you do so, but obediently takes it all in, swallowing it down as you feed it to him.  ");
    ...
    static corruptJojoVaginalGentle() {
        ...
        if (liveData.player.vaginalCapacity() < 10) {
            ...
            GUI.outputText("You lower your hand to take hold of his cock, lining it up with your entrance, and then with a moan of pleasure, you lower your weight atop him. His cock slides into your pussy like a hand into a glove, fitting perfectly, as though he were made for you.\n");
            liveData.player.cuntChange(36.4, true);
        ...
        GUI.outputText("You cry out in pleasure as your orgasm floods through your body, causing your juices to splash out around your mouse slut's cock" +
    ...
    static corruptJojoVaginalSmother() {
        GUI.clearOutput();
        GUI.outputText("You feel the need to gain a little sexual relief and a mischievous idea comes to your mind, making you grin wickedly. You slip off into the jungle to seek out your monk mouse fuck toy, and when you find him, you practically pounce atop him, pinning him to his back. He struggles in surprise until he realizes that it is you, at which point he blushes and tries to look away, unable to help the erection that you are sitting against as you straddle him.  ");
        GUI.outputText('You crawl further up his body and grin down at him as you press your already dripping pussy to his mouth and command sharply, "<i>Start licking if you want to breathe.</i>" His eyes go wide, but you can feel his tongue already starting to work at your lusty slit.  ');
        if (liveData.player.vaginas.wetness > 4)
            ...
            GUI.outputText("You grind your slit against him as he eats you out, moaning with pleasure and writhing above him. You lift off of his face every so often, giving him just enough of a break to catch his breath before cutting it off with your pussy once again.  ");
        else
            GUI.outputText("You settle the full of your weight against his face and laugh as you feel him struggling to pleasure you, his nose and mouth trapped tight against your slit so that every attempt to breathe is halted, making him tremble breathlessly beneath you.  ");
        GUI.outputText("His tongue digs deep into your body, finally bringing you to an explosive climax that leaves you shuddering thoughtlessly above him. You actually forget you are sitting on his face for a moment, feeling him go still as he nearly passes out from lack of breath before you stand up.  ");
    ...
    static corruptJojoAnalCruel() {
        ...
        if (liveData.player.cocks[x].cArea() < 10)
            GUI.outputText("You saw your swelling erection between his ass cheeks a few times, and then with little warning, you shove yourself deep into his body, making the mouse gasp out as you fill his well used rear. You groan in pleasure as you feel his anal ring grip in flutters along your " +
                liveData.player.cockDescript(x) +
                " as you spear in and out of him, fucking your slut toy with wild abandon.  ");
        else if (liveData.player.cocks[x].cArea() < 36)
            GUI.outputText("You press the mouse hard against the tree, inhaling his scent and sliding your " +
                liveData.player.cockDescript(x) +
            ...
            GUI.outputText("You grin as your mouse slut cries out with your " +
                liveData.player.cockDescript(x) +
    ...
    static corruptJojoAnalGentle() {
        GUI.clearOutput();
        var x = liveData.player.biggestCockIndex();
        GUI.outputText("You watch as Jojo slinks into your camp from the dense jungle, moving timidly with his eyes focused on your feet. The sight of such a once pious monk reduced to your submissive fuck toy stirs your loins and brings a smile to your lips.  ");
        GUI.outputText("You pull him against your body in a firm and possessive hug, and press your lips to his in a forceful kiss, laughing as you break the kiss to the sight of his discomfort. You pay it little mind as you gently force him back onto the ground and spread his legs. You can see in his eyes that he knows what is coming, and you can see that he is as eager for it as he is humiliated by that eagerness.  ");
        if (liveData.player.cocks[x].cArea() < 10)
            GUI.outputText("You lift the mouse's balls out of the way and spit down onto the crinkled star of his anus, then lever your tip to the well used hole. There is little ceremony or foreplay, but his cock is already straining erect, and a blush colors his cheeks as you push into his ass, inch by inch. You set a slow and tender pace at first, but as your orgasm nears, your thrusts become more animal and needy.  ");
        else if (liveData.player.biggestCockArea() < 36)
            GUI.outputText("You slide your thick and drooling cockhead beneath the mouse's balls, working the musky drool of your pre-cum against the well used crinkle of his ass before forcing the thick vein-lined length of your " +
                liveData.player.cockDescript(x) +
        ...
        GUI.outputText("You pound away at the mouse's tight body for as long as you can, then feel your orgasm hit you hard, your balls drawing up tight as your seed churns and pulses through you and into the mouse's ass, filling his belly with your lust and corruption. You watch his belly swell with the seed in a beautifully vulgar display.  ");
        GUI.outputText("His eyes glaze over from the intensity of the act, his teeth tightly grit, and then you can hear a keening groan from him as he falls over the edge into his own orgasm, his untouched mouse cock bouncing and jerking on his belly as his thick seed is sprayed across his chest and face lewdly. He blushes deep at the visible proof that he enjoyed what you did to him and trembles beneath you.  ");
    ...
    static corruptJojoAnalSmother() {
        GUI.clearOutput();
        GUI.outputText("You feel the need to gain a little sexual relief and a mischievous idea comes to your mind, making you grin wickedly. You slip off into the jungle to seek out your monk mouse fuck toy, and when you find him, you practically pounce atop him, pinning him to his back. He struggles in surprise until he realizes that it is you, at which point he blushes and tries to look away, unable to help the erection that you are sitting against as you straddle him.  ");
        GUI.outputText('You crawl further up his body and grin down at him as he stares at your exposed pussy. You suddenly spin, sitting down the other way, so that your ass cheeks envelope his muzzle, trapping his nose and mouth against your tight pucker. "<i>Get that tongue up in there slut.</i>"  ');
        switch (UTIL.rand(3)) {
            case 0:
                GUI.outputText("You grind your ass against him as he eats you out, moaning with pleasure and writhing above him. You lift off of his face every so often, giving him just enough of a break to catch his breath before cutting it off with your ass once again.  ");
                break;
            case 1:
                GUI.outputText("You settle the full of your weight against his face and laugh as you feel him struggling to pleasure you, his nose and mouth trapped tight against your ass so that every attempt to breathe is halted, making him tremble breathlessly beneath you.  ");
                break;
            default:
                GUI.outputText("You moan as he takes you at your word, spearing his tongue deep into your anus and thrusting it in and out as though it were a sleek muscled shaft, making your body tremble in pleasure. It makes you wonder where he learned such a trick in his life as a pious monk.  ");
        }
        GUI.outputText("His tongue continues to work at your ass, finally bringing you to an explosive climax that leaves you shuddering thoughtlessly above him. You actually forget you are sitting on his face for a moment, feeling him go still as he nearly passes out from lack of breath before you stand up.  ");
        GUI.outputText("He gasps for breath and coughs a few times, and once you are sure that he is safe, you laugh softly and walk back to your camp.");
        liveData.player.orgasm();
        liveData.player.modStats(["cor", 1]);
        GUI.doNext(Camp.returnToCampUseOneHour);
    ...
    static corruptJojoBreasts() {
        ...
        if (liveData.player.biggestLactation() > 1) {
            ...
            GUI.outputText("He leans in close and presses a kiss to first one nipple, then the other, starting to worship your breasts lovingly. You have other plans, however, and one hand grabs the fur at the back of his neck as the other slips beneath your breasts to pull them together to either side of his face as you press him in tight against the curves of your cleavage, forcing the mouse to fight for every breath.  ");
        }
        GUI.outputText("You can hear Jojo's breath quickening, then his body shudders as he climaxes spontaneously, splashing his seed across your hip and belly. You can't help the laugh that rises from within you at his submissive gesture, watching as shame washes across his face and his ears lay back.  ");
