...
flee = function (callHook) {
    ...
    if (player.canFly())
        escapeMod -= 20;
    if (player.tailType == TAIL_TYPE_RACCOON && player.earType == EARS_RACCOON && player.findPerk(PerkLib.Runner) >= 0)
        escapeMod -= 25;
    if (monster.findStatusEffect(StatusEffects.Stunned) >= 0)
        ...
        if (player.buttRating >= 20)
            escapeMod += 5;
        if (player.ballSize >= 24 && player.balls > 0)
            escapeMod += 5;
        if (player.ballSize >= 48 && player.balls > 0)
            escapeMod += 10;
        if (player.ballSize >= 72 && player.balls > 0)
            escapeMod += 10;
    }
            ...
            if (player.biggestTitSize() >= 35 || player.buttRating >= 20 || player.hipRating >= 20) {
                ...
                if (player.biggestTitSize() >= 35 && player.biggestTitSize() < 66) {
                    if (player.hipRating >= 20) {
                        ...
                        if (player.buttRating >= 20)
                            outputText(player.buttDescript() + " and ");
                ...
                //FOR PLAYERS WITH MASSIVE BREASTS
                    ...
                    if (player.hipRating >= 20) {
                        ...
                        if (player.buttRating >= 20)
                            outputText("causing the fat of your " + player.skinTone + player.buttDescript() + " to wobble heavily, ");
                ...
                //FOR PLAYERS WITH EITHER GIANT HIPS OR BUTT BUT NOT THE BREASTS
                    ...
                    if (player.buttRating >= 20)
                        outputText("causing your " + player.skinTone + player.buttDescript() + " to wobble obscenely ");
                    outputText("and forcing your body into an awkward gait that slows you down, preventing you from escaping.");
                }
                //JUST DA BOOTAH
                else if (player.buttRating >= 20)
                    outputText("Your " + player.skinTone + player.buttDescript() + " wobbles so heavily that you're unable to move quick enough to escape.");
            }
