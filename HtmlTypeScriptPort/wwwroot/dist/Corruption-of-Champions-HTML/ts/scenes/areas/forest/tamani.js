...
addToGameFlags(FLAG.TAMANI_MET, FLAG.TAMANI_TIME_OUT, FLAG.TAMANI_BAD_ENDED, FLAG.TAMANI_DAUGHTER_PREGGO_COUNTDOWN, FLAG.TAMANI_NUMBER_OF_DAUGHTERS, FLAG.TAMANI_TIMES_HYPNOTIZED, FLAG.TAMANI_DEFEAT_COUNTER, FLAG.TAMANI_TIMES_IMPREGNATED, FLAG.TAMANI_PREGNANCY_COUNT, FLAG.TIMES_OVIPOSITED_TAMANI);
//Tamani Description
    ...
    tamaniHypnoTease() {
        ...
        //Medium Hypnosis
            ...
            if (selector == 0) {
                ...
                if (liveData.player.totalCocks() > 1)
                    ...
                    outputText("Y");
                outputText("our " + liveData.player.multiCockDescriptLight());
                ...
                if (liveData.player.totalCocks() > 1)
                    outputText("each of ");
                outputText("your " + liveData.player.multiCockDescriptLight());
        ...
        //High Hypnosis
            ...
            if (selector == 0) {
                ...
                if (liveData.player.totalCocks() > 1)
                    outputText("each of ");
                outputText("your " + liveData.player.multiCockDescriptLight() + " aches with need.  You battle with the compulsion to kneel before your short, stacked mistress and perform your duties as her breeder husband.");
            }
            else {
                ...
                if (liveData.player.totalCocks() > 1)
                    ...
                    outputText("Y");
                outputText("our " + liveData.player.multiCockDescriptLight() + " pulses and dribbles pre-cum, aching to do its duty and fire load after load into Tamani's perfect pussy.");
            }
        }
...
class TamaniScene {
    ...
    static tamaniSexWon() {
        ...
        if (liveData.player.cockArea(x) <= 90) {
            ...
            outputText("It's too tempting of a target to resist.  You open your " +
            ...
            if (liveData.player.totalCocks() == 1)
                outputText("pussy squeezing tightly as she cums hard.<br><br>");
            else
                outputText("holes squeezing tightly as she cums hard.<br><br>");
            if (liveData.player.totalCocks() > 1) {
            ...
            outputText('<br><br>Tamani winks, sucking on her finger as she staggers up.  She coos, "<i>Mmmm, Tamani loves it when her ' + liveData.player.mf("sexy lover", "stud") + " dominates her.  Do you think your ");
        ...
        //Too big? Jerk off with feet and bukkake
            ...
            outputText(", so you grab her by the ankles and wrap her soft-soled feet about yourself.   You start jerking yourself off, using Tamani as a cute but expendable masturbation aid.  She chews a fingernail and massages her " +
                this.tamaniChest() +
            ...
            if (liveData.player.cumQ() >= 250)
                outputText("  You continue working your " + liveData.player.cockDescript(x) + " with her supple feet, watching your dripping spooge froth and bubble as you continue to pump more onto the sassy wench.");
            if (liveData.player.cumQ() >= 500)
            ...
            outputText("<br><br>");
            outputText('Tamani winks, blinking the cum out of an eye as you finish up, releasing her seed-covered form.  She coos, "<i>Mmmm, Tamani loves it when you dominate her, ' + liveData.player.mf("stud", "sexy") + ".  Do you think your ");
            if (liveData.player.balls > 0)
                outputText("sexy balls have ");
            else
                outputText("sweet cock has");
    ...
    static tamaniAnalSex() {
        ...
        outputText('The slutty creature\'s moans turn to shouts as the sensation overwhelms her, and she bucks wildly back against you, face still in the dirt and tongue lolling out of her mouth.  "<i>Oh, fuck yes, harder, HARDER!</i>" she bursts forth wildly.  You oblige and pick up the intensity, absolutely ravaging her tight ass now with the motions of your ' +
            liveData.player.cockDescript(x) +
    ...
    static tamaniBeaten() {
        ...
        if (liveData.gameFlags[FLAG.TIMES_OVIPOSITED_TAMANI] == 0)
            outputText("my baby-" + liveData.player.mf("daddy", "momma"));
        else
    ...
    static tamaniSexLost() {
        ...
        if (liveData.player.cocks[0].cockThickness >= 5)
            outputText("Impossibly, despite your titanic girth, the ring somehow expands to squeeze onto you, though it's painfully tight.<br><br>");
        else
            outputText("Somehow the ring fits onto you perfectly, as if it was made exactly for your " + liveData.player.cockDescript(0) + ", though it remains painfully tight.<br><br>");
        outputText("\"<i>Don't fret, " +
        ...
        if (liveData.player.biggestTitSize() >= 6)
            outputText("but can't manage to see your bloated prick past the wall of titflesh.<br><br>");
        else
            outputText("at your bloated prick, looking almost overinflated from all the blood that tight ring has forced into it.<br><br>");
        outputText("<b>*SMACK*</b>  Tamani's hand cracks against your " +
        ...
        if (liveData.player.balls > 0)
            outputText("cups your " + liveData.player.ballsDescriptLight() + " tightly");
        else
            outputText("caresses you around the ring");
        outputText(' and asks, "<i>So are you sorry for making me wait for my cream ' +
            liveData.player.mf("stud", "slut") +
        ...
        if (liveData.player.cor < 50)
            outputText("  You have no choice, you'll say what she wants you to say.<br><br>");
        else
            outputText("  Being denied like this was kind of fun, but you REALLY need to get off now, so you'll say what she wants you to say.<br><br>");
        ...
        if (liveData.player.cor > 50)
            outputText("blushing hotly and doing your best to look like a submissive toy.<br><br>");
        else
            outputText("blushing in shame and embarrassment, but meaning every word.<br><br>");
        outputText("She takes the empty bottle and presses it against your " +
    ...
    static tamaniSexLetHer() {
        ...
        if (COMBAT.inCombat()) {
            ...
            if (liveData.player.isTaur()) {
                if (liveData.player.HP < 1)
                    ...
                    outputText("You stumble, legs weaving drunkenly as " + liveData.player.sMultiCockDesc() + " ache and drool with need.  ");
                outputText("Tamani sidles up to you and pats your flank, cooing, \"<i>There there horsey, everything's going to be okay.  Momma Tamani's going to take really good care of you.</i>\"  Before you know it your " +
                    liveData.player.armor.equipmentName +
            ...
            //Not taur
                ...
                outputText("  She wiggles her " + this.tamaniChest() + ", and despite your efforts to control your body, ");
        ...
        //Voluntary submission
            ...
            //Taur
            if (liveData.player.isTaur()) {
                outputText("You meekly undress and ask Tamani how she would like to take you today.  She titters and slowly walks around you, taking her time, taking in your formidable bestial body and your " +
                    liveData.player.multiCockDescriptLight() +
                ...
                switch (temp) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        outputText(liveData.player.nippleDescript(0));
                        break;
                }
                outputText(" a quick kiss before pushing hard against you, shoving you onto the ground and flashing a brilliant smile.<br><br>");
                outputText('"<i>Just lie there and take it ' + liveData.player.mf("stud", "slut") + ',</i>" she commands.<br><br>');
            }
        }
        //Taur-zilla
        if (liveData.player.isTaur()) {
            ...
            if (liveData.player.cocks[0].cockLength <= 18) {
                outputText("Before you can get too far she stops and agonizingly shifts her attention; you feel her transfer her weight to her hands, and then the rough but soft bottoms of her feet work their way down to the other end of your " +
                    liveData.player.cockDescript(0) +
                ...
                //No balls:
                if (liveData.player.balls == 0)
                    outputText("You find yourself wondering vaguely where a goblin learns these kinds of gymnastics.<br><br>");
                else
                    outputText("You find yourself wondering vaguely where a goblin learns these kinds of gymnastics, before the goblin in question drives all thoughts out of your head by mashing her soft soles into your " +
                ...
                outputText('"<i>Go on then,</i>" she breathes eventually. "<i>I guess you\'ve had enough. Cum for Mistress Tamani, ' +
                    liveData.player.mf("stud", "slut") +
            ...
            //If >18 Inches
                ...
                outputText("Before you can get too far she stops and agonizingly shifts her attention; you feel her rough but soft bottoms of her feet work their way down to the other end of your " +
                    liveData.player.cockDescript(0) +
                ...
                if (liveData.player.balls == 0)
                    ...
                    outputText("You find yourself wondering vaguely where a goblin learns these kinds of gymnastics, before the goblin in question drives all thoughts out of your head by beginning to mash her soft soles into your " +
                        liveData.player.ballsDescriptLight() +
                        ".<br><br>");
                ...
                if (liveData.player.cumQ() < 1200) {
                    outputText("With a ragged sigh, you reach your peak. Your first blast of jizz goes straight into Tamani's mouth, but you feel the goblin nimbly and hastily changing her position so that the very tip of your " +
                        liveData.player.cockDescript(0) +
                ...
                //High cum:
                    ...
                    if (liveData.player.balls > 0)
                        outputText("Your " + liveData.player.ballsDescriptLight() + " ache and you feel very thirsty indeed.");
                    else
                    ...
                    outputText('"<i>Wheeeeeeeee,</i>" she says, with a grin which almost splits her face in half. "<i>Who knew that riding a horsie could be so much fun! We\'re going to have to do that again, stud. Next time I might make it a gallop instead of a canter. Won\'t that be nice? Until next time, big  ' +
                        liveData.player.mf("boy", "girl") +
                        ".</i>\" She swaggers off, leaving you to wonder if you'll ever be in a fit enough state to let her near your cock again, and where the nearest whereabouts of a gallon of water is.<br><br>");
                }
            }
        ...
        //Not-taurs
            ...
            if (liveData.player.cockArea(0) <= 90) {
                outputText("Tamani turns about, dragging her wet gash across you and giving you a nice view of her plump butt-cheeks.  The soft skin of her palms squeezes around you as she lifts you up, positioning your " +
                    liveData.player.cockDescript(0) +
                ...
                if (liveData.player.biggestTitSize() >= 2)
                    outputText("Your " + liveData.player.allBreastsDescript() + " bounce and jiggle obscenely as the goblin twists and pulls, abusing your nipples.");
                else
                    outputText("Your " +
                        liveData.player.nippleDescript(0) +
                ...
                if (liveData.player.balls > 0)
                    outputText("Your " + liveData.player.ballsDescriptLight() + " twitch powerfully, venting their contents, releasing a jet of hot cum into the goblin.");
                else
                ...
                if (liveData.player.cumQ() < 250)
                    outputText(".  I really enjoy our fucks " + liveData.player.mf("stud", "hun") + ", and I can't wait to 'bump' into you again.");
                else {
                    outputText(".  You make sure and let your ");
                    if (liveData.player.balls > 0)
                        outputText(liveData.player.ballsDescriptLight() + " fill back up with cum, ok?");
                    else
                        outputText(liveData.player.cockDescript(0) + " fills back up with cum, ok?");
                }
                outputText('</i>"<br><br>');
                //Combat end:
                if (COMBAT.inCombat()) {
            ...
            //(Doesnt fit)
                ...
                if (liveData.player.balls > 0)
                    outputText(liveData.player.ballsDescriptLight());
                else
                    outputText(liveData.player.cockDescript(0));
                outputText(" a rough slap.  Whimpering, you still your rebellious hips and allow her to play you like the world's most sensitive fiddle.  Tamani pulls your " +
                    liveData.player.cockHead() +
                ...
                if (liveData.player.balls > 0)
                    outputText("lifts up your " + liveData.player.ballsDescriptLight());
                else
                    outputText("leans forwards, looking between your legs");
                outputText(", and places the dildo's leaking tip against your " +
                ...
                outputText("  A burning heat radiates through your body, making your " + liveData.player.nippleDescript(0) + " tingle and grow ever more sensitive.<br><br>");
                outputText("Tamani rocks back and forth, sliding herself against your " +
                    liveData.player.cockDescript(0) +
                ...
                outputText("The kinky goblin dominatrix on your " + liveData.player.cockDescript(0) + " leans even further forwards, angling the dildo in your " + liveData.player.assholeOrPussy() + " upwards to squeeze your ");
                if (liveData.player.hasVagina())
                ...
                outputText("Your body immediately and happily complies, squirting a jet of thick white jism onto the goblin's jiggling ass-cheeks.  She slides down, aligning her cunt with your swollen cock-tip, taking the next squirt directly between her lips as she rubs against you.  Tamani slaps the dildo in your " +
                    liveData.player.assholeOrPussy() +
                ...
                outputText("The dildo slips out of your abused " + liveData.player.assholeOrPussy() + " forgotten in the heat of your lovemaking, leaking pink goo.<br><br>");
    ...
    static tamaniHypnosis() {
        ...
        outputText("Tamani crooks her finger and you come running, already feeling yourself straining against your " +
            liveData.player.armor.equipmentName +
            ' for a chance to fuck your wife and mistress.  She giggles, "<i>Ohhh, how sweet, you\'re so ready to do your duty.</i>"<br><br>');
        outputText("The goblin traces her fingers over the bulge in your " +
            liveData.player.armor.equipmentName +
        ...
        outputText('She smirks and bends over, looking back up at you from between her legs.  She offers, "<i>Go ahead and stick it in.  A horny ' +
        ...
        if (primary >= 0) {
            ...
            if (cocks > 1) {
                if (primary > 0)
                    ...
                    secondary = 1;
                outputText("She moans and pulls your " + liveData.player.cockDescript(secondary) + " into her mouth, running her tongue around the tip and sliding her palm along the underside.");
            }
            else
                outputText("She moans and pants, babbling about how good you are to her the whole time.");
            outputText("  You don't stop until your " + liveData.player.cockHead(primary) + " is the only thing inside her.<br><br>");
            ...
            if (cocks > 0)
                outputText(" around your " + liveData.player.cockDescript(secondary));
            ...
            outputText("  She visibly orgasms, shaking and trembling from head to toe as her pussy milks your " + liveData.player.cockDescript(primary) + ".  It only lasts a few seconds, though they feel like heaven, before her body goes nerveless.<br><br>");
            ...
            if (cocks == 1)
                ...
                outputText("and her mouth is too full of " + liveData.player.cockDescript(secondary) + " to do anything but gurgle out nonsensical pleasure-noises.");
            outputText("  Swelling wider inside the wet hole, your " + liveData.player.cockDescript(primary) + " tingles and clenches, about to unload.<br><br>");
            outputText("An intense orgasm rolls through you, making your body clench as your piston your " + liveData.player.cockDescript(primary) + " forwards, burying it deeply inside the goblin-shaped cum-receptacle.  ");
            if (liveData.player.hasKnot(primary))
                ...
                outputText("The corrupted nodules along your " + liveData.player.cockDescript(primary) + " pulsate in rippling, wave-like motions, massaging the interior of Tamani's twat");
            ...
            outputText(".  Tamani regains her senses and pushes you back, waddling slightly after the intense fuck.   White jism and clear feminine fluids drool down her thighs, and your mistress couldn't be happier.  She pets your still-dripping " +
        ...
        //[DOESNT FIT]
            ...
            if (liveData.player.biggestTitSize() < 1)
                ...
                outputText("between your " + liveData.player.breastDescript(0) + " ");
            outputText(' and commands, "<i>Stop, you\'re just too big of a man for Tamani to do it the old fashioned way.</i>"<br><br>');
            outputText("Disgruntled but obedient, you stop your vaginal assault and release your wife.  It seems she has another way for your aching " +
                liveData.player.cockDescript(0) +
            ...
            outputText("You do as you are told, like a good husband, and Tamani stays close, bound to you by a flexible, artificial umbilical.  She sits next to you, propping her feet up onto your " +
                liveData.player.cockDescript(0) +
            ...
            outputText("With both her feet locked together, wrapped around most of your sensitive " +
            ...
            if (liveData.player.tallness > 60)
                outputText("big ");
            outputText(liveData.player.mf("strong man's", "sexy lover's") + " " + Appearance.cockNoun(ENUM.CockType.HUMAN) + '?</i>"<br><br>');
            ...
            if (cocks > 1) {
                if (cocks == 2)
                    outputText("  Your other" + liveData.player.cockDescript(1));
                else
                    outputText("  Each of your other " + liveData.player.multiCockDescriptLight());
                outputText(" splatters its own orgasmic juice everywhere, making a thorough mess of things, but neither of you seem to mind.");
            }
            outputText("<br><br>");
            outputText("Tamani smiles as she pulls the tube out and stands up.  White jism and clear feminine fluids drool down her thighs, and your mistress couldn't be happier.  She peels her device off your still-dripping " +
                liveData.player.cockDescript(0) +
    ...
    static tamaniFemaleEncounter() {
        ...
        clearOutput();
        outputText("A goblin leaps out from behind a rock outcropping.  She keeps her arms folded across her " +
            this.tamaniChest() +
    ...
    static tamaniFemaleYes() {
        ...
        if (liveData.player.cor < 50)
            outputText("Gross.<br><br>");
        else
            outputText("Getting cock-slapped would've been kind of hot...<br><br>");
    ...
    static tamaniFirstTimeConsentual() {
        ...
        outputText("Her hips sway seductively as she approaches with her right hand dipping into the moist honeypot of her sex.  You disrobe, throwing your " +
            liveData.player.armor.equipmentName +
            " to the side before you reach down and lift her up, pressing her curvy body against your ");
        if (liveData.player.biggestTitSize() > 1)
            outputText(liveData.player.allBreastsDescript());
        else
            outputText("chest");
        ...
        outputText("As if to emphasize her point, she curls her toes around your " +
            liveData.player.cockDescript(0) +
        ...
        if (liveData.player.balls > 0)
            outputText("Your " + liveData.player.ballsDescriptLight() + " swell with seed, spurring your desire to new heights.");
        else
        ...
        //(FITS)
        if (liveData.player.cockArea(0) <= 90) {
            outputText("Tamani breaks the kiss and gives you a coy smile as she shimmies down your body, dropping her moist cunt onto your " +
                liveData.player.cockDescript(0) +
                "'s " +
                liveData.player.cockHead() +
            ...
            if (liveData.player.balls > 0)
                outputText(" and drips from your " + liveData.player.ballsDescriptLight());
            ...
            outputText("All good things eventually end, and with a sigh you pull the insensate goblin slut free of your " +
                liveData.player.cockDescript(0) +
                ...
                liveData.player.mf("stud", "hun") +
                '?</i>"<br><br>');
            outputText("It takes a moment to put your " + liveData.player.armor.equipmentName + " back on and make ready to leave, but somehow you know this isn't the last you've seen of this goblin.");
            //[CORRUPT]
            if (liveData.player.cor > 66)
                outputText("  Your " + liveData.player.cockDescript(0) + " twitches at the thought, ready and wanting more.");
        }
        //(TOO BIG)
        else {
            outputText("Tamani breaks your sloppy kiss and shimmies down your body, clutching tightly to your " +
                liveData.player.cockDescript(0) +
                " and " +
                liveData.player.skinDesc +
            ...
            if (liveData.player.hasSheath()) {
                ...
                if (liveData.player.balls > 0)
                    ...
                    outputText("licks the sensitive " + liveData.player.skinTone + " " + liveData.player.skinDesc + " of your inner thighs");
            }
            outputText("<br><br>");
            ...
            if (liveData.player.balls > 0 && liveData.player.hoursSinceCum > 200)
                outputText(", visibly draining your " + liveData.player.ballsDescriptLight() + " down to their normal size");
    ...
    static tamaniFirstTimeRefusal() {
        //TODO Tamani Sprite spriteSelect(56);
        clearOutput();
        outputText("Tamani's eyes widen in surprise, \"<i>Don't let the size fool you, big " +
            liveData.player.mf("boy", "girl") +
    ...
    static tamaniMaleRepeatEncounter() {
        ...
        if (liveData.tamanipreg.isPregnant() || liveData.gameFlags[FLAG.TAMANI_NUMBER_OF_DAUGHTERS] > 0)
            outputText("While exploring, you're startled by the feeling of tiny hands stroking the insides of your thighs.  You look down and find Tamani there, grinning wolfishly,  \"<i>Ready for another fuck, big " +
                liveData.player.mf("boy", "girl") +
                '?"<br><br>');
        // Else check for hypnoslut scene (large hypnosis number, then 50% chance)
        else
            outputText("While exploring, you're startled by the feeling of tiny hands stroking the insides of your thighs.  You look down and find Tamani the goblin there, grinning with desire, \"<i>Ready to stuff me with cum?  I'm not taking no for an answer this time.</i>\"<br><br>");
        if (liveData.gameFlags[FLAG.TAMANI_TIMES_HYPNOTIZED] > 19 && UTIL.rand(2) == 0) {
            this.tamaniHypnosis();
            return;
        }
    ...
    static tamaniPregnantFuck() {
        //TODO Sprite spriteSelect(56);
        clearOutput();
        outputText("Tamani's eyes light up and she pounces you, somehow managing to jump up and latch onto your chest despite the weight of her burgeoning pregnancy.  The two of you overbalance as her weight carries you to the ground, flat on your back.   Your " +
            liveData.player.buttDescript() +
        ...
        if (liveData.player.biggestTitSize() >= 2)
            ...
            outputText("chest");
        outputText(".\n\n");
        outputText("You grab her under the arms and lift her up, examining her milk-laden nipples.  They shine with moisture, practically begging to be sucked.  You nuzzle them, gently sucking one into your mouth and drinking down the nutritious beverage.  Tamani grinds her hips against one of your " +
            liveData.player.nippleDescript(0) +
        ...
        if (liveData.player.cockArea(0) <= 50) {
            outputText("Tamani pulls herself up to her feet and grabs your " +
                liveData.player.cockDescript(0) +
            ...
            outputText('"<i>Thanks for the good fuck, ' +
        ...
        //(Doesn't Fit)
            ...
            outputText('"<i>Sorry ' + liveData.player.mf("stud", "lover") + ", you're just too big and <b>hard</b> for me.   Don't worry, I'll help you unload everything straight into my sweet cunt,</i>\" she apologizes, ");
            if (liveData.player.balls > 0)
                outputText("massaging your balls with her feet");
            else
                outputText("jacking the base of your " + liveData.player.cockDescript(0) + " with her feet");
            outputText(" while her hands caress and tease you.   Tamani pulls herself downwards, pressing the " +
                liveData.player.cockHead() +
            ...
            outputText("Tamani grinds on you a bit longer before staggering up and stretching.  She pauses to get a narrow bottle and abruptly jams the end into your urethra.  With one practiced motion, she squeezes your " +
                liveData.player.cockDescript(0) +
    ...
    static tamaniBirthScene() {
        ...
        if (liveData.gameFlags[FLAG.TAMANI_NUMBER_OF_DAUGHTERS] > 0)
            outputText("with her daughters, "); //She always has at least two daughters if she has any
        outputText("laying against a scrubby tree with her legs spread wide and surrounded by a small puddle.  Her " +
            this.tamaniChest() +
        ...
        outputText("  She looks up at you and whispers breathily, \"<i>Come fuck me a little later, I'll give you even more beautiful little girls.  These " +
