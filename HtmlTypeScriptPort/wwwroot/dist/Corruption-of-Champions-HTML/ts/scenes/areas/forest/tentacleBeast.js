...
class TentacleBeast extends Creature {
    ...
    //Tentacle Beast AI
    doAI() {
        if (UTIL.rand(2) == 0 || liveData.gameFlags[FLAG.TENTACLE_COOL_DOWN] == 1)
            this.tentaclePhysicalAttack();
        else
            this.tentacleEntwine();
    ...
    tentacleEntwine() {
        ...
        if (liveData.gameFlags[FLAG.TENTACLE_BIND] == 0) {
            ...
            //Fail
                ...
                GUI.outputText("While you attempt to avoid the onslaught of pseudopods, one catches you around your " +
                ...
                if (liveData.player.hasCock())
                    GUI.outputText("The creature, having immobilized you, coils a long tendril about your penis. You shudder as the creature begins stroking your cock like a maid at a dairy farm in an attempt to provoke a response from you. Unable to resist, your " +
                ...
                //Female Version:
                    ...
                    GUI.outputText("The creature quickly positions a long tentacle with a single sucker over your clitoris. You feel the power of the suction on you, and your body quickly heats up.  Your clit engorges, prompting the beast to latch the sucker onto your " +
                        liveData.player.clitDescript() +
                        ".<br>");
                //Genderless
                else
                    GUI.outputText("The creature quickly positions a long tentacle against your " + liveData.player.assholeDescript() + ". It circles your pucker with slow, delicate strokes that bring unexpected warmth to your body.<br>");
...
class TentacleBeastScene {
    ...
    static tentacleVictoryRape() {
        ...
        if (liveData.player.gender == 1 || liveData.player.gender == 3) {
            GUI.outputText("Seizing the opportunity, you rush the monster while it is stopped. You grab the fattest hollow tentacle you can find and summarily shit-kick the beast onto the ground. Holding the creature down with one foot, you take the hollow tentacle and poise it in front of your raging erection.<br><br>");
            GUI.outputText('"<i>You want dick milk, you freak?!</i>" you bellow in triumph. "<i>HERE YOU GO!</i>"<br><br>');
            GUI.outputText("You impale the tentacle on your penis and begin humping wildly, treating the creature's armature as your own personal onahole. The creature squirms wildly, trying to escape your lust-driven strength. Replying with a swift kick with your free foot, the creature's resolve to escape wavers.<br><br>");
            ...
            GUI.outputText("Feeling your peak approach, you allow your muscles into their rhythmic contractions as you unload your cum into the creature like a howitzer attacking a fort. Laughing like a maniac with each shot, you see your jizz leak out as the creature struggles to assimilate your 'donation'.<br><br>");
        ...
        //Female:
            ...
            if (liveData.player.cor >= 66) {
                GUI.outputText("Seizing the opportunity, you rush the monster while it is stopped. You grab the fattest phallic tentacle you can find and summarily shit-kick the beast onto the ground. Holding the creature down with one foot, you take the tentacle-cock and poise it in front of your dripping cunt.<br><br>");
    ...
    static tentacleLossRape() {
        ...
        if (liveData.player.hasCock() && liveData.player.cumQ() < 1500 && liveData.player.ass.analLooseness < 4) {
            GUI.outputText("Just as you think it's over, another tentacle rams into your " +
        ...
        if (liveData.player.hasCock() && liveData.player.cumQ() < 1500 && liveData.player.ass.analLooseness >= 0) {
            GUI.outputText("Just as you think it's over, the tentacle inside your " +
                liveData.player.assholeDescript() +
        ...
        if (liveData.player.biggestLactation() >= 3.5 && liveData.player.gender > 0) {
            ...
            if (liveData.player.gender == 2) {
                ...
                if (liveData.player.vaginalCapacity() < 30)
                    GUI.outputText("The beast senses your excitement and with beguiling speed swiftly impales your " +
                        liveData.player.vaginaDescript(0) +
                ...
                if (liveData.player.cuntChange(20, true))
                    GUI.outputText("<br>");
                GUI.outputText("<br>");
            } //HERMS
            ...
            GUI.outputText("You slowly become aware that the beast has slowed its assault on your genitals and soon stops altogether, withdrawing entirely.  The beast lets out an audible gurgle and you smile as you feel the tentacles re-double their assault on your " +
        ...
        if (liveData.player.gender == 1) {
            ...
            if (liveData.player.cockTotal() > 1)
                GUI.outputText("at the base of your " + liveData.player.multiCockDescriptLight() + ".");
            ...
            if (liveData.player.cockTotal() == 1)
                GUI.outputText("your member immediately becomes fully erect and pre-cum leaks liberally from your tip.");
            else
                GUI.outputText("your members immediately become fully erect, pre-cum drizzling from the tips.");
            ...
            if (liveData.player.cockTotal() == 1)
                GUI.outputText("In your daze you see a monstrous, hollow tentacle poised over your furious cock. You scream in shock and protest, but your cries fall upon deaf ears. The tentacle descends upon your penis, now begging for release, and clamps down upon your pubic mound, fully encapsulating your member.");
            else
                GUI.outputText("In your daze you see " +
        ...
        if (liveData.player.gender == 2) {
            ...
            if (liveData.player.cor < 75)
                GUI.outputText("It grabs you before you can get away!<br><br>While you struggle valiantly, the beast's raw might is more than a match for you. ");
            GUI.outputText("Tentacles burst from the mass and bind your arms, legs, and midriff. ");
            if (liveData.player.cor < 75)
                GUI.outputText("You struggle to break free, but the creature only constricts you further, ensuring your immobility. ");
            GUI.outputText("A quick flex of the tentacles securing your legs leaves you spreadeagled before the maw of the horror.  ");
            if (liveData.player.cor < 75)
                GUI.outputText("Fearing for your life, you scream and struggle for help, but only the apathetic sounds of nature respond.");
            GUI.outputText("<br><br>" +
        ...
        if (liveData.player.gender == 3) {
            ...
            if (liveData.player.cor < 75)
                GUI.outputText("While you attempt to resist the abomination, its raw muscle mass is too much. ");
            GUI.outputText("It pins you to the ground easily. You immediately feel a sharp, horrible pain at the base of your ");
            if (liveData.player.cockTotal() > 1)
                GUI.outputText("cocks");
            else
            ...
            if (liveData.player.cockTotal() > 1)
                GUI.outputText(liveData.player.multiCockDescriptLight() + " immediately become fully erect and leak pre-cum liberally from their tips.  ");
            else
                GUI.outputText("member immediately becomes fully erect and pre-cum leaks liberally from your tip.  ");
            ...
            if (liveData.player.cockTotal() > 1)
                GUI.outputText("furious cocks.  ");
            else
                GUI.outputText("furious cock.  ");
            GUI.outputText("You scream in shock and protest, but your cries fall upon deaf ears. The tentacle descends upon your ");
            if (liveData.player.cockTotal() > 1)
                GUI.outputText(liveData.player.multiCockDescriptLight() + ", now begging for release, and clamps down around your pubic mound, fully encapsulating your members.  ");
            else
                GUI.outputText(liveData.player.cockDescript(0) + ", now begging for release, and clamps down upon your pubic mound, fully encapsulating your member.");
        }
        //Call page 2!
    ...
    static tentacleRapeContinuation() {
        ...
        // Male
        if (liveData.player.gender == 1) {
            GUI.outputText("You next feel the wretched sensation of another tentacle pushing its way past your anus and into your rectum. You cry more out of frustration and anger than pain as the foreign body settles a few inches inside your body. With a furious, coordinated rhythm, the monstrosity begins swelling the tentacle in your ass and ");
            if (liveData.player.cockTotal() == 1)
                GUI.outputText("using a sucking-stroking motion on your helpless " +
                    liveData.player.multiCockDescriptLight() +
                ...
                GUI.outputText("using a sucking-stroking motion on your " +
                    liveData.player.multiCockDescriptLight() +
        ...
        // Herm
            ...
            if (liveData.player.cockTotal() == 1) {
                GUI.outputText("A sharp tug tells you that the creature has sealed itself upon your " +
                    liveData.player.cockDescript(0) +
                    ". You see " +
                ...
                GUI.outputText("With freakish coordination, the beast sucks your " +
                    liveData.player.cockDescript(0) +
    ...
    static tentacleRapeContinuationForFemales() {
        ...
        if (liveData.player.vaginas.length == 1) {
            ...
            //normal girls get big clits
                ...
                GUI.outputText("almost four inches in length.  Bruised and sore, you pass into unconsciousness ");
        }
        else {
            GUI.outputText("Satisfied, the creature drops you smartly and withdraws its limbs from you and lumbers away.  Covered completely in cum, you see that your " +
        ...
        //Not too corrupt
        if (liveData.player.cor < 75)
            GUI.outputText("too intoxicated with lust to fume over your violation. ");
        //Very corrupt
        else
            GUI.outputText("too intoxicated with lust to continue the pleasure. ");
        ...
        if (liveData.player.clitLength < 7 && liveData.player.clitLength >= 3.5 && liveData.player.findPerk(PerkLib.BigClit) >= 0) {
            ...
            if (liveData.player.clitLength < 5)
                GUI.outputText("like a tiny cock.");
            if (liveData.player.clitLength >= 5 && liveData.player.clitLength < 7)
                GUI.outputText("like a slick throbbing cock.");
            if (liveData.player.clitLength >= 7)
                GUI.outputText("like a big thick cock.");
        }
        ...
        //Mention that clit doesn't grow if your big enough.
            ...
            GUI.outputText("In time it returns to its normal size, losing all the extra volume.");
    ...
    static centaurLossGendered() {
        GUI.outputText("Tentacles wrap around your legs before you can stop them.  They continue to coil up your legs, spreading an uncomfortable warmth through your equine half.  Another tentacle wraps around your torso, spreading that same warmth and fuzzing your mind.  You grab one you can reach and attempt to tear it off of you, but two thinner, translucent feelers immobilize your arms, pulling them up behind your head.<br><br>");
        liveData.player.slimeFeed();
        GUI.outputText("They test your body, slipping about over your form.  A small tentacle finds its way into your mouth, coiling about your tongue and down your throat.  It's careful not to make you choke, seemingly as curious about your innards as it is about your shell.  You're given little time to think though, as a surge of fluid is deposited into your stomach, making your desire to cum grow even more.  The sharp spines coiled about you act similarly, spreading warmth about them wherever they touch your " +
        ...
        if (liveData.player.hasCock()) {
            if (liveData.player.cockArea(liveData.player.smallestCockIndex()) <= 50) {
                ...
                if (liveData.player.cockTotal() > 1)
                    GUI.outputText("  The creature seems surprised at first to discover such a large brace of cocks, testing their texture and wrapping around each individually.  Your " +
                        liveData.player.multiCockDescriptLight() +
                ...
                GUI.outputText("<br><br>");
                GUI.outputText("A peculiar sensation rolls over it as an unseen tentacle engulfs you, rippling and milking your " +
                    liveData.player.cockDescript(0) +
            ...
            // has cock, not engulfable:
                ...
                GUI.outputText("More aphrodisiac-toxin pours into you, causing " +
                ...
                //[With testicles:
                if (liveData.player.balls > 0)
                    GUI.outputText("The sucking reaches all the way to your " + liveData.player.ballsDescriptLight() + ", a spectacularly strange sensation that nevertheless feels wonderful.");
                GUI.outputText("<br><br>");
            }
        }
        // has vagina:
        if (liveData.player.hasVagina()) {
            GUI.outputText("A squirming tentacle forces its way inside your " +
                liveData.player.vaginaDescript(0) +
            ...
            if (liveData.player.hasCock()) {
                if (liveData.player.cockArea(liveData.player.smallestCockIndex()) <= 50)
                    GUI.outputText("  Your humping appears to not affect the creatures continuing efforts, despite the force of your body.");
            }
        ...
        if (liveData.player.biggestTitSize() >= 1 && liveData.player.lactationQ() <= 0) {
            ...
            if (liveData.player.totalBreasts() == 2)
                GUI.outputText("  The anus-like tips affix to them.");
            else
                GUI.outputText("  The anus-like tips attach to one pair as more appear in order to take the others.");
            GUI.outputText("  You feel a gush of liquid leave your body as the translucent lengths of the tentacles turn stark white.  The fluid they inject has caused you to lactate!  They suckle at you incessantly and before long your nipples ache from overuse and your breasts have run completely dry.<br><br>");
        ...
        if (liveData.player.ass.analLooseness >= 4) {
            ...
            if (liveData.player.hasCock())
                GUI.outputText("  A series of undulating lumps pass over your prostate, pushing out a splash of pre-cum.");
        ...
        if (liveData.player.biggestTitSize() >= 1 && liveData.player.lactationQ() > 0 && liveData.player.lactationQ() < 1000) {
            GUI.outputText("Roving tentacles latch onto your " +
                liveData.player.allBreastsDescript() +
        ...
        if (liveData.player.hasCock()) {
            ...
            if (liveData.player.cumQ() <= 500)
                GUI.outputText("pushing the creature to the edge of its fluid-containing abilities.");
            else
                GUI.outputText("quickly overfilling the tentacle attached to it; it explodes off of you, freeing your spunk to spray from both you and the retreating beast.  ");
        }
    ...
    static encounter() {
        ...
        if (liveData.player.gender == 0 && UTIL.rand(3) == 0 && !liveData.player.isNaga() && !liveData.player.isTaur() && !liveData.player.isGoo()) {
            ...
            GUI.outputText("You see a massive, shambling form emerge from the underbrush. While first appearing to be a large shrub, it shifts its bulbous mass and reveals a collection of thorny tendrils and cephalopodic limbs. Sensing your presence, it lumbers at you, full speed, tentacles outstretched.<br><br>");
            if (liveData.player.cor > 50 && liveData.player.cor <= 75)
                GUI.outputText("You debate the merits of running from such a creature, and realize it's now too late to escape.  ");
            if (liveData.player.cor > 75)
                GUI.outputText("You smile and stride forward, welcoming the pleasure you expect from such a monster.  ");
            ...
            GUI.outputText('You sheepishly state that you are gender-neutral and have no genitalia.<br><br>"<i>You gotta be shitting me!!</i>" the monster bellows in contempt. "<i>Of all the motherfuckers I ambush, it has to be the ONE bastard I can\'t feed from! What am I supposed to do now, asshole?! I gotta eat!</i>"');
            GUI.outputText('At a loss for words, you meekly offer the creature some of your food you have packed for your journey. The creature slaps it out of your hand, almost breaking your wrist.<br><br>"<i>I can\'t eat that shit!</i>" roars the abomination. "<i>Do I look like I have a fucking mouth to chew that with?! NOOOOOO! I feed off dicks and wayward women! Cum and tit milk! YOU have NEITHER!!!</i>"  ');
        ...
        //Combat starter
        GUI.outputText("You see a massive, shambling form emerge from the underbrush.  While it resembles a large shrub, a collection of thorny tendrils and cephalopodic limbs sprout from its bulbous mass.  Sensing your presence, it lumbers at you, full speed, tentacles outstretched.<br><br>");
        if (liveData.player.cor > 50 && liveData.player.cor <= 75)
            GUI.outputText("You debate the merits of running from such a creature.<br><br>");
        if (liveData.player.cor > 75)
            GUI.outputText("You smile and stride forward, welcoming the pleasure you expect from such a monster.<br><br>");
        //Worms get nothing!
    ...
    static centaurLossGenderless() {
        ...
        if (liveData.gameFlags[FLAG.TENTACLE_GENDERLESS_CENTAUR] == 0 || liveData.player.balls == 0) {
            ...
            if (liveData.player.cor < 50 && liveData.player.lust < 70)
                GUI.outputText("dread");
            else
                GUI.outputText("anticipation");
            ...
            GUI.outputText("\"<i>Oh, you think this shit is FUNNY, don't you?</i>\"  The voice has switched to a mocking tone.  \"<i>I know, let's wander into the forest and fuck with the hungry creatures who want some nice, nutritious cum!  Let's make them work for my amusement!  It'll be fucking HILARIOUS!</i>\"<br><br>");
        ...
        //(Followup scene, if pc has seen above at least once, is unsexed centaur and has balls: -Z)
            ...
            GUI.outputText("The tentacle, now joined by a second, hunts around your " +
    ...
    static nagaLossGenderless() {
        GUI.clearOutput();
        // TODO spriteSelect(100);
        GUI.outputText("Out of nowhere tentacles bind your arms and tail, holding you firm in a matter of seconds.  You struggle to free yourself but can do nothing against the strength of the beast holding you in your current state.  More of the appendages start teasing around your body, as if looking for something.  A handful test the entrance to your " +
            liveData.player.assholeDescript() +
            " but evidently that's not what they're after.<br><br>");
        GUI.outputText("An oddly human voice comes from the undergrowth, catching you off-guard.  \"<i>Look, I'm really sorry about this, but I'm really not all that familiar with, uh, whatever it is you are.  Where do you keep the naughty bits?</i>\"<br><br>");
        GUI.outputText('A little stunned by the question, you tell the voice that you don\'t have any "<i>naughty bits</i>".<br><br>');
        GUI.outputText('"<i>I\'m sorry, maybe I just worded the question badly.  Um, where do you keep your penis... esss and or vagina... ssss.</i>"  The words are followed up by prolonged hisses that may or may not represent the usual attempt to transmute one language to another by tacking new suffixes on.<br><br>');
        GUI.outputText("Sensing an opportunity to get out of this situation, you respond with your own series of hisses and hand gestures as if to say you have no idea what the beast wants.  It responds with a sigh and you're released from its grip, landing on the ground in a bit of a heap.<br><br>");
    ...
    static gooLossGenderless() {
        ...
        GUI.outputText("One of the larger tentacles extends and latches onto your base, its anus-like opening sucking gently at your gooey mass.  There follows a brief moment where you're not really afraid of the situation, but are instead mildly curious yourself what you taste like.<br><br>");
    ...
    static futaTentacleEpilogue() {
        ...
        if (liveData.gameFlags[FLAG.GIACOMO_MET] > 0) {
            ...
            GUI.outputText('"<i>It is a good thing I happened to be out and about today.</i>", Giacomo says. "<i>I was testing out a new weapon to sell and I happened to see one of those nasty tentacle beasties. I had no idea they captured prey! Hell, you must have spent a few months inside that thing feeding it!</i>"<br><br>');
        ...
        //[Never met Giacomo]
            ...
            GUI.outputText('"<i>We cannot leave this unfortunate ' +
