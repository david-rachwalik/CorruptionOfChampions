    ...
    if (player.isTaur()) {
        ...
        if (player.longestCockLength() >= 100 || player.gender == 0) {
            ...
            //[Herm (bypasses the bucking scene):
                ...
                //[Huge cum amount:
                    ...
                    outputText(player.SMultiCockDesc() + " goes off like a firehouse, coating the base of the tree along with a number of the ones behind it. Soon you're standing in a massive puddle of your own splooge, the scent threatening to overpower that of the honey. The bee-girl compensates by splashing more onto your back, causing you to release yet another burst of thick white cum.<br><br>", false);
            }
        ...
        //Route 1
            ...
            //[Female:
                ...
                outputText("Your inability to reach your " + player.vaginaDescript(0) + " quickly becomes a problem as the pleasure from the bee maiden's scent courses through you, it starts reflexively rippling, trying to milk the cock it so desperately wants while your " + player.clitDescript() + " quivers.", false);
            //[Herm:
            else if (player.gender == 3)
            ...
            if (player.gender == 1) {
                ...
                //[Huge cum amount:
                    ...
                    outputText("Your " + player.ballsDescriptLight() + " goes off like a firehouse, coating your underside with white and dripping down your front legs. Soon you're standing in a massive puddle of your own splooge, the scent threatening to overpower that of the honey. The bee-girl compensates by splashing more onto your back, causing you to release yet another burst of thick white cum.<br><br>", false);
            }
            //[Female:
            else if (player.gender == 2) {
    ...
    if (player.isTaur()) {
        ...
        if (player.cockArea(x) <= monster.vaginalCapacity()) {
            ...
            if (player.balls == 0)
                ...
                //Huge cum amount:
                    ...
                    outputText("  It sprays inside the bee-girl, quickly overfilling her and causing her belly to expand. Her sudden increased girth and the extreme exertion cause her to lose her grip on you, and she is propelled off of you into a puddle of spunk and honey. You can't control yourself as your " + player.ballsDescriptLight() + " continue to pump out more and more fluid, spraying down the exhausted bee and coating her flower with enough gunk to cause it to wilt slightly. Eventually it stops, with only periodic gushes spraying out.", false);
            }
            outputText("<br><br>", false);
        ...
        //Cock too long to penetrate her:
            ...
            //Other cocks:
                ...
                outputText("  Her tongue wraps around your " + player.cockDescript(x) + " and slides up and down the small area it can reach before flicking about at the tip of your urethra. Her expert licking feels amazing and it's not long before your feel the familiar sensation of orgasm creeping up on you.", false);
            outputText("<br><br>", false);
...
BeeGirlScene.rapeABeeGirlWithYourVagina = function () {
    ...
    if (player.isTaur()) {
        ...
        if (player.ass.analLooseness >= 2)
            outputText("  Not wanting this, she attempts to brace her other hand between your " + player.assDescript() + "'s cheeks, but your " + player.assholeDescript() + " opens and she slides inside. With an immense effort she pulls out of your ass, nearly pushing you over the edge in the process, but the arm stuck on your vagina is stuck tight.", false);
...
BeeGirlScene.futaRapesBeeGirl = function () {
    ...
    if (player.balls >= 2) {
        if (player.ballSize < 5)
            ...
            outputText("Your " + player.ballsDescriptLight() + " obscure most of her face, making it difficult to see her reactions, but her mouth gives you all the feedback you need.  It doesn't take more than a few moments for her struggles to cease, and soon, her long insectile tongue is worming its way into your " + player.vaginaDescript(0) + ".  ", false);
    }
    ...
    if (player.balls >= 2)
        outputText("The warmth and pleasurable pressure of your male orgasm builds in your " + player.ballsDescriptLight() + ", growing stronger as it migrates up your groin to the base of your pulsing member.  You squeeze your " + player.cockDescript(0) + " tightly, trying to hold on a bit longer, but the squirming tongue inside you is too much.  ", false);
    //Mmmmmmangasm!
    if (player.isTaur())
...
BeeGirlScene.beeGirlRapeForTheDistinguishedGentleman = function () {
    ...
    //[(if dick)
    if (player.hasCock())
        outputText("stroke your " + Appearance.cockNoun(CockTypesEnum.HUMAN), false);
    else if (player.hasVagina())
