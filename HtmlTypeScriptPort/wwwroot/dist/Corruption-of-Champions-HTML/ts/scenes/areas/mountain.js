            ...
            case 3:
                ...
                if (liveData.gameFlags[FLAG.INFESTED] == 1 || liveData.gameFlags[FLAG.WORMS_FETISH] == 3) {
                    if (liveData.player.cor < 90) {
                        ...
                        GUI.outputText("During your hike into the mountains, your depraved mind keeps replaying your most obcenely warped sexual encounters, always imagining new perverse ways of causing pleasure.<br><br>It is a miracle no predator picked up on the strong sexual scent you are emitting.");
                ...
                if (liveData.gameFlags[FLAG.WORMS_FETISH] == 2)
                ...
                if (liveData.gameFlags[FLAG.WORMS_FETISH] == 1 && UTIL.rand(2) == 0) {
                    if (liveData.player.cor < 90) {
                        ...
                        GUI.outputText("During your hike into the mountains, your depraved mind keeps replaying your most obcenely warped sexual encounters, always imagining new perverse ways of causing pleasure.\n\nIt is a miracle no predator picked up on the strong sexual scent you are emitting.");
