...
SandTrapScene.handjobWin = function () {
    ...
    if (player.gender == 1) {
        ...
        if (player.cocks[0].cockLength < 6) {
            // balls:
            if (player.balls == 0)
                outputText("<br><br>The sandtrap only needs one hand to pump your diminutive cock; it barely moves its wrist as it jerks you, occasionally wriggling its oily fingers along the bottom of your " + player.cockDescript(0) + " to stimulate you even further.");
            else
                outputText("<br><br>The sandtrap only needs one hand to pump your diminutive cock; it barely moves its wrist as it jerks you, occasionally wriggling its oily fingers along the bottom of your " + player.cockDescript(0) + " to incite you even further, whilst it uses its free hand to gently cup your [balls].");
        ...
        //Cock 6-16 inches:
            ...
            //Balls:
                ...
                outputText("<br><br>The sandtrap glides its hand up and down your " + player.cockDescript(0) + ", picking up a warm smooth rhythm as it gently cups your [balls] with its free hand.]  It slows down intermittently to move its palm around your length, letting every inch of your dick feel the tips of its delicate fingers.");
        }
    ...
    //Herm:
        ...
        //Cock 6-16 inches:
            ...
            if (player.balls == 0)
                ...
                outputText("<br><br>The sandtrap glides its hand up and down your " + player.cockDescript(0) + ", picking up a warm smooth rhythm as it gently cups your [balls] with its free hand.]  It slows down intermittently to move its fingers around your length, letting every inch of your dick feel the tips of its delicate fingers.");
        }
        else {
