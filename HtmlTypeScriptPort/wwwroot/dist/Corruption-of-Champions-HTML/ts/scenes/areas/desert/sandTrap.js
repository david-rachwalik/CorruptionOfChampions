...
SandTrap.trapLevel = function (amount) {
    ...
    if (amount != 0) {
        ...
        if (gameFlags[TRAP_LEVEL] < 1)
            gameFlags[TRAP_LEVEL] = 1;
        if (gameFlags[TRAP_LEVEL] > 4)
            gameFlags[TRAP_LEVEL] = 4;
    }
...
SandTrap.prototype.doAI = function () {
    ...
    if (gameFlags[TRAP_LEVEL] == 4 && gameFlags[CLIMBED_TRAP_THIS_ROUND] == 0)
        SandTrap.grabAttack();
    // Otherwise, try pheramones
    else
        SandTrap.sandTrapPheremones();
...
SandTrapScene.sandTrapWin = function () {
    ...
    if (player.lust >= 33) {
        ...
        if (player.hasCock() && player.str >= 60)
            addButton(1, "UseYourCock", SandTrapScene.cockWin); //stickWanginSandgina
        if (player.hasVagina())
            addButton(2, "RideVaginal", SandTrapScene.vaginaWin); //rideDatSandTarp
        if (player.gender > 0)
            addButton(3, "Handjob", SandTrapScene.handjobWin); // useSandTarpsHands
...
SandTrapScene.cockWin = function () {
    ...
    outputText("<br><br>You take a moment to look your strange conquest over.  Even up close you can't tell from its thin, fey beauty whether it is male or female.  Although it is affecting to look angry at you, its sculpted cheeks are quite flushed and there is a definite undercurrent of desire in its eyes; you suspect your display of strength and dominance appeals to it on some perverse, animalistic level.  Still smiling victoriously, you bend your face into it, deliberately invading its personal space, silently demonstrating who is in charge here.  It can't hold your gaze and, blushing, looks downwards.  This submissive demureness sends heat rushing towards your " +
        ...
        ", makes you hard");
    if (player.balls > 0)
        outputText(", makes your " + player.ballsDescriptLight() + " swell in readiness,");
    ...
    //Megacock:
        ...
        outputText("<br><br>The creature's moist sex is tight and you honestly doubt it can even take your obscenely massive tool.  Never say never, though.  You work your way in carefully, letting it get used to your girth, slowly working it loose enough to take your " +
            player.cockDescript(0) +
        ...
        if (player.balls > 0)
            outputText("  Your " + player.ballsDescriptLight() + " slap against the creature's wet opening.  ");
    ...
    outputText("<br><br>\"<i>Hhhhyes!  That'sz it lion, oh do me, do it to me hard!  Give me yyyyour strong spunk - uh! give hhit to me szo I can sink yyour children into evvryone I catch - yes!  Hhhhso the whole world can know hhwhat a " +
        player.mf("man", "woman") +
...
SandTrapScene.vaginaWin = function () {
    ...
    //TODO spriteSelect(97);
    //Requirement: Vagina
    outputText("You bend into the sand and allow the slope to slowly carry you down to the bottom and the defeated sandtrap.  Its six black eyes regard you with a mixture of lust and resentment as you slowly discard your [armor], reveling in the hot desert sun upon your naked " +
        player.skin() +
...
SandTrapScene.handjobWin = function () {
    ...
    if (player.gender == 1) {
        ...
        if (player.cocks[0].cockLength < 6) {
            // balls:
            if (player.balls == 0)
                outputText("<br><br>The sandtrap only needs one hand to pump your diminutive cock; it barely moves its wrist as it jerks you, occasionally wriggling its oily fingers along the bottom of your " +
                    player.cockDescript(0) +
        ...
        //Cock 6-16 inches:
            ...
            //[no balls:
            if (player.balls == 0)
                outputText("<br><br>The sandtrap glides its hand up and down your " + player.cockDescript(0) + ", picking up a warm smooth rhythm.");
            //Balls:
            else
                outputText("<br><br>The sandtrap glides its hand up and down your " +
                    player.cockDescript(0) +
        ...
        //Cock more than 16 inches:
            ...
            outputText("<br><br>The sandtrap quickly comes to the realisation it needs both hands for this.  Still cupping your behind, it moves one oily hand up the top end of your massive shaft, while the other works the other half.  You sigh with deep satisfaction, enjoying the all-too-rare sensation of having every inch of your " +
                player.cockDescript(0) +
        ...
        //Two cocks:
            ...
            outputText("  As the sandtrap begins to pump you faster, your disregarded " +
        ...
        //Three cocks:
            ...
            outputText("<br><br>As the sandtrap begins to pump you faster, your two other, disregarded cocks bob in hard, eager concert with your " +
                player.cockDescript(0) +
        ...
        //Four cocks:
            ...
            outputText("<br><br>As the sandtrap begins to pump you faster, your three other, disregarded cocks bob in hard, eager concert with your " +
                player.cockDescript(0) +
        ...
        //More than four cocks:
            ...
            outputText("<br><br>As the sandtrap begins to pump you faster, your many other, disregarded cocks bob in hard, eager concert with your " +
                player.cockDescript(0) +
    ...
    //Herm:
        ...
        outputText('<br><br>One pair of the creature\'s hands slowly brush up your inner thighs whilst the other two feel around your "<i>armor</i>", clumsily loosening clasps and belts as it finds them.  One hand finds your ' +
            player.cockDescript(0) +
        ...
        //Two cocks:
            ...
            outputText("<br><br>As the sandtrap begins to pump you faster, your disregarded " +
                player.cockDescript(1) +
        ...
        //hree cocks:
            ...
            outputText("<br><br>As the sandtrap begins to pump you faster, your two other, disregarded cocks bob in eager concert with your " +
                player.cockDescript(0) +
        ...
        //More than three cocks:
            ...
            outputText("<br><br>As the sandtrap begins to pump you faster, your many other, disregarded cocks begin to harden in eager concert with your " +
                player.cockDescript(0) +
...
SandTrapScene.sandTrapLoss = function () {
    ...
    //PC lust loss:
        ...
        outputText("You feel as radiant and molten as the sun above you... you just want to sink into the warm sand surrounding you forever.  Why are you struggling against it again?  You can't remember; with a sigh, you fall backwards onto the soft powder and allow yourself to be carried right down to the bottom.  The sandtrap chuckles softly as it envelopes you in its waiting arms.  \"<i>Good " +
            ...
            '...</i>"');
    if (player.hasCock())
        doNext(SandTrapScene.cockLoseToSandTrap);
    else if (player.hasVagina())
        doNext(SandTrapScene.chicksLoseToSandTrap);
    else
        doNext(SandTrapScene.genderlessLoseToSandTrap);
};
SandTrapScene.cockLoseToSandTrap = function () {
    ...
    //6 inches to 15:
        ...
        outputText("<br><br>The creature owns an incredibly tight sex which grasps you possessively once it is on you; it fits your cock like a glove.  The sandtrap sighs its fluttering sigh when it reaches your base and then slowly begins to work you, its punishing, pulsing muscles squeezing your cock up and down.");
    //More than 15 inches:
    else
        outputText("<br><br>The creature owns an incredibly tight sex which grasp you possessively once it is on you.  Sweat beads the sandtrap's elegant brow as it forces itself brutally down your huge shaft; when it finally stops with a sizable portion of your " +
            player.cockDescript(0) +
    ...
    if (player.analCapacity() < 40)
        outputText("  Although the oil which coats your thoughts and reflexes with sensual supplication makes things easier, the feeling is still incredibly intense, and you grit your teeth as something round travels down the creature's ovipositor and stretches your tight hole wide.");
    else
...
SandTrapScene.chicksLoseToSandTrap = function () {
    ...
    if (monster.findStatusEffect(StatusEffects.Fertilized) >= 0)
        SandTrapScene.sandTrapPregChance(); //TODO Pregnancy
    player.dynStats("lib", 1);
    player.slimeFeed();
    //reduce lust, increase lib, slimefeed, reset hours since cum
    cleanupAfterCombat();
...
SandTrapScene.birfSandTarps = function () {
    ...
    //TODO spriteSelect(97);
    outputText("<br>Your eyes widen as a gout of oil suddenly gushes from your ass.  Before panic can set in, an incredible light-headedness overtakes you.  Dreamily, you discard your [armor] and squat.  More oil oozes out of you, and in your hazy euphoria, you scoop some of it up and rub it dreamily into your " +
    ...
    //Herm:
        ...
        //[(no horses)]
        if (!player.isTaur())
            outputText("  Your oily hands descend upon your genitals and you begin to slowly pump your shaft and finger your needy " + player.clitDescript() + " as you feel the pressure in your bowels intensify again.");
    }
    ...
    //Libido 30-65:
        ...
        outputText("<br><br>You spend a moment enjoying your post-natal haze, then haul yourself out of it, flap the flytraps you have birthed away, and make your way back to camp.  Though this experience has been deeply unnerving, you can't help but acknowledge it has also been incredibly erotic.");
    //Libido >65:
    else
        outputText("<br><br>You smile lazily, then lie back and glory in the sensual haze the oil has left you in.  After you have spent many minutes lying listening to the happy twittering of your flytrap children above you, you reluctantly get up.  You only hope that you get to experience the unearthly wonder of birthing these strange creatures again, and again, and again.");
