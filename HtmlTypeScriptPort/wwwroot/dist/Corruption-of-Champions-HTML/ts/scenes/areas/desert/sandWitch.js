...
SandWitch.lustAttack = function () {
    ...
    if (player.findStatusEffect(StatusEffects.StoneLust) >= 0) {
        ...
        outputText("You feel the sands shift by your " +
            player.feet() +
        ...
        if (player.hasVagina() > 0) {
            ...
            outputText("Too late! You reach to stop it, but it pushes against your lips and slips inside your " +
...
SandWitchScene.beatSandWitch = function () {
    if (monster.lust >= monster.maxLust())
        outputText("You smile in satisfaction as the " +
            monster.name +
            " drops down on all fours and begins masturbating feverishly.  Sadly you realize your own needs have not been met.  Of course you could always fuck the horny witch...<br><br>Do you rape her?", true);
    else
        outputText("You smile in satisfaction as the " + monster.name + " drops down on all fours and struggles to rise.  Sadly you realize your own needs have not been met.  Of course, you could always fuck the witch...", true);
    ...
    if (player.gender == 1 || player.gender == 3) {
        ...
        //Really corrupt
            ...
            if (player.cockTotal() == 1) {
                //DOGGIES
                if (player.dogCocks() > 0 && player.cocks[0].knotMultiplier > 1.4)
                    SandWitchScene.knotSandWitch();
                else {
                    outputText("You place your " +
                        player.foot() +
                        ...
                        " to one of her nethers, slowly easing into her depths.  ", false);
                    outputText("Thrusting deep, you hit bottom, and marvel at the sensations as you feel the head of your " +
                        player.cockDescript(0) +
                        " rub against the end of her slick cunts, only making you lust after her more. As though responding to your will, your " +
                        player.cockDescript(0) +
                        " grows just a tiny bit more in length and thickness.  ", false);
                    ...
                    outputText("<br><br>The sand witch screams in savage denial as you plant your seed deep within her body, your corruption no doubt making it extra potent. You gaze into her eyes, reveling in her expression of horror. Without uttering a word, you continue to fuck her, making sure your seed is well-entrenched within her womb, feeling it splatter and bubble around your " +
                        player.cockDescript(0) +
                        ".  You wonder if she will remember the pleasure her body felt today, and if she will be more likely to drop to her knees before you than to fight... ", false);
            ...
            if (player.cockTotal() > 1) {
                ...
                outputText("Using the corruption in your blood, you place your " +
                    player.foot() +
                    ...
                    " to her nethers, slowly easing into her depths.  ", false);
                outputText("Thrusting deep, you hit bottom, and marvel at the sensations as you feel the heads of your " +
                    player.multiCockDescriptLight() +
                    ...
                    player.multiCockDescriptLight() +
                    " grow just a tiny bit more in length and thickness.  ", false);
                outputText("With a satisfied growl of lust from yourself, and a screech of pain from the sand witch, you break past her cervixes and into her wombs. Pulling the heads of your " +
                    player.multiCockDescriptLight() +
                    " from her wombs, you rub and rut at the outside of her cunts, bringing yourself closer and closer to your peak as the sand witch struggles, her eyes turning wide with fright as she starts to understand you hold more power than her.  ", false);
                ...
                outputText("<br><br>The sand witch screams in savage denial as you plant your seed deep within her body, your corruption no doubt making it extra potent. You gaze into her eyes, reveling in her expression of horror. Without uttering a word, you continue to fuck her, making sure your seed is well-entrenched within her wombs, feeling it splatter and bubble around your " +
                    player.multiCockDescriptLight() +
                    ".  You wonder if she will remember the pleasure her body felt today, and if she will be more likely to drop to her knees before you than to fight... ", false);
                outputText("Finally finished, you pull your " +
                    player.multiCockDescriptLight() +
                    " from her well used slits, your " +
                    player.multiCockDescriptLight() +
                    " drooling cum even now. With a grin, you walk away, happy with your little encounter.  ", false);
                cleanupAfterCombat();
                player.orgasm();
            }
        }
...
SandWitchScene.sandWitchCentaurBoning = function () {
    ...
    //[win via HP]
    if (monster.HP < 1)
        outputText("and torn in many places. ", false);
    //[win via lust]
    else
        outputText("and her fingers squeezing her nipples as lust overwhelms her. ", false);
    //[has breasts]
    if (player.biggestTitSize() > 3) {
        outputText("As you approach, her eyes drift up to your " + player.allBreastsDescript() + " and she ", false);
        //[win via HP]
        if (monster.HP < 1)
            outputText("is unable to stop herself from slowly licking her lips. ", false);
        //[win via lust]
        else
            outputText("sensually licks her parted lips. ", false);
    }
    //[lactating]
    ...
    if (player.cor < 70) {
        ...
        if (player.biggestTitSize() > 0)
            outputText("; your " + player.nippleDescript(0) + "s  become stiff", false);
        //[cock only]
        if (player.totalCocks() > 0 && !player.hasVagina())
            outputText(" and your " + player.cockDescript(0) + " hardens.", false);
        //[cunt only]
        if (player.hasVagina() && player.totalCocks() == 0)
            outputText(" and your " + player.vaginaDescript(0) + " begins to drip with moisture.", false);
        //[cock and cunt]
        if (player.hasVagina() && player.totalCocks() > 0)
            outputText(" and your " + player.cockDescript(0) + " hardens as your " + player.vaginaDescript(0) + " begins to drip with moisture.", false);
        if (player.gender == 0)
            outputText(" her.", false);
        ...
        //[has breasts]
        if (player.biggestTitSize() > 0)
            outputText(", eyes fixed on your " + player.allBreastsDescript(), false);
        outputText(".<br><br>", false);
        ...
        //[STR > 50]
        if (player.str > 50)
            outputText("pick her up and toss her onto your back. ", false);
        //[STR < 50]
        else
            outputText("offer her your hand and help her onto your back. ", false);
        ...
        //[has breasts]
        if (player.biggestTitSize() > 0)
            outputText("fondle your " + player.allBreastsDescript() + " and ", false);
        ...
        if (player.biggestTitSize() > 0) {
            ...
            if (player.biggestLactation() >= 1) {
                ...
                //[light-med lactation]
                if (player.biggestLactation() < 3)
                    outputText("small streams running out ", false);
                //[heavy lactation]
                else
                    outputText("torrents gushing out ", false);
    ...
    //[Corruption > 70]
        ...
        //[STR > 50]
        if (player.str >= 50)
            outputText("easily tear them off of her. ", false);
        //[STR < 50]
        else
            outputText("drag her a bit until they come off. ", false);
        ...
        if (player.cockTotal() > 0 || (player.gender == 3 && rand(2) == 0)) {
            ...
            if (player.cocks[0].cockThickness >= 3) {
                if (player.hasKnot(0))
                    outputText("Seeing its sheer size combined with your swollen knot causes her to gasp in terror and try to run again.  ", false);
                else
                    outputText("Seeing its sheer size causes her to gasp in fear and turn to run again.  ", false);
            }
            ...
            //[1 cock, non-tentacle]
            if (player.cockTotal() == 1 && player.countCocksOfType(ENUM.CockType.TENTACLE) == 0)
                outputText("With a single thrust, you push deep into one of her cunts, ", false);
            //[1 cock, tentacle]
            ...
            if (player.cockTotal() == 2)
                outputText("After aligning your " + player.multiCockDescriptLight() + " to her twin cunts, you push yourself deeply into her, ", false);
            //[3+ cocks]
            if (player.cockTotal() >= 3)
                outputText("Lining up two of your cocks to her twin cunts and another to her anus, you thrust into her without pre-amble.  Her anal muscles try to keep you out, but they are no match for the strength of your legs.  You tear into her, ", false);
            ...
            if (player.cocks[0].cockLength >= 12) {
                if (player.cockTotal() == 1)
                    outputText("Her body surrenders more and more as your " + player.multiCockDescriptLight() + " presses against her cervix. ", false);
                else
                    outputText("Her body surrenders more and more as your " + player.multiCockDescriptLight() + "  press against her cervixes. ", false);
            ...
            //[largest cock is not wide and/or long]
                ...
                outputText(", and her cries have long since turned into groans of pleasure. ", false);
            ...
            if (player.cumQ() >= 250)
                outputText("gushing massive amounts of your cum ", false);
            //[regular cum production]
            else
                outputText("pushing your sperm ", false);
            outputText("deep into her ", false);
            //[1 cock, tentacle]
            if (player.cockTotal() == 1 && player.countCocksOfType(ENUM.CockType.TENTACLE) == 1)
                outputText("anus", false);
            else {
                //[largest cock is not wide and/or long]
                if (player.cocks[0].cockLength >= 12 || player.cocks[0].cockThickness >= 3) {
                    //[1 cock]
                    ...
                    //[2+ cocks]
                    if (player.cockTotal() >= 2)
                        outputText("cunts", false);
                }
                //[largest cock is wide and/or long]
                else {
                    outputText("womb", false);
                    if (player.cockTotal() >= 3)
                        outputText(" and bowels", false);
                }
            }
        ...
        //[% no cocks]
            ...
            //[has cunt]
            if (player.hasVagina())
                outputText("and your " + player.vaginaDescript(0) + " dripping with desire", false);
            ...
            if (player.hasVagina()) {
                outputText(player.vaginaDescript(0) +
                    ...
                    player.clitDescript() +
                    " and she suckles on it, drawing a pained gasp from you and causing your pussy juices to gush over her face. You feel ", false);
                //[cunt size is small]
                if (player.vaginalCapacity() < 10)
                    outputText("one of her fingers ", false);
                //[cunt size is normal]
                else if (player.vaginalCapacity() < 20)
                    outputText("several of her fingers ", false);
                //[cunt size is large]
                else
                    outputText("a fist ", false);
                outputText("pushing deep into your " + player.vaginaDescript(0) + ", and you're surprised as ", false);
                //[anus size is small]
                if (player.analCapacity() < 10)
                    outputText("her tongue ", false);
                //[anus size is normal]
                else if (player.analCapacity() < 20)
                    outputText("two of her fingers ", false);
                //[anus size is large]
                else
                    outputText("a fist ", false);
            ...
            //[does not has cunt]
                ...
                //[anus size is small]
                if (player.analCapacity() < 10)
                    outputText("The sensations are intense, and you could almost swear that her tongue is tracing a pattern as her mouth mutters strange sounds. ", false);
                //[anus size is normal]
                else if (player.analCapacity() < 20)
                    outputText("Unsatisfied with just her buffet, you soon feel her fingers thrust hard into you and hear her muttering what sounds like obscene words of depraved lust. ", false);
                //[anus size is large]
                else
                    outputText("Unsatisfied with just her buffet, the witch grabs one of her breasts and squirts milk into your massive hole.  You realize she was lubricating it even as you feel her entire hand driving into you.  The sensations are too intense, and your screams of pleasure drown out her lustful muttering. ", false);
            }
...
SandWitchScene.sandWitchBewbs = function () {
    ...
    outputText("You burp, and flush scarlet, but the sand witch lays a hand against your face, leans close, and kisses your lips sweetly. Her tongue snakes out and dives into your mouth. She pulls your face against hers, grinding her breasts against your chest. You can feel fresh milk dribbling against your " +
        player.skinDesc +
        " and the scents are driving you wild with lust.  ", false);
...
SandWitchScene.sandWitchSex = function () {
    ...
    if (player.cockTotal() > 1)
        outputText(num2Text(player.cockTotal()), false);
    else
        outputText("two", false);
    outputText(" of them!  The sand witch appears frightened, but as you gently tease her lips with your fingers, she slowly starts to breathe faster, starting to moan as her legs spread themselves against her better judgment. Grinning in satisfaction, you bring your rigid " +
        player.cockDescript(0) +
        " against her lips, and push slowly, gently.  ", false);
    outputText("The sand witch cries out, her hands grabbing your arms, pressing hard against your " +
        player.skinDesc +
        " as you slowly and teasingly ease your " +
        player.cockDescript(0) +
        " into her tight depths. You almost feel like a virgin, your " +
        player.cockDescript(0) +
        " throbbing, the need to cum almost beyond your ability to control.  ", false);
    ...
    outputText("<br><br>With a satisfied smirk, you lay atop your prize, your " +
        ...
        player.cockDescript(0) +
        " buried deep in the sand witch.  ", false);
...
SandWitchScene.knotSandWitch = function () {
    //spriteSelect(50);
    clearOutput();
    outputText("You press the tip of your " +
        player.cockDescript(0) +
        ...
        player.cockDescript(0) +
        " to the hilt within her, moaning as the tip pushes against her cervix.<br><br>", false);
    outputText("As your " +
        player.cockDescript(0) +
        ...
        player.cockDescript(0) +
        ". As the pleasure increases, your body readies itself for the spill, and your knot begins to swell.  ", false);
    ...
    outputText("Then it begins to get in the way, preventing your length from going all the way in, causing the pointed tip of your " +
        player.cockDescript(0) +
    ...
    outputText("You grunt and push hard, desperate to force the bulbous cock-flesh inside, and you're rewarded as it pops in with a wet squelch. The tightening pressure around the base of your " +
        player.cockDescript(0) +
        " pushes you over the edge, and the cum begins to shoot in her tight hole, with your " +
        player.cockDescript(0) +
        " trapped inside!<br><br>", false);
    //ORGAZMO
    if (player.cumQ() < 25)
        outputText("The cum slicks your dick as you continue trying to hump, easing the over-sensation of your dick while you're glued together by the bulbous knot locked in her snatch.", false);
...
SandWitchScene.sandWitchGetsDildoed = function () {
    ...
    if (player.cor > 50)
        outputText("lick it clean, ", false);
...
SandWitchScene.ovipositSandWitches = function () {
    ...
    if (monster.HP < 1)
        outputText("<br><br>Rolling your eyes, you offer a sympathetic hand to the defeated witch, showing her that you don't mean to hurt her any further, that you have something more... pleasurable in mind.  ");
    ...
    if (player.hasCock())
        outputText("hardened  " + player.multiCockDescriptLight());
    if (player.gender == 3)
        outputText(" and ");
    if (player.hasVagina())
...
SandWitchScene.laySomeEggsInThatWitchFinally = function () {
    ...
    if (player.hasCock())
        outputText("take hold of your " + player.multiCockDescriptLight() + " and bring it");
    else
        outputText("bring your " + player.vaginaDescript(0));
...
SandWitchScene.sammitchBirthsDriders = function () {
    ...
    if (player.cor < 60)
        SandWitchScene.helpZeWithBirfBabies();
    else
        SandWitchScene.reluctantlyHelpZeWitch();
};
//[Help her!] (corr < 60)
//no new PG
SandWitchScene.helpZeWithBirfBabies = function () {
    ...
    if (!player.isDrider())
        outputText('<br><br>"<i>W-what the hell did you do to yourself over the last few days?</i>" the sand witch blurts, noticing the difference in your appearance since your union.  The words that come out of her mouth next are cut off however, as she doubles over in pain.');
...
SandWitchScene.sandWitchBirthsYourMonstrositites = function () {
    ...
    //[(corr >= 60)
    if (player.cor >= 60)
        outputText('<br><br>"<i>Just, use your common sense next time.</i>"');
