...
class Minotaur extends Creature {
    ...
    minoPheromones() {
        ...
        if (UTIL.rand(3) == 0) {
            ...
            GUI.outputText("right past your head. ");
        ...
        if (liveData.gameFlags[FLAG.MINOTAUR_CUM_ADDICT] > 0 || liveData.gameFlags[FLAG.MINOTAUR_CUM_ADDICTION_STATE] == 2) {
            if (UTIL.rand(2) == 0)
                GUI.outputText("<br><b>You shiver with need, wanting nothing more than to bury your face under that loincloth and slurp out every drop of goopey goodness.</b> ");
            else
                GUI.outputText("<br><b>You groan and lick your lips over and over, craving the taste of him in your mouth.</b> ");
...
class MinotaurScene {
    static encounterMinotaur() {
        ...
        if (liveData.gameFlags[FLAG.MINOTAUR_TF2] == 0 && liveData.player.level <= 1 && liveData.player.str <= 40) {
            if (liveData.silly) {
                ...
                GUI.outputText('The beast collapses in a charred and bloody heap. As you stand back up, you hear a strange noise behind you. You turn around to find a well-dressed man wearing a ski mask and smoking a cigarette. "<i>Don\'t you know ze mountains are dangereuse,</i>" the man says with a thick accent. "<i>You will get FUCKED up here if you are not careful.</i>"<br><br>');
                GUI.outputText('You thank the man and his team, but they brush off your gratitude. "<i>Non, non!</i>" the man with the accent says. "<i>As zey say, everyone gets ONE.</i>" With that, he touches the watch on his wrist and disappears. The rest of the group continues on their way.<br><br>');
                GUI.outputText('As they leave, the giant with the chain gun yells in a horribly accented manner, "<i>YOU LEAVE SANDVICH ALONE! SANDVICH IS MINE!</i>"<br><br>');
                GUI.outputText("With that, another hail of bullets break the scene as they walk away, leaving you safe from the minotaur, but utterly baffled as to what in hell just happened.");
            }
            else {
                GUI.outputText("Crossing over the treacherous mountain paths, you walk past an ominous cave. The bones and the smell of death convince you to hasten your pace. However, as you walk by, you hear a deep bellow and a snort as a monstrous man with a bull's head steps out. With hell in his eyes and a giant ax in his hand, he begins to approach you in clear rage. As he comes out into the light, you see that he is completely naked and sports a monstrous erection as angry as the minotaur himself, freely leaking a steady stream of pre-cum as he stalks you.<br><br>");
                GUI.outputText("You stumble in your attempt to escape and realize that you are completely helpless. The minotaur towers over you and heaves his ax for a <i>coup de grace</i>. As he readies the blow, another beast-man slams into him from the side. The two of them begin to fight for the honor of raping you, giving you the opening you need to escape. You quietly sneak away while they fight - perhaps you should avoid the mountains for now?<br><br>");
            }
        ...
        if (liveData.gameFlags[FLAG.MINOTAUR_AND_COWGIRL] == 0 || UTIL.rand(10) == 0) {
            if (liveData.gameFlags[FLAG.HAS_SEEN_MINO_AND_COWGIRL] == 1 && liveData.player.cowScore() >= 4 && liveData.player.lactationQ() >= 200 && liveData.player.biggestTitSize() >= 3 && liveData.player.minotaurAddicted()) {
                //PC must be a cowmorph (horns, legs, ears, tail, lactating, breasts at least C-cup)
                //Must be addicted to minocum
                GUI.outputText("As you pass a shadowy cleft in the mountainside, you hear the now-familiar call of a cowgirl echoing from within. Knowing what's in store, you carefully inch closer and peek around the corner.<br><br>");
                GUI.outputText("Two humanoid shapes come into view, both with pronounced bovine features - tails, horns and hooves instead of feet. Their genders are immediately apparent due to their stark nudity. The first is the epitome of primal femininity, with a pair of massive, udder-like breasts and wide child-bearing hips. The other is the pinnacle of masculinity, with a broad, muscular chest, a huge horse-like penis and a heavy set of balls more appropriate on a breeding stud than a person. You have once again stumbled upon a cow-girl engaging in a not-so-secret rendezvous with her minotaur lover.<br><br>");
                ...
                GUI.outputText("<br><br>You settle in behind an outcropping, predicting what comes next. You see the stark silhouettes of imps and goblins take up similar positions around this makeshift theatre, this circular clearing surrounded on the edge by boulders and nooks where all manner of creatures might hide. You wonder if they're as eager for the upcoming show as you are. The heady scent of impending sex rises in the air... and with it comes something masculine, something that makes your stomach rumble in anticipation. The mouth-watering aroma of fresh minotaur cum wafts up to your nose, making your whole body quiver in need. Your [vagOrAss] immediately ");
                if (liveData.player.hasVagina())
                    GUI.outputText("dampens");
                else
                    GUI.outputText("twinges");
                GUI.outputText(", aching to be filled");
                if (liveData.player.hasCock())
                    GUI.outputText(", while [eachCock] rises to attention, straining at your [armor]");
                GUI.outputText(".");
                GUI.outputText("<br><br>You can barely see it from your vantage point, but you can imagine it: the semi-transparent pre-cum dribbling from the minotaur's cumslit, oozing down onto your tongue. Your entire body shivers at the thought, whether from disgust or desire you aren't sure. You imagine your lips wrapping around that large equine cock, milking it for all of its delicious cum. Your body burns hot like the noonday sun at the thought, hot with need, with envy at the cow-girl, but most of all with arousal.");
                GUI.outputText("<br><br>Snapping out of your imaginative reverie, you turn your attention back to the show. You wonder if you could make your way over there and join them, or if you should simply remain here and watch, as you have in the past.");
                GUI.menu();
                //[Join] [Watch]
                GUI.addButton(0, "Join", this.joinBeingAMinoCumSlut);
                GUI.addButton(1, "Watch", this.watchAMinoCumSlut);
                return;
            }
            liveData.gameFlags[FLAG.HAS_SEEN_MINO_AND_COWGIRL] = 1;
            liveData.gameFlags[FLAG.MINOTAUR_AND_COWGIRL]++;
            GUI.outputText("As you pass a shadowy cleft in the mountainside, you hear the sounds of a cow coming out from it. Wondering how a cow got up here, but mindful of this land's dangers, you cautiously sneak closer and peek around the corner.<br><br>");
            GUI.outputText("What you see is not a cow, but two large human-shaped creatures with pronounced bovine features -- tails, horns, muzzles, and hooves instead of feet. They're still biped, however, and their genders are obvious due to their stark nudity. One has massive, udder-like breasts and wide hips, the other a gigantic, horse-like dong and a heavy set of balls more appropriate to a breeding stud than a person. You've stumbled upon a cow-girl and a minotaur.<br><br>");
            if (liveData.gameFlags[FLAG.CODEX_ENTRY_MINOTAURS] <= 0) {
                liveData.gameFlags[FLAG.CODEX_ENTRY_MINOTAURS] = 1;
                GUI.outputText("<b>New codex entry unlocked: Minotaurs!</b><br><br>");
            }
        ...
        GUI.outputText("Suddenly you're grabbed from behind, your arms held together by a single massive, furry hand. A heavy, snorting breath brushes the top of your head. You turn your neck to see a massive bull-man. His impressive dick presses ");
    ...
    static joinBeingAMinoCumSlut() {
        GUI.clearOutput();
        GUI.outputText("The prospect of getting a huge dose of that fresh minotaur cum is just too much to bear. Before you realize what's happening, you're moving out of your rocky hiding spot and making your way down to the two bovine creatures, stripping your [armor] as you go. By the time you reach the two figures, you're as naked as they are. You shiver softly, whether due to some chill in the air or desperate anticipation, you can't say.");
        GUI.outputText("<br><br>The cow-girl is bent over, her hands on a low ledge with the minotaurs hands on either side of her ample ass. She moans, more like a moo than a human groan, as the minotaur plunges into her quaking depths. As you step forward, suddenly unsure of yourself, both the bull and the cow turn their sharp gazes on to you. You feel very small");
        if (liveData.player.tallness <= 96)
            GUI.outputText(" despite your immense height");
        GUI.outputText(" as they look you up and down. The entire area goes silent, even the goblins and the imps that are no doubt watching seem to be holding their breath, wondering what will happen to you.");
        GUI.outputText("<br><br>The minotaur grunts, finally, as if he finds you acceptable, and turns back to the plush ass before him, plowing into it once more. The cow-girl, however, motions for you to move forward, and latches onto a [nipple] when you do. Her soft lips encircle your areola, while her tongue dances over the rapidly hardening flesh of your teat. Your breasts tingle with the slightest bit of suction, making you gasp as small droplets of milk escape your nipple and roll over the cow-girl's tongue. She sucks more and more, eagerly gulping down your refreshing lactic beverage.");
        GUI.outputText("<br><br>All the while the minotaur continues grunting, thrusting his massive member into the woman's hungry cunt. The two rock back and forth, pushing her face right into your breast before pulling back again. The cow-girl's legs tremble and you suddenly find her arm grasping your shoulder for support. Her other hand drifts down between your own naked legs, ");
        if (liveData.player.hasCock()) {
        ...
        if (liveData.player.bRows() > 1)
            GUI.outputText("uppermost ");
        GUI.outputText("breasts around his monolithic shaft. Your faces meet and her soft lips press against yours, each of you earnestly pressing your tongues into the other's mouths, swapping the juices you've collected over the past hour or so. The bull beneath you groans, awakening to the feeling of four breasts surrounding his love muscle.");
        GUI.outputText("<br><br>The two of your pump your breasts up and down, your lips barely leaving each other long enough to give his member the occasional kiss, lick or slurp. Up and down you go, and this time it's the minotaur's body that's wracked with bliss, writhing on the ground. Milk dribbles from your breasts, coating you, the cow-girl and the minotaur in a fine white sheen and creating a sweet-smelling aroma that permeates the air.");
        GUI.outputText("<br><br>The bull groans, biting his lip as a third, and likely final, orgasm rips through him. His hips buck upwards, his cock flaring up and out of your mammaries. Ropes of immaculate silver seed jet from his cumslit, arcing up into the air several feet before splattering down on your heads. Wasting no time, you slip your lips around the flare, gulping down mouthful after mouthful of the sweet man-milk. Even though it's his third load of the hour, it's just as big as the others, and soon your find you can't swallow any more; your cum-laden belly just won't allow it.");
        GUI.outputText("<br><br>Sadly, you relinquish your hold on his cock and sit back, watching the cow-girl opposite you pick up where you left off, slurping up whatever you missed with a dedicated fervor.");
        GUI.outputText("<br><br><b>Now</b> you feel satisfied. Filled with that precious, precious minotaur spunk in both ends, fresh from the source. You slump onto your back and drift off into a hazy, bull-filled dream world.");
        GUI.outputText("...");
        GUI.outputText('<br><br>You awaken several hours later. The minotaur and the cow-girl are nowhere to be seen, but your [armor] is left neatly folded next to you, along with a small bottle filled with some white liquid, most likely a gift from your "bull".');
        GUI.outputText("<br><br>You quickly re-dress and head back to camp, spying the occassional goblin or imp scurrying from its hiding spot, no doubt recovering from their own self-inflicted orgasms.");
        liveData.player.orgasm();
        liveData.player.modStats(["lib", 0.5], ["sen", -3], ["cor", 1]);
        if (liveData.gameFlags[FLAG.PC_FETISH] > 0) {
            GUI.outputText(" A thrill runs through you. Even though you were brought to such a satisfying climax, the whole thought that goblins and imps were watching you and getting off on it... it just makes you hornier than you were before.");
    ...
    static watchAMinoCumSlut() {
        GUI.clearOutput();
        GUI.outputText("Deciding not to risk it, you settle back into your nook in the rocks and watch on eagerly. The cow-girl turns and places her hands on a low ledge, causing her to bend over, her ample ass facing the minotaur. The minotaur closes the distance between them in a single step.<br><br>");
        GUI.outputText("She bellows, almost moaning, as the minotaur grabs her cushiony ass-cheeks with both massive hands. Her tail raises to expose a glistening wet snatch, its lips already parted with desire. She moos again as his rapidly hardening bull-cock brushes her crotch. You can't tear your eyes away as he positions himself, his flaring, mushroom-like cock-head eliciting another moan as it pushes against her nether lips.<br><br>");
        GUI.outputText("With a hearty thrust, the minotaur plunges into the cow-girl's eager fuck-hole, burying himself past one -- two of his oversized cock's three ridge rings. She screams in half pain, half ecstasy and pushes back, hungry for his full length. After pulling back only slightly, he pushes deeper, driving every inch of his gigantic dick into his willing partner who writhes in pleasure, impaled exactly as she wanted.<br><br>");
        ...
        // GUI.doNext(0, "Next", this.continueMinoVoyeurism)
        GUI.addButton(0, "Next", this.continueMinoVoyeurism);
    }
    static continueMinoVoyeurism() {
        GUI.clearOutput();
        GUI.outputText("They go at it for nearly an hour, oblivious to you watching them, before their intensity heightens as they near orgasm. The results are almost explosive, both of them crying out as they begin twitching uncontrollably. Clinging desperately to the cow-girl's ass, the minotaur pumps so much cum into her depths that it begins spurting out. This accidental lubrication releases his grip and the pair collapse to the ground. Yet the minotaur isn't finished, his man-milk spraying into the air almost like his still-erect dick is a hose and splattering down onto both of them.<br><br>");
        GUI.outputText("As you look at the two cum-covered creatures laying their in their exhausted sex-induced stupors, the minotaur's thick horse-cock now slowly deflating, you realize that you've been touching yourself. You make yourself stop ");
        if (liveData.player.cor < 33)
            GUI.outputText("in disgust.");
        else if (liveData.player.cor < 66)
            GUI.outputText("in confusion.");
        else
            GUI.outputText("reluctantly.");
        GUI.outputText("<br><br>Only now do you notice other faces peeking over ledges and ridges. You count at least two goblins and one imp who quickly pull back. From the sounds, they were busy getting themselves off.");
        if (liveData.gameFlags[FLAG.MINOTAUR_AND_COWGIRL] == 0)
            GUI.outputText(" Apparently this isn't an uncommon show, and the locals enjoy it immensely. ");
        //Lust!
    ...
    static minoAddictionFuck() {
        ...
        GUI.doNext(this.getRapedByMinotaur);
    }
    //------------
    // WIN/LOSS SCENES
    //------------
    ...
    static minotaurWin() {
        ...
        */
        this.minoVictoryRapeChoices();
    }
    static minoVictoryRapeChoices() {
        //spriteSelect(44);
        ...
        if (liveData.player.lust >= 33) {
            ...
            if (liveData.player.hasCock() && x >= 0)
                GUI.addButton(0, "Use Cock", this.bumRapeaMinotaur);
            // Checking for vaginal fuck
            if (liveData.player.hasVagina())
                GUI.addButton(1, "Use Vagina", this.girlRapeAMinotaur);
            // Checking for herm scene. Centaurs can't do the herm scene
            if (liveData.player.gender == 3 && x >= 0 && !liveData.player.isTaur())
                GUI.addButton(2, "Use Both", this.minotaurGetsRapedByHerms);
            // Checking for tentacle fuck
            if (x >= 0 && liveData.player.cockTotal() > 1 && liveData.player.countCocksOfType(ENUM.CockType.TENTACLE) > 0)
                GUI.addButton(3, "TentacleDick", this.rapeMinotaurTentacles);
            ...
            if (liveData.player.hasCock()) {
                ...
                while (counter < liveData.player.cockTotal()) {
                    if (liveData.player.cocks[counter].cockThickness <= 4 && liveData.player.cocks[counter].cockLength >= 14) {
                        GUI.addButton(4, "UrethraFuck", this.minoUrethralPen);
                    }
                    counter++;
                }
            }
            ...
            if (liveData.player.hasCock()) {
                if (liveData.player.cockThatFits(80) >= 0)
                    GUI.addButton(7, "MakeHimSuck", this.minotaurBlowjob);
            }
        }
        // Non lusty options
        // Are you an addict?
        if (liveData.gameFlags[FLAG.MINOTAUR_CUM_ADDICTION_STATE] >= 1 || liveData.gameFlags[FLAG.MINOTAUR_CUM_ADDICT] > 0) {
            GUI.addButton(5, "Get Filled", this.takeMinoCumDirectly);
            if (liveData.player.biggestTitSize() >= 5 && !liveData.player.isNaga()) {
                GUI.addButton(6, "Titfuck Him", this.minoGetsTitFucked);
            }
            else if (liveData.player.isNaga()) {
                GUI.addButton(6, "ProstateMilk", this.minoGetsTitFucked);
            }
        }
        // Are you a feeder?
        if (liveData.player.findPerk(PerkLib.Feeder) >= 0)
            GUI.addButton(8, "Breastfeed", this.minotaurDrinksMilkNewsAtEleven);
        ...
        if (liveData.player.canOvipositSpider() || (liveData.player.canOvipositBee() && liveData.player.gender > 0)) {
            GUI.addButton(9, "Lay Eggs", this.layEggsInAMinotaurSpiderLike);
        }
        ...
        if (x < 0 && liveData.player.hasCock())
            GUI.outputText("<br>Sadly, you're too well endowed to penetrate the minotaur.");
    ...
    static minoRapeIntro() {
        //spriteSelect(44);
        GUI.clearOutput();
        //Monster got ass whupped
        if (liveData.monster.HP <= 0) {
            GUI.outputText("You roll the barely conscious beast over, lifting his ass up above his knees.  The loincloth flops open, giving you a perfect view of his hardening member.  In most ways it looks like a horse's dick, though it seems to be textured with multiple rings of prepuce along its length.  The scent boiling off that marvelously thickening endowment is pleasant yet musky, and overpoweringly strong.");
            //Vagina or not flavor texts
            if (liveData.player.vaginas.length > 0)
                GUI.outputText("  Glancing back at you with hope in his eyes, the minotaur's " + liveData.monster.cockDescriptShort(0) + " twitches as he lays his gaze upon your " + liveData.player.vaginaDescript(0) + ".");
            else
                GUI.outputText("  Glancing back at you with eyes full of despair, the minotaur seems to realize you won't be helping the predicament his " + liveData.monster.ballsDescriptLight() + " are in.");
        }
        //Monster lost to lust
        else {
            GUI.outputText("You rip off the minotaur's loincloth with a savage grin, slapping his ass and admiring the jiggle of his " +
            ...
            if (liveData.player.totalNipples() > 1)
                GUI.outputText(" and nipples");
            GUI.outputText(".");
            //Vagina or not flavor texts
            if (liveData.player.vaginas.length > 0)
                GUI.outputText("  Glancing back at you with hope in its eyes, the minotaur's " + liveData.monster.cockDescriptShort(0) + " twitches as he lays his gaze upon your " + liveData.player.vaginaDescript(0) + ".");
            else
                GUI.outputText("  Glancing back at you with eyes full of despair, the minotaur doubts you'll help relieve the predicament his " + liveData.monster.ballsDescriptLight() + " are in.");
        }
    }
    //Male Rape
    static bumRapeaMinotaur() {
        //spriteSelect(44);
        var x = liveData.player.cockThatFits(liveData.monster.analCapacity());
        this.minoRapeIntro();
        ...
        //Regular or multi...
        if (liveData.player.cockTotal() == 1)
            GUI.outputText(liveData.player.cockDescript(x));
        else
        ...
        if (liveData.player.cumQ() < 25)
            GUI.outputText("dribbling a bit of slick pre-cum into his fur.  ");
        if (liveData.player.cumQ() >= 25 && liveData.player.cumQ() < 250)
            GUI.outputText("leaking thin ropes of pre-cum over his muscular ass.  ");
        ...
        if (liveData.player.cumQ() > 500) {
            ...
            GUI.outputText("hosing him down with the constant flow of pre-cum produced by your over-sexed maleness.  Thick runners of the stuff coat his asshole, some dripping down his thighs, and the rest slicking the tumescent monster between his legs.  ");
        }
        //Unfinished minotaur cum addiction hook goes here?
        GUI.outputText("You gently squeeze his swollen balls as you align yourself with his pucker, breathing deeply as his musk intensifies, feeling dizzy and giddy.");
        //New paragraph for penetration.
        GUI.outputText("<br><br>");
        GUI.outputText("With little warning, you push inside, amazed to feel his sphincter relax completely.  Pushing forward with ease, you slide all " +
        ...
        GUI.outputText("At last you feel the pressure of your climax approaching, spurring you on to jackhammer the mino's poor abused tail-hole even more brutally. ");
        if (liveData.player.cumQ() <= 25) {
            GUI.outputText("With long deep strokes you bury your " +
                liveData.player.cockDescript(x) +
    ...
    //Female Rape
    static girlRapeAMinotaur() {
        //spriteSelect(44);
        this.minoRapeIntro();
        liveData.player.slimeFeed();
        liveData.player.minoCumAddiction(5);
        GUI.outputText("<br><br>With a quick shove, you roll the panting minotaur onto his back, exposing his pulsing " +
        ...
        if (liveData.player.vaginalCapacity() < liveData.monster.cockArea(0)) {
            GUI.outputText("Restraint evaporates as you lower yourself, your aching " +
                liveData.player.vaginaDescript(0) +
        ...
        if (liveData.player.isTaur())
            GUI.outputText("hindquarters, forcefully grinding your vagina along his length like a toy.  ");
        else
            GUI.outputText(liveData.player.hipDescript() + ", forcefully grinding up and down along his length like a cheap sex-toy.  ");
        //Size variants
        //Too small
        if (liveData.player.vaginalCapacity() < liveData.monster.cockArea(0))
            GUI.outputText("Every ridge of his " + liveData.monster.cockDescriptShort(0) + " presses tightly against your walls, smearing more of his wondrous pre-seed into your body with every stroke.  ");
        //Just right
        ...
        //ITS OVER
        GUI.outputText("He passes out with a contented sigh, balls shrunk down to the size of baseballs and his cock still dribbling cum.  You pull yourself to your feet unsteadily, drunk with pleasure as you stagger away, clamping your " +
            liveData.player.vaginaDescript(0) +
            " down unconsciously to hold in his wonderful seed.");
        if (liveData.player.vaginalCapacity() < liveData.monster.cockArea(0))
            GUI.outputText("<br><br>Mixed with the sheer sexual pleasure, you feel a diffuse pain and numbness coming from your much-abused " +
                liveData.player.vaginaDescript(0) +
    ...
    //Herm Rape
    static minotaurGetsRapedByHerms() {
        //spriteSelect(44);
        this.minoRapeIntro();
        liveData.player.minoCumAddiction(5);
        liveData.player.slimeFeed();
        GUI.outputText("<br><br>With little care for the beast's feelings, you grip his cock with both hands, pulling it towards yourself, bending it up at an awkward angle that makes him give a trembling moo of pain.   You edge closer, your own " +
        ...
        GUI.outputText("With a twisted grin and a grunt of pain, you push forward, slipping his " +
            liveData.monster.cockDescriptShort(0) +
            " into your " +
            liveData.player.vaginaDescript(0) +
            " as your " +
        ...
        if (liveData.player.vaginas[0].vaginalLooseness < ENUM.VaginalLoosenessType.VAGINA_LOOSENESS_GAPING)
            GUI.outputText("A small suppressed part of your mind dimly registers that this should be fairly painful, but the lust and drug-like pre-cum wash that thought away with waves of pleasure.  ");
        if (liveData.player.vaginas[0].vaginalLooseness >= ENUM.VaginalLoosenessType.VAGINA_LOOSENESS_GAPING)
            GUI.outputText("The intense feelings seem to grow more and more powerful as he stays inside you, his drug-like pre-cum making your " + liveData.player.vaginaDescript(0) + " tingle from the inside-out.");
        GUI.outputText("Your " +
            liveData.player.cockDescript(0) +
    ...
    static rapeMinotaurTentacles() {
        ...
        if (liveData.monster.HP <= 0)
            ...
            if (liveData.monster.weapon.equipmentName == "axe")
                GUI.outputText(", letting his axe clatter to the floor");
        ...
        GUI.outputText("You grab his arm firmly, making certain there will be no retaliation during the pleasure. By the look on his face, and the state of his torn, rolled up loincloth, though, you doubt that will be a problem.  ");
        if (liveData.player.cor < 25)
            GUI.outputText("You cry, petting his hair, smoothing it across his horns, justifying to yourself that you are raping this beast because this is how this world works as you maneuver your " +
        ...
        if (liveData.player.cockTotal() != liveData.player.countCocksOfType(ENUM.CockType.TENTACLE)) {
            ...
            GUI.outputText("Your " + liveData.player.cockDescript(temp2) + " slams into his tailhole, spreading it wider as you thrust in and out of the opening, relishing in the feeling of the rough, yet lubricated insides of the minotaur.  ");
        }
        //Not mismatched
        else {
            temp2 = 0;
            GUI.outputText("One of your prehensile dicks coils in on itself as it nears the minotaur's tailhole, readying itself. It then suddenly springs itself into his fleshy orifice, wiggling and writhing in deeper and deeper until all " +
        ...
        if (liveData.player.vaginas.length > 1 && !mismatched && liveData.player.cocks.length > 2)
            GUI.outputText("Your tentacle cocks writhe upon themselves, each turning to an unattended " +
    ...
    static rapeMinotaurTentacle() {
        ...
        GUI.clearOutput();
        GUI.outputText("You stand before the defeated minotaur and your tentacle dick begins to lash back and forth quickly, showing your excitement.  You see the hardness of his dick, and decide to do something about it... for both of you.  ");
        GUI.outputText("You come up behind him and wrap your tentacle dick around his huge member, squeezing him tightly at his dick's base pump even more blood to it.  Then you wrap yourself around his massive erection a few more times and you're ready. You jerk him up and down, varying the pace, place, and strength of your grip, milking his dick for all he is worth.  ");
        GUI.outputText("The minotaur's balls begin to spasm, so you wrap the base of your tentacle around him tightly, preventing his " +
            liveData.monster.cockDescriptShort(0) +
        ...
        if (liveData.player.countCocksOfType(ENUM.CockType.HORSE) == 1) {
            GUI.outputText("But it isn't enough for you. You take your pony prick, and with your hands, pull his anus wide. The flare at your tip takes some effort to get in, but once it's inside, you ram right to the hilt, knocking the wind from the minotaur with a solid grunt.  ");
            temp = 1;
        }
        //if multi with dogdick
        if (liveData.player.dogCocks() == 1 && temp != 1) {
            temp = 1;
            GUI.outputText("But it isn't enough for you. You take your bitch knotter, and with your hands, pull his anus wide. You slide in easily, right up to your knot, but he's too tight for you to slip that in.  ");
        }
        ...
        if (liveData.player.cocks.length > 2 && temp != 1) {
            temp = 1;
            GUI.outputText("It's not enough! Your other dicks demand attention too! Fortunately, he has a large hole for you to abuse... you stuff as many of your " +
                liveData.player.multiCockDescript() +
                " as you can, the rest hanging underneath him, slapping against his sack. ");
        }
        if (liveData.player.clitLength > 6) {
            GUI.outputText("Eager for more stimulation, you muse that your clit's big enough to fuck with, so why not!? You take your fingers, spit on them, and slide them into place, opening him up wider to accept your " +
        ...
        if (liveData.player.vaginas.length > 0) {
            temp = 2;
            GUI.outputText("You're a woman, and it's about time you got some pussy action too!  You slide your " +
                liveData.player.vaginaDescript(0) +
                " onto " +
                liveData.player.cockDescript(x) +
            ...
            GUI.outputText("Eventually, the moment is right.  You smile as you feel a boiling heat building in your groin, surging through your " +
                liveData.player.multiCockDescript() +
            ...
            if (liveData.player.cumQ() < 50)
                GUI.outputText("Your cock made quite a mess of things, and when you pull him out, your " + liveData.player.vaginaDescript(0) + " makes a wet sucking sound.  ");
            if (liveData.player.cumQ() >= 50 && liveData.player.cumQ() < 400)
                GUI.outputText("Your cock made quite a mess of things inside your " +
                    liveData.player.vaginaDescript(0) +
        ...
        //Free ass!
            ...
            temp = 2;
            GUI.outputText("You're feeling a little kinky so you step in front of him, offering him a little bit more, pushing yourself down onto his meaty dick.  You slowly push down, enjoying every inch as it travels down your " +
    ...
    static minoUrethralPen() {
        ...
        if (liveData.gameFlags[FLAG.INFESTED] == 5) {
            ...
            GUI.outputText("Grinning maliciously, you shove the minotaur onto his back, his massive equine dong slapping him in the chest as he lands with a grunt. Fondling your " +
                liveData.player.cockDescript(x) +
            ...
            GUI.outputText("The minotaur writhes and moans, openly panicking but too weak to resist, as you saw your " +
                liveData.player.cockDescript(x) +
            ...
            //(maximum/enhanced cum production finish):
                ...
                GUI.outputText("You walk over and pull him up against the wall, not wanting your sex beast to drown in his own jizz in his exhausted slumber. Chuckling slightly, you leave him and walk to the mouth of the cave, before a sudden noise from down the mountain catches your attention. The entire slope of the mountain below the minotaur's cave is glazed white with wormy cum, and you can't help the hysterical laughter that bellows from your lungs as you look down to see a couple of imps and a hellhound struggling fruitlessly against the newly released colony of worms, their dicks and balls bulging and swelling as the multitudes of parasites force their way into them. As you walk back to camp, you hear their terrified squeals turn into ecstatic howls and glance over your shoulder, seeing geysers of thick cum shoot into the air far behind you. You smile and pat your infested nuts, proud of the work of your vile symbiotic pets and resolving to let them loose on some unsuspecting prey again sometime...");
            }
        }
        else {
            //--MINOTAUR URETHRAL PENETRATION--
            //(If your cock is 4 inches or less in width, but 2 or more feet long)
            GUI.outputText("Overcome with lust and fatigue, the minotaur falls to the ground as you unhurriedly remove your " +
                liveData.player.armorName +
            ...
            GUI.outputText("With a hand covered in pre-cum, you roughly grab his fat prick and you smear it onto his flared cockhead, feeling it throb in your hand from the sensation. You press the head of your " +
                liveData.player.cockDescript(x) +
    ...
    static minotaurBlowjob() {
        ...
        if (!liveData.player.isTaur())
            GUI.outputText("taking the bull by the horns");
        else
            GUI.outputText("pinning his horns in the crook of your forelegs");
        GUI.outputText(', you guide its mouth closer to your member as if on autopilot.  "<i>Let\'s see just how good you are at milking,</i>" you blurt; the minotaur moos in defiance but is soon silenced when the head of your ' +
            Appearance.cockNoun(liveData.player.cocks[x].cockType) +
            " presses into its bovine mouth.<br><br>");
        GUI.outputText("You grimace at the awkward feeling of the beast's snout against you, but soon regain confidence in your choice as the monster begins to take your prick into his mouth.  His eyes grow wide as his lips wrap around you, with ");
        if (liveData.monster.lust >= liveData.monster.maxLust())
            GUI.outputText("his own burning lusts");
        else if (liveData.player.findPerk(PerkLib.ArousingAura) >= 0)
            GUI.outputText("the power of your corruption");
        else
            GUI.outputText("the salty taste of your pre-cum");
        GUI.outputText(" leaving him hungry for more.<br><br>");
        GUI.outputText("At this realization he attempts to pull away, to save himself from the ordeal, but in his debilitated state his efforts are as weak as a kitten's. Held firmly by the horns, the bull-man slowly succumbs.  Unable to control himself in his lust, he licks at the cock within his mouth wildly, his thick cow-like tongue roughly wrapping around your length as you move yourself further within his sucking mouth.  From the combined effects of the creature's musk and maw you start to lose yourself as well, ");
        if (!liveData.player.isTaur())
            GUI.outputText("finding your hands leaving his horns for the back of his head ");
        GUI.outputText("as your hips begin to thrust into his face.  In your daze you glance down, to see the minotaur roughly and futilely stroking his shaft, his eyes full of shame and desperation - full of wanting to not only release his pent-up arousal, but to taste your thick cum as well.<br><br>");
        GUI.outputText("You soon oblige the bull; your effort to fuck his face and the rapid bobbing of his head along your member quickly pass what little restraint you care to exercise on the monster's behalf.  Slamming the muzzle into your groin and leaning over his back, you begin layering the minotaur's tongue and tonsils with bursts of your seed.  Reaching down with ");
        if (!liveData.player.isTaur())
            GUI.outputText("your hand");
        else
            GUI.outputText("a forehoof");
        GUI.outputText(", you quickly put a stop to his unimportant attempts to pleasure himself by knocking his hand from his meaty cock.  The bull moos over your prick in response, leaving you to shudder while he swallows every last drop of your cum.  You are unable to tell if the beast is blushing from arousal or being reminded of his submission, but it does not matter.<br><br>");
        GUI.outputText("Pulling yourself free from the thing's mouth, you let the abused creature fall flat onto its chest and then gather your armor to leave.  Once, you turn back, only to catch sight of the minotaur lost with himself, desperatly trying to fuck the ground beneath him and mooing in overstimulated agony from the experience.");
        COMBAT.cleanupAfterCombat();
        liveData.player.orgasm();
    }
    //Steal Minotaur Cum
    static takeMinoCumDirectly() {
        //spriteSelect(44);
        GUI.clearOutput();
        ...
        if (liveData.monster.HP < 1)
            ...
            GUI.outputText("The beast-man is on his back with his legs splayed, masturbating hopelessly.  His anguished moans tell you all you need to know - he'll never get off alone.");
        GUI.outputText("  You smile, blushing in anticipation, readying yourself for the coming bliss.<br><br>");
        GUI.outputText("You shed your " +
            liveData.player.armorName +
        ...
        if (liveData.player.analCapacity() < liveData.monster.cockArea(0)) {
            GUI.outputText("You have to push harder and harder to get it inside you, even with the copious lube's drug-like affects relaxing your sphincter.  The penetration is slow, but inch by inch you force it inside you.");
        }
        else {
        ...
        if (!liveData.player.buttChange(liveData.monster.cockArea(0), true))
            GUI.outputText("  ");
        GUI.outputText("The minotaur's eyes open wide as he lets out a lustful '<i>Moooooo</i>'.  He doesn't struggle or even move - you're giving him exactly what he wants, after all.<br><br>");
        GUI.outputText("You bottom out, sighing happily as you feel his hot fluids leaking inside you, radiating pure pleasure out from your core.   Bestial hands grab your " +
        ...
        if (liveData.player.sens < 80)
            liveData.player.dynStats(["sen", 1]);
        if (liveData.player.sens < 60)
            liveData.player.dynStats(["sen", 1]);
        if (liveData.player.sens < 40)
            liveData.player.dynStats(["sen", 1]);
        if (liveData.player.sens < 20)
            liveData.player.dynStats(["sen", 1]);
        //+15 addiction
    ...
    static minoGetsTitFucked() {
        ...
        if (liveData.monster.HP < 1)
            GUI.outputText("defeated.  ");
        else
            GUI.outputText("masturbating uncontrollably.  ");
        GUI.outputText("He's yours for the moment, and for right now, you want to see if that throbbing horse-cock will splatter its heavenly spunk all over your " +
        ...
        if (liveData.monster.lust >= liveData.monster.maxLust())
            GUI.outputText("You push his hands away and y");
        else
            GUI.outputText("Y");
        GUI.outputText("ou lean over him, feeling your generous breast-flesh jiggle, your " +
            liveData.player.nippleDescript(0) +
        ...
        if (liveData.player.totalCocks() > 0)
            ...
            GUI.outputText("  Your body aches with arousal while your ");
        if (liveData.player.hasVagina())
            GUI.outputText(liveData.player.vaginaDescript(0) + " grows hotter and hotter, begging to be taken.");
        else
            GUI.outputText(liveData.player.assholeDescript() + " puckers slightly, as if begging to be taken by another monstrous beast.");
        GUI.outputText("<br><br>");
        ...
        if (liveData.player.hasVagina())
            ...
            GUI.outputText("ass.  ");
        GUI.outputText("Out to prove him wrong by letting him release all over your face, you wrap your " +
            liveData.player.allBreastsDescript() +
        ...
        GUI.outputText('The minotaur\'s balls clench tightly as the bull-man throws his head back and screams out in pleasure and relief, "<i>MooooOOOOOOooooOOOOO!</i>"<br><br>');
        GUI.outputText("You squeeze tightly and press down, watching his dick-head flare out, nearly doubling size before it unloads, drenching your face and hair with his thick narcotic cream.   You manage to get your lips against it in time for the next blast, and nearly drown when it overfills your mouth.  You pull back, coughing, starting to get high, and swaying woozily as more and more cream spatters your body, continuing to be squeezed out by your slick heaving breasts.<br><br>");
        GUI.outputText("The bull-man relaxes at last, drenching you with one last wave before he passes out.  You stagger up and nearly trip over your legs, giggling and drunk on cow-spunk as you noisily slurp down the fluids drenching your face and hair.  You black out for a while...<br><br>");
        GUI.outputText("You wake up an hour later, unsure how you made it back to your camp, light-headed and euphoric with the lingering after-affects.  You also find a bottle on the ground next to you, filled to the brim with the fluid.  You don't remember filling it up, but you're already itching to pop it open and guzzle it down.  You manage to resist the urge.  Besides, you're still feeling GREAT from your last 'sample'.");
        liveData.player.minoCumAddiction(10);
    ...
    static AddictNagaOnMinotaur() {
        //spriteSelect(44);
        GUI.clearOutput();
        //[if (monster.lust >= 99)
        if (liveData.monster.lust >= liveData.monster.maxLust())
            GUI.outputText("You slither towards the fallen monster, wishing to taste his addictive semen.  He's currently engaged in stroking his enormous shaft up and down with both of his hands, but offers little resistance when you push him over to a sitting position.  You pull his hands away and replace them with yours, running your fingers up and down along his thickness, working yourself up with anticipation.  He leans back and exhales loudly, clearly appreciative.<br><br>");
        else
            GUI.outputText("You slither towards the fallen monster, wishing to taste his addictive semen.  You notice that, despite the beating you just gave him, his huge cock is fully erect.  Delighted, you gently run both of your hands up and down its long shaft.  He exhales loudly, signaling his appreciation.<br><br>");
        GUI.outputText("A bit of gooey pre-cum begins to gather at the tip of his thick, horse-like cock.  Your tongue flits out instinctively, and you taste its scent in the air.  It's too much for you to handle, and you are overcome with an absolute need to fill yourself with his nectar.  You throw yourself onto his crotch, grabbing his thighs and rubbing his cock along your torso as you position your mouth over his length, taking care to keep your long fangs out of the way.  You violently pull yourself to him, forcing more of him than you thought you could handle down your throat.  You feel his pre lubricating your insides, numbing you to the pain and allowing you to take him deeper.  You take one hand from his leg and place it on the still exposed bit of his shaft, stroking what you could not take in your mouth. His animal grunting grows louder as you take just a bit more of him with each thrust downwards.  Mad with lust, you remove your other hand from his thigh, balancing on your lengthy tail and his cock, and use it to ");
        //if (player.cocks.length > 0)
        if (liveData.player.hasCock())
            GUI.outputText("furiously stroke your own " + liveData.player.multiCockDescriptLight() + ". Your muffled vocalizations of pleaure weakly join his own.<br><br>");
        else
            GUI.outputText("part the folds of your " + liveData.player.vaginaDescript(0) + ", sliding it inside and masturbating with a furious vigor. Your muffled vocalizations of pleaure weakly join his own.<br><br>");
    ...
    //Mino Feeder Scene
    static minotaurDrinksMilkNewsAtEleven() {
        //spriteSelect(44);
        GUI.clearOutput();
        GUI.outputText("You kneel next to the exhausted minotaur, lifting his head up to your " +
        ...
        GUI.outputText("You pop your " + liveData.player.nippleDescript(0) + " from the dazed minotaur's mouth and leave him there to enjoy the afteraffects of his meal.");
    ...
    static layEggsInAMinotaurSpiderLike() {
        GUI.clearOutput();
        if (liveData.player.canOvipositBee()) {
            this.layBeeEggsInCowbutt();
            return;
        }
        GUI.outputText("The defeated minotaur turns and tries to flee.  You quickly fling a cord of sticky webbing that wraps around his massive horns, hauling him up short.  With a panicked moo, he begins to thrash his head, desperately trying to free himself.  You scurry forward and tackle the man-bull, forcing him onto his back.  Extruding more webbing, you wrap his wrists and bind them to his horns, then force his muscular legs upward, bending him almost double before lashing his legs to his horns as well.");
        GUI.outputText('<br><br>Now helpless and hog-tied, the minotaur gazes up at you with wide eyes.  His throbbing, flared cock indicates that not all of him finds the situation as objectionable as he wants you to believe.  Gathering up his musky pre with your fingertips, you hold them beneath his nose before forcing your fingers into his mouth.  "<i>Arrogant little cow,</i>" you growl throatily, "<i>I have a special gift for you.</i>"');
        GUI.outputText("<br><br>Gathering the silk binding his limbs with one hand, you position your ovipositor at ");
        if (!liveData.silly)
            GUI.outputText("his bovine rosebud.");
        else
            GUI.outputText("the entrance to his O.K. Corral.");
        GUI.outputText("  Grinning, you lift your abdomen high behind you, then snap it forward, forcing more than half of your long ovipositor deep into your beef-bitch.");
        if (liveData.player.gender > 0) {
            GUI.outputText("<br><br>");
            if (liveData.player.hasCock())
                GUI.outputText("Forcing [oneCock] between his bound thighs, you frot his flared bull-cock, your mixed pre soaking into the fur of his belly as you thrust against him.");
            if (liveData.player.hasVagina())
                GUI.outputText("Grasping his bull-cock, you pull it against your pussy, rubbing your juices up and down his impressive length as your lips and clit grind on him, adding to your pleasure.");
        }
        //(If male or herm:
        GUI.outputText("<br><br>");
        if (liveData.player.hasCock()) {
            ...
            if (liveData.player.cumQ() < 100)
                GUI.outputText("spattering");
            else if (liveData.player.cumQ() < 500)
                GUI.outputText("drenching");
            else
                GUI.outputText("nearly drowning");
            GUI.outputText(" your helpless prey.  ");
        }
        if (liveData.player.hasVagina())
            GUI.outputText("Your femcum sprays across his cock.  ");
        ...
        if (liveData.player.gender > 0)
            GUI.outputText("combination of the scent of your fluids and the ");
        GUI.outputText("sensation of eggs forcing their way past his sphincter proves too much for your bovine bitch to resist, and he helplessly sprays his musky cum, stream after stream jetting up his chest and across his face as his eyes roll back in his head.");
        //[(mino addict)
        if (liveData.gameFlags[FLAG.MINOTAUR_CUM_ADDICTION_STATE] >= 1) {
            GUI.outputText("  The smell is too much for you as well, and as you come a second time, you point his flare at your mouth, gulping as much of his seed as you can get.");
            liveData.player.minoCumAddiction(3);
        }
        if (liveData.player.cor < 50)
            GUI.outputText("<br><br>You carefully unwrap his limbs, then pull his snout around to force him to look at you.");
        else
            GUI.outputText("<br><br>Chuckling at the thought of the fun the other mountain denizens will have with your well-trussed side of beef, you grab his snout and force him to look you in the eyes.");
    ...
    static layBeeEggsInCowbutt() {
        GUI.clearOutput();
        GUI.outputText("Looking down at the defeated minotaur");
        if (liveData.monster.lust >= liveData.monster.maxLust())
            GUI.outputText(", stroking his flared cock desperately");
        GUI.outputText(" you feel a throbbing sensation in your apiary appendage.  A leering grin spreads across your face as you force the minotaur onto his stomach, trapping his musky manhood beneath him.");
        if (!liveData.player.isTaur())
            GUI.outputText("  Wrapping his tail around one hand, you lift his furred flanks up");
        else
            GUI.outputText("  Straddling him with all four legs, you slide forward");
        GUI.outputText(" while aiming your ovipositor.");
        GUI.outputText("<br><br>As your egg-phallus slides home, a confused moan escapes from the defeated man-bull.  For a moment, you are reminded of a lost calf calling for its mother.  ");
        if (liveData.player.cor < 50)
            GUI.outputText("You hesitate, feeling a surge of pity for the once-mighty creature, but your new instincts drive your egg-layer further into his prone body.  ");
        else
            GUI.outputText('Grinning cruelly, you grasp him by the horns and haul back with both hands until the minotaur is forced to look you in the eye.  You lean in close to his snout and buzz mockingly, "<i>Whoz the bitch now?  Iz it you?  Yezz, it izz!</i>"  ');
        ...
        if (liveData.player.hasCock()) {
            ...
            if (liveData.player.cumQ() < 250)
                GUI.outputText("backside with your cum");
            else if (liveData.player.cumQ() < 500)
                GUI.outputText("back with your cum, with ropes dripping slowly off his horns and down his face");
            else
                GUI.outputText("back with your cum, before it covers him and spreads across the floor of his cave.");
        }
        //(if female:
        ...
        GUI.outputText("<br><br>Finally, you feel powerful pulses moving through your bee-like abdomen as your eggs move down your ovipositor into their bovine incubator, each one feeling like a mini-climax of its own.  You're beginning to understand why the bee girls are so keen on laying eggs in you when you pass through the forest.  You could definitely get used to this.");
        //(If Silly mode:
        if (liveData.silly)
            GUI.outputText('<br><br>Looking down at the mass of bull-meat filled with eggs, you lean down and whisper into his ear, "<i>And that\'s how you make Scotch Eggs, cowboy.</i>"');
        liveData.player.dumpEggs();
        COMBAT.cleanupAfterCombat();
        liveData.player.orgasm();
    }
    ...
    static getRapedByMinotaur(autoRape = false) {
        //spriteSelect(44);
        liveData.player.slimeFeed();
        GUI.clearOutput();
        //BY BUTTS MCGEE
        ...
        if (!autoRape) {
            ...
            if (UTIL.rand(2) == 0 && liveData.player.buttRating >= 15 && liveData.player.vaginalCapacity() < liveData.monster.biggestCockArea() && liveData.player.tone < 60) {
        ...
        //Normal RAEP
        if (liveData.player.vaginas.length > 0) {
            GUI.outputText("The bull-man roughly grabs your hair and begins rubbing the flared head of his penis along your " + liveData.player.vaginaDescript(0) + ".  ");
            if (liveData.player.averageVaginalWetness() < 2)
                ...
                GUI.outputText("You're shamefully wet by this point, and your knees are ready to buckle.  ");
            liveData.player.minoCumAddiction(5);
        }
        //BUTTSECKS!
        else {
            GUI.outputText("The bull-man roughly grabs your hair and repositions himself to press against your asshole, slowly building the pressure until suddenly, the flared head pops into you.  ");
            liveData.player.buttChange(liveData.monster.cockArea(0), true);
            liveData.player.minoCumAddiction(15);
        }
        if (liveData.player.isTaur())
            GUI.outputText("<br><br>He positions himself behind your rear legs, and roughly impales you onto his shaft, forcing himself as far into you as he can manage. You cry out, and you feel your stomach distending to accommodate his incredible size. Grabbing your ass, he begins to violently pound your backside with his massive member.  ");
        else
            GUI.outputText("<br><br>He lifts you into the air, hefting your insignificant weight with little effort, and roughly impales you onto his shaft, forcing himself as far into you as he can manage. You cry out, and looking down you can see your stomach distending to accommodate his incredible size. Using you like a human cock-sleeve, he simply holds you by the torso and begins lifting you up and down.  ");
        //Vag stretch texts
        if (liveData.player.hasVagina())
            liveData.player.cuntChange(24 * 3, true, false, true);
        //Continue
        if (liveData.player.biggestTitSize() > 0 && liveData.player.mostBreastsPerRow() > 1 && liveData.player.breastRows.length > 0) {
            ...
            if (liveData.player.biggestLactation() > 1.5)
                GUI.outputText("He then gives a grunt in what you take to be approval as your milk begins to squirt out. He licks a milk-coated finger in satisfaction.  ");
        }
        if (liveData.player.cockTotal() == 1)
            GUI.outputText("The bull-man bends forward a little, and grabs your " + liveData.player.cockDescript(0) + " in a crushing grip. He makes short jerking motions as he keeps thrusting into you.");
        if (liveData.player.cockTotal() > 1)
            GUI.outputText("The bull-man bends forward a little, and grabs one of your " + liveData.player.cockDescript(0) + "s in a crushing grip. He makes short jerking motions as he keeps thrusting into you.");
        if (liveData.player.vaginas.length > 0) {
            if (liveData.player.vaginalCapacity() < liveData.monster.cockArea(0))
                GUI.outputText("<br><br>You clench your teeth in pain as his thick ribbed cock ravages your tight pussy. After a while, a kind of numbness sets in, and you start to feel dim waves of pleasure piercing through the curtain of pain. You hear grunts of pleasure and satisfaction coming from the beast's mouth.");
            if (liveData.player.vaginalCapacity() >= liveData.monster.cockArea(0) && liveData.player.vaginalCapacity() < liveData.monster.cockArea(0) * 1.5)
                GUI.outputText("<br><br>You feel his monstrous ribbed cock deliciously rubbing against your love-canal, sending maddening waves of pleasure to your brain as the beast keeps shoving into you. Oblivious to anything but your own enjoyment, you moan loudly like a whore, as the beast chuckles and grunts from his own pleasure.");
            if (liveData.player.vaginalCapacity() >= liveData.monster.cockArea(0) * 1.5)
                GUI.outputText("<br><br>You feel his monstrous cock sliding easily in and out of your wide fuck-hole, hearing the beast grunt in dissatisfaction. He suddenly clouts your left buttock, which makes you tense your muscles, including your vagina's, and you start to feel the ribs on his cock rubbing against your wall. The pleasure it procures you makes you tense your muscles harder, causing the pleasure to swell again. The minotaur grunts in approval, and continues his violent pounding as you start moaning.");
        }
        GUI.outputText("<br><br>Finally, you can feel he's ready to cum. His thrusts become shorter and faster, and just when you think you can't stand it anymore he starts shooting his sperm into you. Your stomach begins to round out from the sheer amount of bull seed being pumped into your belly.  ");
        liveData.player.dynStats(["lib", 1], ["sen", -0.5], ["cor", 1]);
        if (liveData.player.vaginas.length > 0) {
            if (liveData.player.averageVaginalWetness() >= 2) {
                if (liveData.player.averageVaginalWetness() < 4)
                    GUI.outputText("You squirm and quiver, orgasming from the beast's rough usage.  ");
                if (liveData.player.averageVaginalWetness() == 4)
                ...
                if (liveData.player.averageVaginalWetness() == 5)
                    GUI.outputText("You orgasm on his massive rod, splattering the beast with girlcum.  ");
        ...
        if (liveData.player.cockTotal() > 0 && liveData.player.sens + UTIL.rand(40) > 50) {
            ...
            if (liveData.player.cumQ() < 25)
                GUI.outputText("spurting your seed helplessly from the brutal rape.  ");
            if (liveData.player.cumQ() >= 25 && liveData.player.cumQ() < 250)
                GUI.outputText("squirting thick ropes of cum over the cave.  ");
            if (liveData.player.cumQ() >= 250 && liveData.player.cumQ() < 500)
                GUI.outputText("erupting potent ropes of seed in thick bursts, splattering the cave walls and floors.  ");
            if (liveData.player.cumQ() >= 500)
                GUI.outputText("erupting a thick torrent of seed that seems to go on forever, spurred by the constant pressure of the huge minotaur cock.  You paint the cave wall with cum, the beast egging you on as it roughly jacks your " +
                    liveData.player.cockDescript(0) +
        ...
        GUI.outputText("The bull-man relaxes for a moment, then shoves you off of him and to the cold ground. You pass out as a strange sense of euphoria washes over you while copious quantities of monstrous cum escape your distended ");
        if (liveData.player.hasVagina())
            GUI.outputText("pussy.");
        else
            GUI.outputText("asshole.");
    ...
    static getOralRapedByMinotaur() {
        //spriteSelect(44);
        GUI.clearOutput();
        GUI.outputText("The huge bull-man grabs you around the waist with one hand and flips you over. You hang upside down in his grip, your " +
        ...
        GUI.outputText("The minotaur traps your " +
            liveData.player.legs() +
        ...
        GUI.outputText("  All you can see is the minotaur's huge shaft, the tip grinding against your mouth. The minotaur slaps his cock-head against your face, rubbing his musk and pre-cum into your cheeks and hair.<br><br>");
        //new pg
        GUI.outputText("The minotaur reaches down and grabs your jaw, yanking it open. You know what's coming next but decide not to fight it. Submitting to this beast is the safest choice. You spread your jaws as wide as you can and bend your mouth towards the minotaur's monstrous cock-head...<br><br>");
        //new pg
        GUI.outputText("Wasting no time, the minotaur grinds his glans past your lips and tries to force the tip of his " +
            liveData.monster.cockDescriptShort(0) +
        ...
        //new pg
        GUI.outputText("You hear a <i>POP</i> and feel a sharp pain in your jaw as the minotaur forces its full cock-head into your mouth.  The head slides past your jaws and into your mouth, pinning your tongue down and jabbing against the opening of your throat. The flared end of the shaft wedges itself behind your teeth. The minotaur moans, a sound somewhere between a bull calling to its herd and a man groaning in ecstasy. You grab the bull-man's shaft in both hands and brace yourself, trying to pull your head away from the cave wall. The minotaur starts grinding its hips, and with one hand grabs your head and twists it from side to side, rubbing its huge tip around in your mouth.<br><br>");
        //new pg
        GUI.outputText("You arch your back off the wall, resting your weight on the minotaur's " + liveData.monster.cockDescriptShort(0) + ". Your chest and belly rub against the minotaur's massive torso");
        if (liveData.player.hasBreasts())
            GUI.outputText(", painfully grinding your " + liveData.player.nippleDescript(0) + " against his wiry fur");
        if (liveData.player.balls > 0)
            GUI.outputText(", and you can feel the minotaur's hot breath on your " + liveData.player.ballsDescriptLight());
        GUI.outputText(". The bull-man snorts and jerks his hips as you twist your hands around his shaft, hoping to make him cum sooner. You tickle your tongue against his cock-head and start sucking as hard as you can. You bend your neck as the minotaur grinds itself in your mouth, hoping to make the tip easier to take. The minotaur jerks his hips in short spasms and you can hear its grunts coming closer and closer together. You take a deep breath through your nose, filling your lungs with air before the beast floods your throat with its cum...<br><br>");
        //new pg
        GUI.outputText("With no warning the minotaur yanks your " +
            liveData.player.legs() +
        ...
        //new pg
        GUI.outputText("The minotaur bellows and slams its hips forward, forcing the ridge past your lips. You're almost out of air and the edges of your vision are starting to fade. All you can see is the minotaur's belly. Its " +
            liveData.monster.ballsDescriptLight() +
        ...
        //last pg
        GUI.outputText("The minotaur grunts a few last times.  Finished with you, it lifts your " +
            liveData.player.leg() +
