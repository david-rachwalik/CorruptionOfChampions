...
WormMass.wormEntice = function () {
    ...
    if (rand(2) == 0) {
        if (player.lust < 50)
            outputText("The worm colony stands before you and begins secreting a significant amount of slime. You are perplexed as to why the worms have done this. You shrug your shoulders and remain on guard.<br>", false);
        else
            outputText("The worm colony shambles over to you and attempts to grapple you. Quickly sidestepping the clumsy movements of the creature, you avoid what could have been a horrible fate as the mass falls over and splatters in its failed attempt to engulf you.<br>", false);
        return;
    }
    //SUCCESS
    if (player.lust < 50) {
...
WormsScene.infest1 = function () {
    ...
    if (gameFlags[EVER_INFESTED] == 0)
        gameFlags[EVER_INFESTED] = 1;
    cleanupAfterCombat();
};
//---------
// Worm Encounters
