...
GoblinScene.gobboGetsRapedMaleFits = function () {
    ...
    if (player.cockArea(x) > monster.vaginalCapacity() * .8) {
        ...
        else if (player.cocks[0].cockType == CockTypesEnum.HORSE || player.cocks[0].cockType > 3)
        ...
        if (player.cumQ() >= 500)
            outputText("  The orgasm is so potent that by the time you wind down, she looks to be sporting a pregnancy the size of a medicine ball.  Your cum is trapped inside her, unable to find any gap between her walls and your " + player.cockDescript(x) + ".");
