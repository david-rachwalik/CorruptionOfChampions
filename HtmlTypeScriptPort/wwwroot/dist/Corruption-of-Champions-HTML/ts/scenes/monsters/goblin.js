...
Goblin.goblinTeaseAttack = function () {
    ...
    if (monster.refName == "goblin" || monster.refName == "goblin assassin" || monster.refName == "Tamani") {
        if (det == 0)
            outputText(capitalize(monster.a) + monster.refName + ' runs her hands along her leather-clad body and blows you a kiss. "<i>Why not walk on the wild side?</i>" she asks.');
        if (det == 1)
            outputText(capitalize(monster.a) + monster.refName + " grabs her heel and lifts it to her head in an amazing display of flexibility.  She caresses her snatch and gives you a come hither look.");
        if (det == 2)
            outputText(capitalize(monster.a) + monster.refName + " bends over, putting on a show and jiggling her heart-shaped ass at you.  She looks over her shoulder and sucks on her finger, batting her eyelashes.");
    }
    else if (monster.refName == "goblin warrior") {
        if (det == 0)
            outputText(capitalize(monster.a) + monster.refName + ' runs her hands along her metal-clad body and blows you a kiss. "<i>Why not walk on the wild side?</i>" she asks.');
        if (det == 1)
            outputText(capitalize(monster.a) + monster.refName + " grabs her heel and lifts it to her head in an amazing display of flexibility despite the armor she's wearing.  She caresses her snatch and gives you a come hither look.");
        if (det == 2)
            outputText(capitalize(monster.a) + monster.refName + " bends over, putting on a show and jiggling her heart-shaped ass at you.  She looks over her shoulder and sucks on her finger, batting her eyelashes.");
    }
        ...
        if (det == 0)
            outputText(capitalize(monster.a) + monster.refName + ' runs her hands along her leather-clad body and blows you a kiss. "<i>Why not walk on the wild side?</i>" she asks.');
        if (det == 1)
            outputText(capitalize(monster.a) + monster.refName + " grabs her heel and lifts it to her head in an amazing display of flexibility.  She lifts her loincloth and caresses her snatch and gives you a come hither look.");
        if (det == 2)
            outputText(capitalize(monster.a) + monster.refName + " bends over, putting on a show and jiggling her heart-shaped ass at you.  She looks over her shoulder and sucks on her finger, batting her eyelashes.");
    }
    else if (monster.refName == "goblin elder") {
        if (det == 0)
            outputText(capitalize(monster.a) + monster.refName + ' runs her hands along her bone-clad body and blows you a kiss. "<i>Why not walk on the wild side?</i>" she asks.');
        if (det == 1)
            outputText(capitalize(monster.a) + monster.refName + " grabs her heel and lifts it to her head in an amazing display of flexibility.  She lifts her loincloth and caresses her snatch and gives you a come hither look.");
        if (det == 2)
            outputText(capitalize(monster.a) + monster.refName + " bends over, putting on a show and jiggling her heart-shaped ass at you.  She looks over her shoulder and sucks on her finger, batting her eyelashes.");
    ...
    if (monster.refName == "goblin assassin")
        lustDmg *= 1.4;
    if (monster.refName == "goblin warrior")
        lustDmg *= 1.6;
    if (monster.refName == "goblin shaman")
        lustDmg *= 1.6;
    if (monster.refName == "goblin elder")
        lustDmg *= 2;
...
Goblin.goblinDrugAttack = function () {
    ...
    if (monster.refName == "Tamani")
        temp2 = rand(5);
    if (monster.refName == "Tamani's daughters")
        temp2 = rand(5);
    // Set Color
    var color = "";
    if (temp2 == 0)
    ...
    if (color != "blue") {
        if (monster.refName == "Tamani's daughters")
            ...
            outputText(capitalize(monster.a) + monster.refName + " uncorks a glass bottle full of " + color + " fluid and swings her arm, flinging a wave of fluid at you.");
    }
    //Drink blue pots
        ...
        if (this.HPRatio() < 1) {
            ...
            outputText("  There doesn't seem to be any effect.<br>");
        outputText("<br>");
        return;
    }
    else {
    ...
    if ((player.findPerk(PerkLib.Evade) >= 0 && rand(10) <= 3) || rand(100) < player.spe / 5) {
        ...
        if (color == "red") {
            ...
            if (player.findStatusEffect(StatusEffects.TemporaryHeat) < 0)
...
GoblinScene.victoryAgainstGoblin = function () {
    ...
    if (player.lust >= 33 && player.gender > 0) {
        ...
        if (player.hasCock()) {
            ...
            if (player.cockArea(player.biggestCockIndex()) > monster.vaginalCapacity() && player.cor > 80) {
    ...
    if (player.canOvipositSpider() || player.findStatusEffect(StatusEffects.Feeder) >= 0) {
        // CHECK STATUS EFFECT
        outputText("<br><br><b>You aren't horny enough to rape her, but ");
        if (player.findStatusEffect(StatusEffects.Feeder) >= 0)
            outputText("your nipples ache with the desire to feed her your milk.  Do you feed her milk or leave?</b>");
        else
            outputText("your abdomen aches with the desire to impregnate her full of insect eggs.  Do you?</b>");
        if (player.findStatusEffect(StatusEffects.Feeder) >= 0) {
            //CHECK THIS STATUS EFFECT!
            addButton(5, "Breastfeed", GoblinScene.giveGoblinAMilkMustache, null, null, null, "TO BE ADDED");
        }
...
GoblinScene.gatsGoblinBoners = function () {
    ...
    if (player.cockTotal() == 1)
        ...
        outputText("them");
    outputText(" against the bare flesh of her ass, whilst your victim anxiously awaits your next move.  You take your time massaging the goblin's slutty ass with your bare hands before sliding your " +
    ...
    if (player.cockTotal() == 1)
        outputText("your dick inside of the panting whore, pushing her forwards violently as you enter her tight snatch");
    else if (player.cockTotal() == 2)
        outputText("both of your dicks inside of the panting whore, pushing her forwards violently as you enter her tight snatch and asshole");
    else {
    ...
    outputText("Eventually you begin to feel yourself coming to a climax, your movements getting faster and faster as you build up to your release.  The goblin below you has already lost herself to the pleasure of your " +
        player.cockDescript(x) +
    ...
    outputText("You pick yourself back up, jerking yourself slowly as cum dribbles from your " +
        player.cockDescript(x) +
...
GoblinScene.gobboGetsRapedMaleFits = function () {
    ...
    if (player.cockArea(x) > monster.vaginalCapacity() * 0.8) {
        outputText('You pick up the defeated goblin, looking her over. She crosses her arms across her chest pitifully and asks, "<i>What now?</i>" with her eyes darting down when she thinks you won\'t notice. A grimace temporarily crossing her face at the size of your ' +
            player.cockDescript(x) +
        ...
        if (player.cocks[0].cockType == ENUM.CockType.DEMON)
        ...
        else if (player.cocks[0].cockType == ENUM.CockType.HORSE || player.cocks[0].cockType > 3)
        ...
        outputText("It's all the encouragement you need, and you break into a run, feeling her lithe form bounce on your " +
            player.cockDescript(x) +
        ...
        outputText("The familiar tightness of a coming orgasm grows in your groin, tightening as you near release. You pick up the pace, full out sprinting, letting the girl bounce and jiggle as she clings to you, supported entirely by your " +
            player.cockDescript(x) +
            ". ");
        if (player.balls > 0)
        ...
        if (player.cumQ() >= 100)
            outputText("  Your enhanced body easily stuffs her full of cream, pudging her belly out slightly, your seed staying embedded in her womb with nowhere to escape, her cunt plugged tightly with your " + player.cockDescript(x) + ".");
        if (player.cumQ() >= 500)
            outputText("  The orgasm is so potent that by the time you wind down, she looks to be sporting a pregnancy the size of a medicine ball.  Your cum is trapped inside her, unable to find any gap between her walls and your " +
                player.cockDescript(x) +
                ".");
        else if (player.cumQ() >= 250)
            outputText("  The orgasm is so potent that by the time you wind down, she looks heavily pregnant.  Your cum is unable to find any gap between her walls and your " + player.cockDescript(x) + ".");
        outputText("<br><br>");
    ...
    //(FITS – Get ridden)
        ...
        outputText("You pick up the defeated goblin, looking her over.  She crosses her arms across her chest pitifully and asks, \"<i>What now?</i>\" with her eyes darting down when she thinks you won't notice.  You muse to yourself 'great minds think alike' and lower her down towards your " +
            player.cockDescript(x) +
        ...
        outputText("The familiar tightness of a coming orgasm grows in your groin, tightening as you near release.  You pick the pace, full out sprinting, letting the girl bounce and jiggle as she clings to you, supported entirely by your " +
            player.cockDescript(x) +
            ".  ");
        if (player.balls > 0)
            outputText("Your " + player.ballsDescriptLight() + " tighten, releasing the seed of your orgasm.  ");
...
GoblinScene.goblinFemaleRape = function () {
    ...
    if (player.isTaur()) {
        ...
        outputText("You drop her for real this time but don't give her the opportunity to stand, roughly shoving your " +
            player.vaginaDescript(0) +
    ...
    // Are you a naga?
        ...
        outputText("That's proven very false in a moment though, as her eyes fly open and she yells out \"<i>WHOOOOOO!</i>\". You're startled at the sudden change in demeanor, but decide to roll with it, shoving your " +
            player.vaginaDescript(0) +
    ...
    // Normal female rape.
        ...
        outputText("The goblin squeals, though in delight or pain you can't be sure.  You start spanking her harder and harder, turning her ass from green to red with the repeated abuse.  Her entire body begins convulsing and squirting, splattering your arm with her honey.  She got off on it!  Well, after that kind of show, she's going to get you off too - or else!<br><br>");
        outputText("You pull her off your leg and shove her face into your " +
            player.vaginaDescript(0) +
...
GoblinScene.manRapesGoblinTooBig = function () {
    ...
    outputText(".  The ");
    if (player.cocks[0].cockType == ENUM.CockType.HORSE)
        outputText("flare");
    else
        outputText("head");
    outputText(" of your " +
    ...
    outputText("Disgruntled with the tease, you pull out and slide it onto her torso, pinning her underneath your " +
        player.cockDescript(x) +
...
GoblinScene.rapeAGoblinCorruptTooBig = function () {
    ...
    outputText("You have a seat, legs wide, on the ground and hold the little goblin whore with her relatively tiny slit resting at the tip of your " +
        player.cockDescript(x) +
    ...
    outputText("Both of you dripping with sweat from your respective exertions, you slowly begin to realize the combination of her furious struggling and the tightness of her " +
        monster.vaginaDescript() +
    ...
    outputText("The goblin relaxes a little when she feels you no longer pressing her down onto your " +
        player.cockDescript(x) +
    ...
    outputText("You reposition your fucktoy so that now she's facing away from you and again bring your " +
        player.cockDescript(x) +
    ...
    outputText(" and it drives your lust even higher. You withdraw more cock from the hole than your cum starved slut has body, causing her eyes to roll into the back of her head as her " +
        monster.vaginaDescript() +
    ...
    if (player.hasVagina()) {
        ...
        outputText("while your other " + Appearance.cockNoun(ENUM.CockType.HUMAN));
        if (player.cockTotal() > 2)
...
GoblinScene.goblinButtSex = function () {
    ...
    outputText("After quickly removing your " +
        player.armorName +
    ...
    outputText("Without any reservations, you slam the goblin whore onto your " +
        player.cockDescript(x) +
    ...
    outputText("Protesting, the goblin squirms more, even going as far as to beat her fists into your chest; she's so feeble at the moment that her strikes actually tickle. Her puny assault is enough to knock you out of your carnal daze. You grin manically as you grasp her tiny waist and hammer her! Your " +
        player.cockDescript(x) +
    ...
    outputText("As you pick up your " +
        player.armorName +
...
GoblinScene.giveGoblinAMilkMustache = function () {
    clearOutput();
    outputText("You slowly walk up to the downed goblin, gently telling her that everything will be all right now. She looks at you a bit incredulously and spreads her legs, obviously hoping that you will satisfy the urges that she has. You shake your head at her and instead cup your hands under your " +
    ...
    outputText('She struggles against your grip, trying to get something, anything inside her needy pussy while yelling "<i>Come on ' +
        player.mf("slut", "stud") +
    ...
    outputText("After a while, you feel the goblin fall asleep in your arms. Even then, she still continues suckling gently on your " +
        player.nippleDescript(0) +
...
GoblinScene.goblinCondomed = function (mode) {
    ...
    outputText('Defeated, the goblin girl\'s knees give out and she sinks backward, lying on her back with her emerald ankles suspended above her head. "Use me," she begs, "humiliate, degrade, and debase me! Just, whatever you do, fill me!" As you strip off your ' +
        player.armorName +
    ...
    outputText("Impatiently, she thrusts her legs out and hooks her toes around your lower body, trying to pull you closer while still keeping her needy hole accessible. Her olive feet clench around your flesh, her soles firm and muscular on your " +
    ...
    if (mode == 0) {
        ...
        outputText("you work your spinnerets, the delicate organ weaving a long, thin sheath of finely meshed spider silk, taking care to leave the sticky strands between the inert layers of the flexible condom. Sliding it over your " +
            player.cockDescript(x) +
...
GoblinScene.goblinDriderEggs = function () {
    ...
    if (player.femininity > 50)
        outputText("<br><br>\"<i>W-what?  You- I haven't got any, you stupid bitch!  This your idea of fun, jackass?  Kicking people when they're down?!</i>\"");
    //[if (femininity < 51)
    else
        outputText("<br><br>\"<i>W-what?  You- I haven't got any, you stupid bastard!  This your idea of fun, jackass?  Kicking people when they're down?!</i>\"");
...
GoblinScene.goblinRapesPlayer = function () {
    ...
    if (player.findPerk(PerkLib.BimboBrains) >= 0 || player.findPerk(PerkLib.FutaFaculties) >= 0) {
        ...
        if (player.hasVagina()) {
            ...
            outputText("Your body is already hot and your " +
                player.nippleDescript(0) +
            ...
            outputText("Saliva coats your lips and dribbles down onto your boobs when the goblin pulls the thick, soaked dong out of your mouth. The part that was stuffed down your throat is swollen up to nearly twice as wide as the half still in her hand. The goblin quickly corrects that, slurping the second half down into her throat, taking at least eight inches into her mouth with no sign of gagging. She's like, totally good at this! She pulls it out, watching it puff up. She blushes, turning her slightly-dimpled, green cheeks a shade of purple. The dildo slaps your twat cruelly as she drops part of it onto your mons. With a few practiced motions, she shoves it inside you, stuffing you full of artificial cock, bringing your mind back to all the times you'd fucked yourself just like this. Your easy, wandering mind is brought back to the present by a small slap on the dildo, which sends vibrations right into your " +
                player.vaginaDescript(0) +
                ".<br><br>");
            outputText("Your green slut counterpart stands up and steps over your crotch, positioning herself perpendicular to you. The warm wetness of her dripping cunt splashes your thighs when she works the free end of the double-dong into her own slick twat. Your pussy squelches against hers wetly as they meet in the middle, your " +
                player.clitDescript() +
    ...
    if (player.hasVagina()) {
        ...
        if (player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_NORMAL)
            ...
            outputText("Feminine lubricant soaks into the back of your " + player.armorName + ".  ");
        else
            outputText("It rapidly forms into a puddle as your " + player.vaginaDescript(0) + " does its best to show just how ready you are.  ");
    }
    ...
    if (player.totalCocks() > 0 && (!player.hasVagina() || rand(2) == 0)) {
        ...
        if (player.cockArea(0) > monster.vaginalCapacity()) {
            outputText("She lifts her body up high, grabbing your " +
            ...
            outputText(" before she buries it deep into your " +
            ...
            if (player.hasVagina())
                outputText("caressing your " + player.clitDescript());
            else
        ...
        //Dick fits...
            ...
            outputText("The goblin-girl doesn't waste time with any more foreplay, she just arches her back like a cat about to get the cream, and slides her plush ass towards your " +
                player.cockDescript(0) +
            ...
            if (player.balls > 0)
                outputText("cup your " + player.ballsDescriptLight() + " in one hand, squeezing gently as the drug begins to affect them");
            else
    ...
    // Female rape, or herm pussy rape.
        ...
        outputText("By now your passage feels as stuffed as it ever has been, crammed totally full of the squishy expanded double-dong.  Every motion the tiny slut makes is amplified directly into the fuck-stick plugging your " +
            player.vaginaDescript(0) +
