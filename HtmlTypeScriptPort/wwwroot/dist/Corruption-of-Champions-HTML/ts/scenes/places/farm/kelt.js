...
Data.addToGameFlags(FLAG.KELT_MET, FLAG.KELT_SUBMISSIVENESS, FLAG.NEVER_RESIST_KELT, FLAG.KELT_BAD_END_WARNING, FLAG.KELT_DISABLED, FLAG.KELT_KILLED, FLAG.KELT_BREAK_LEVEL, FLAG.KELLY_CUNT_TYPE, FLAG.KELLY_COCK_SIZE, FLAG.TIMES_PUNISHED_KELLY, FLAG.TIMES_RIM_JOBBED_BY_KELLY, FLAG.TIMES_RIDDEN_KELLY_FOR_PUNISHMENT, FLAG.KELLY_BONUS_TIT_ROWS, FLAG.KELLY_LACTATING, FLAG.KELLY_DISOBEYING_COUNTER, FLAG.KELLY_VAGINALLY_FUCKED_COUNT, FLAG.KELT_KILLED);
class KeltScene {
    static bowSkill(amount = 0) {
        //Increment
        liveData.bowSkill += amount;
        //Clamp values
        if (liveData.bowSkill > 100)
            liveData.bowSkill = 100;
        if (liveData.bowSkill < 0)
            liveData.bowSkill = 0;
    }
        ...
        //Repeated encounter
            ...
            if (liveData.player.isTaur() && liveData.gameFlags[FLAG.KELT_SUBMISSIVENESS] >= 100 && liveData.player.gender > 1) {
                if (liveData.player.inte > UTIL.rand(40) && liveData.gameFlags[FLAG.KELT_SUBMISSIVENESS] < 130 && liveData.gameFlags[FLAG.KELT_BAD_END_WARNING] <= 0) {
                    liveData.gameFlags[FLAG.KELT_BAD_END_WARNING] = 1;
                    GUI.outputText("You approach the farm, ready for another archery lesson. Kelt is oblivious to your presence, busy practicing with his own bow for the moment. The wind shifts and blows his musk your way. Unconsciously, you breathe deeply, sending heat racing between your rear legs. Alarm bells go off in your mind as you realize what his presence is doing to you, and you run away to your camp before he can notice you. It's clear to you that you can't resist him much longer; the next time you meet him, you'll probably volunteer to become his brood-mare. Perhaps you should avoid Kelt and the farm until you feel his influence less keenly.");
    ...
    static keltFirstTime() {
        ...
        GUI.outputText("As you get closer, however, the figure comes into view. The rider is not Whitney, but rather a muscular man. And the horse has no head... where its head should be is... with a start, you realize that this is no horse and rider. The figure is a large, male centaur!\r\r");
        GUI.outputText("Wariness growing, you slow down. But it is too late... the centaur has seen you. With a snort, he gallops closer, imposingly tall. You drop into a fighting stance, ready if he should attack you, and the centaur draws to a halt a few feet away.\r\rHe looks scornfully at you, and laughs, ");
    ...
    static keltMainEncounter() {
        ...
        //(Submissive 0-30:
        if (liveData.gameFlags[FLAG.KELT_SUBMISSIVENESS] <= 30)
            GUI.outputText("You grind your teeth in irritation, but swallow your pride enough to ask him for help. ");
        //(Submissive 30-70:
        else if (liveData.gameFlags[FLAG.KELT_SUBMISSIVENESS] <= 70)
            GUI.outputText("You nod reluctantly, and Kelt grins. He may be arrogant, but he is rather good. ");
        //(Submissive 70-100:
        else
            GUI.outputText("You nod enthusiastically, almost begging him to teach you. ");
        //(Before Naked Requirement)
        if (liveData.gameFlags[FLAG.KELT_MET] <= 3) {
            GUI.outputText("Kelt seems to find the idea of training a human almost comical, but suggests that if you want to follow him around for a while, he has no problem with it. Though his attitude is annoying, you resolve to learn what you can.\r\r");
        }
    ...
    static keltMainEncounterAfterNakedReq() {
        ...
        if (player.findStatusEffect(StatusEffects.NakedOn) >= 0) {
            GUI.outputText("He nods, smirking slightly, and gestures at your clothes impatiently. With some pleasure, you strip down before him, discarding your clothes with a little flair. Kelt is grinning by the end, openly admiring your body, and you feel a little more aroused for obeying his dominant command.\r\r");
        ...
        //(Naked Off)
            ...
            //(Otherwise:
                ...
                if ((liveData.player.cor + liveData.player.lib + liveData.player.lust >= 180 && liveData.player.inte < 40) || liveData.gameFlags[FLAG.KELT_SUBMISSIVENESS] >= 60) {
                    GUI.outputText("This time, though, the idea turns you on a little. You ask Kelt if he would prefer to see you naked, and begin stripping down in front of him. He seems surprised but obviously enjoys the show, and you are incredibly aroused by his attention. Part of you reasons that if training naked is better, maybe you should just strip down right away, each time? The thought is more than a little stimulating.");
                ...
                //(Otherwise:
                    ...
                    GUI.outputText("You ignore his barbed comments as best as you can, and soon enough, he leaves the matter alone, instead critiquing your archery skills.\r\r");
            }
        }
    ...
    static keltMainEncounter2() {
        ...
        if (liveData.player.hasKeyItem("Bow") < 0) {
            ...
            if (liveData.player.hasKeyItem("Bow") < 0)
                liveData.player.createKeyItem("Bow", 0, 0, 0, 0);
        }
        //(Bow equipped)
        else {
    ...
    static keltMainEncounter3() {
        ...
        if (liveData.player.findStatusEffect(StatusEffects.NakedOn) < 0) {
            GUI.outputText("Kelt is arrogant, crude, and all too often cruel as he mocks your attempts at archery again and again. Despite all this, however, he obviously does know what he's doing. You try to ignore his insults and lewd comments as best as you can and focus on the archery. In the end, you feel you've learned a lot, though Kelt remains snide.\r\r");
            let temp = UTIL.rand(4);
            //(25% Chance:
            if (temp == 0)
                GUI.outputText("\"<i>Oh, yes. Looks like you're shaping up to be a pretty accurate archer. Just make sure you only fight blind giants. You know, massive targets that have no chance to dodge. You'll do fine.</i>\"\r\r");
            //(25% Chance:
            if (temp == 1)
                GUI.outputText('"<i>Ha! You want to become an archer? Here\'s a hint... stop thinking about sucking cock for two seconds and AIM.</i>"\r\r');
            //(25% Chance:
            if (temp == 2)
                GUI.outputText('"<i>See the red dot, in the middle of the target? Imagine that\'s your ass, and the arrow is a big, fat, minotaur cock. That should help you hit the target.</i>"\r\r');
            //(25% Chance:
            if (temp == 3) {
                if (liveData.player.race() != "centaur")
                    GUI.outputText("\"<i>If you were a centaur, I'd recommend suicide. Since you're a " + liveData.player.race() + ", I'd say your best option is to fuck off.</i>\"\r\r");
                else
                    GUI.outputText("\"<i>As a centaur, I'd recommend suicide. Really, it's that or man the fuck up.</i>\"\r\r");
            }
            //player.addStatusValue(StatusEffects.Kelt,1,5+UTIL.rand(4));
            if (liveData.player.statusEffectv1(StatusEffects.Kelt) < 90)
                bowSkill(5 + UTIL.rand(4));
            else
                bowSkill(1);
        }
        //NAKERS
            ...
            if (liveData.player.inHeat && liveData.player.gender > 1) {
                ...
                GUI.outputText("You line up as normal to begin practicing, shooting at the distant targets while Kelt criticizes your technique... usually in as loud, lewd, and offensive a way as possible. Today, however, he seems particularly energetic. He looms over you, distractingly close, his hooves stomping at the ground like an anxious horse. His insults are as harsh as ever... perhaps even more cruel than usual as he mocks your attempts to hit the targets.\r\r");
                GUI.outputText("One shot goes wide, and Kelt furiously demands that you go to retrieve the arrow, lodged in a nearby bale of hay. You do so quickly, snapping to obey his orders with a little shiver of pleasure. Somehow, it feels right to obey his every wish; to do what you can to satisfy him. His scent has been distracting you... the rich, masculine power of him. How had you never noticed before what a spectacular creature Kelt was?\r\r");
                GUI.outputText("You lean over to pluck the arrow from the haystack, and feel a sharp blow to the back of your head, knocking you over and sending your consciousness spinning. Dizzily, you realize Kelt is standing over you, tossing aside the bow he just used to crack you in the head. Between his horse legs, a massive manhood is dropping from his sheath, flanked by testes the size of softballs. A lewd grin is on his face.\r\r");
                GUI.outputText("\"<i>Did you think I wouldn't notice, slut? You reek like a mare in heat. I could smell it on you the moment you arrived. Fortunately, I know just what to do with a fertile bitch. Let's put a baby centaur in that tight pussy of yours.</i>\"\r\r");
                GUI.outputText("Kelt's forelegs rear up just enough to plant them around your shoulders, his massive weight bearing down on you. The bale of hay lifts you just high enough to line up with his fat erection, which presses between your asscheeks even now.\r\r");
                //(Submissive, 0-30:
                if (liveData.player.statusEffectv2(StatusEffects.Kelt) <= 30)
                    GUI.outputText("You struggle as best as you can, but Kelt weighs a good deal more than you do. As his thrusting hips anxiously press his cock to your nether-lips, you realize this is going to happen, whether you want it to or not. The thought fills you with an undeniable shiver of pleasure.\r\r");
                //(Submissive, 30-70:
                else if (liveData.player.statusEffectv2(StatusEffects.Kelt) <= 70)
                    GUI.outputText("You put forth a token effort to escape, but it is obvious from the beginning that there is no way to get out from under the heavy weight of the centaur. Besides, the desire running through you is palpable... in a way, you want this to happen. So much so that as Kelt is thrusting, trying to line up his cock, you raise your hips to help him out, silently longing for penetration.\r\r");
                //(Submissive, 70-100:
                else
                    GUI.outputText("The masculine scent of him is overpowering, desperate. Your body wants nothing more than to submit to Kelt's ferocious desires, and your mind agrees. Eagerly, you thrust your hips up, reaching back with one hand to guide his cock to your wet pussy. Kelt snorts his approval, and you feel a shivering tremor of lust run through you.\r\r");
            ...
            //(Naked, 60% Chance)
            if (temporary <= 2) {
                GUI.outputText("The lesson proceeds as normal, with you taking shots while Kelt arrogantly critiques your style, tossing out colorful and creative insults whenever possible. He has no shame about mocking your body as much as he laughs at your archery, and makes several crude comments about what it might be good for.");
                //(Submissive, 0-30:
                if (liveData.player.statusEffectv2(StatusEffects.Kelt) <= 30)
                    GUI.outputText("You try to ignore the foul remarks, telling yourself that this is simply the way he is. It does not help, though, that at times you feel Kelt's eyes wandering across you lustfully. At least some of his comments are not mockeries, but suggestions. The entire experience makes you feel a little more uncomfortable around the abusive centaur.");
                //(Submissive, 30-70:
                else if (liveData.player.statusEffectv2(StatusEffects.Kelt) <= 70)
                    GUI.outputText("Despite yourself, some of his cruder comments make you blush. By now, you're getting used to the oft times depraved sexuality of the demon world... but it is a little humiliating to subject yourself to this kind of treatment... and, to your shame, sometimes it's a little arousing. Though Kelt is insulting, cruel, and crude, you also notice real lust in some of his glances. By the end of the lesson, you are flushed with arousal as well as exertion.");
                //(Submissive, 70-100:
                else
                    GUI.outputText("Of course, Kelt's words only distract you even more from hitting the target. Not because you are angry... but because you are aroused. Somehow, his lewd comments and crude jibes make you shiver with anticipation. He's just so powerful, so masculine. Kelt seems well aware of the effect he has on you, and once reaches out to slap your ass heartily. By the end of the training, you feel intensely horny.");
            ...
            if (temporary == 3) {
                ...
                GUI.outputText("To your surprise, he suddenly leans forward, fist moving towards your head. You raise your arms to deflect the blow, but he changes tactics suddenly and grabs one of your " +
                ...
                //(Medium Size, E-HHH:
                    ...
                    GUI.outputText("\"<i>Just look at these mommy melons! You want to be an archer? I'm amazed you don't slap yourself in the tits with every shot! Easy target to grab onto. But hey, I bet you like it that way. Like it when people grope these fat titties of yours?</i>\"\r\r");
                //(Big Size, Watermelon and beyond:
                else
                    GUI.outputText('"<i>Look at you! You\'re a miracle of science, you are... any other creature would break their back, trying to haul these milk bags around! Tell the truth, now... which one of your parents was actually a cow?</i>"\r\r');
                GUI.outputText("Despite his cruel words, you can't help but groan a little bit as he brutalizes your sensitive chest. Kelt seems to take a good deal of pleasure in how helpless you are, pinching and flicking your " +
            ...
            if (temporary == 4) {
                ...
                GUI.outputText("Groaning, distracted and unnerved, you hurriedly line up the shot as best as you can. Kelt's fingers flex, forcing you to stand up straighter. Your arm shakes as you take aim, and you can feel Kelt's hot breath on your hair, and then the arrow is flying! Ten meters... five... bullseye!\r\r");
    ...
    static keltMainEncounterPostBlowjob() {
        ...
        if (liveData.player.findStatusEffect(StatusEffects.BlowjobOn) >= 0) {
            ...
            if (liveData.player.lust >= 75 || (liveData.gameFlags[FLAG.KELT_SUBMISSIVENESS] >= 90 && UTIL.rand(2) == 0)) {
                ...
                GUI.outputText("It is almost too much to wait for your meeting with Kelt today. His familiar musk enflames your senses, making you ache with need. You try to wriggle your ass enticingly for Kelt as the two of you walk, eager to start in on the usual blowjob. Even you don't usually hunger after it this much, but a need for Kelt's cock fills you to the core. You long for nothing more than to service your mighty stud.\r\r");
                GUI.outputText("To your surprise, Kelt leads you not towards the practice field, but towards a small barn, near the edge of the field. When you meekly ask why he's taken you here, his brow clouds and he lashes out, striking you with casual violence. ");
                GUI.outputText('"<i>Bitch! I said get in there. Do I need to repeat myself, you stupid whore?"</i>\r\r');
                GUI.outputText("Scrambling to your feet and babbling apologies, you hastily open the door to the barn, entering immediately. Before you is a thin, upraised table, with straps in it, like saddle stirrups. Your heart leaps excitedly, and Kelt laughs a little to himself as he tells you to get on, facedown. You hasten to comply.\r\r");
                ...
                if (liveData.player.hasVagina())
                    GUI.outputText(" For a moment, his fingers trace the line of your exposed " +
                ...
                //(Penis:
                if (liveData.player.totalCocks() > 0)
                    GUI.outputText(" Beneath you, pressed firmly into the harsh wood of the mounting board, your " +
                ...
                if (liveData.player.gender == 0)
                    GUI.outputText(" Never before has a complete lack of genitalia been so frustrating... or pleasurable. Not being able to physically cum, the explosions of climax simply rack up within your body... waves of cascading pleasure with no release and no mercy.");
                GUI.outputText("\r\rIf anything, your orgasm only seems to spur Kelt on, causing him to push deeper and faster. The idea of fitting his massive, nearly three-foot cock into your bowels seems ludicrous, but the aggressive centaur obviously has no intention of taking 'no' for an answer. With each powerful thrust of his hips, he sinks more cock deep within your ass, filling you, stretching you, ripping you open with still more to come. It is almost a terrible relief when you feel his massive testicles colide with your ass, buried at last to the hilt. Even in victory, Kelt is snide. ");
                if (liveData.player.looseness(false) < 3)
                    GUI.outputText("\"<i>Fuck! About time! Sure got a tight little ass back here, but don't worry, slut. We'll stretch it out in no time. I promise you this... you'll be getting a lot more of my cock from now on, so you'd better be ready!</i>\"\r\r");
                else if (liveData.player.looseness(false) < 5)
                    GUI.outputText("\"<i>Fuck! About time! Sure got a nice ass back here, but don't worry, slut. We'll turn it into a real gaper soon. It's a good thing you've been practicing... you'll be getting a lot more of my cock from now on, so you'd better be ready!</i>\"\n\n");
                else
                    GUI.outputText("\"<i>Fuck! About time! Sure got a nice, stretched out little pucker back here, but don't worry, slut. I'll train into to squeeze down just right in no time. I promise you this... you'll be getting a lot more of my cock from now on, so you'd better be ready!</i>\"\n\n");
                ...
                GUI.outputText("It's some hours later before you rouse yourself, clenching your ass as best as you can to keep the tide inside. Despite your efforts, a steady trail oozes down your leg, marking your path as you slowly, happily trudge back to your Camp.");
                GUI.doNext(Camp.returnToCampUseTwoHours);
                liveData.player.slimeFeed();
                //(+10 Submissiveness)
                if (liveData.player.buttChange(70, true))
                    GUI.outputText("\r\r");
            ...
            //(Otherwise)
                ...
                GUI.outputText("You hardly remember the rest of the training. You're far too distracted by the fullness of your belly, and the thought of maybe getting a little more. Kelt seems almost bored by the end, despite your attempts to entice him during the lesson, and leaves soon afterwards, to your chagrin.");
                liveData.player.slimeFeed();
                //(+5 Submissiveness)
                liveData.gameFlags[FLAG.KELT_SUBMISSIVENESS] += 5;
                bowSkill(3);
        ...
        //(Blowjob Requirement Off, 40% Chance)
            ...
            GUI.outputText("You move towards the practice field, trying to ignore the way Kelt openly and hungrily eyes your naked body. He has become more and more open about his lust for you. Despite yourself, you can't help but enjoy his attentions.\r\r");
            ...
            GUI.outputText("A shiver of desire and a tremor of fear run through you. You had hoped to avoid this requirement. A hunger lies within you... the thought of once more slurping down centaur cum is all but irresistible. But you fear that with each time, you are losing yourself more and more...\r\r");
            ...
            if (liveData.player.cor + liveData.player.lib + liveData.player.lust >= 220 && liveData.gameFlags[FLAG.KELT_SUBMISSIVENESS] >= 80) {
                GUI.outputText("You try to resist the need. You honestly try. But this time, there is just no stopping it. Your desire for Kelt to cum within you again is so great, you fall to your knees immediately before him, waiting hungrily for your treat. A part of you wonders why you ever resisted in the first place... in fact, why not suck him off before every lesson? Surely that would make him like you more...\r\r");
    ...
    static keltResistGivingBJ() {
        GUI.clearOutput();
        GUI.outputText("Summoning what remains of your fragmented willpower, you resist the need, apologizing to Kelt and turning to walk away. It hurts to do so, aching within your chest with an almost physical need to go back; to apologize and kneel before him worshipfully.\r\r");
    ...
    static keltReluctantGivingBJ() {
        ...
        GUI.outputText("Meekly you nod, humiliated and full of cum. The worst part, by far, is how happy you are on the inside. You try to tell yourself that this is wrong, that Kelt is an arrogant, cruel creature, and that this is the last time. But you don't really believe that. Despite the lies you tell yourself, you look forward to the next time he decides to use you.\r\r");
        liveData.player.changeLust(5, false);
        //(+5 Submissiveness)*/
        liveData.gameFlags[FLAG.KELT_SUBMISSIVENESS] += 5;
        GUI.doNext(Camp.returnToCampUseOneHour);
