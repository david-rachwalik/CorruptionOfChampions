...
Areas.GenericExploration.exploreMenu = function () {
    ...
    if (exploration.exploredForest > 0)
        addButton(1, "Forest", Areas.Forest.explore, null, null, null, "Visit the lush forest. <br><br>Recommended level: 1" + (player.level < 5 ? "<br><br>Beware of Tentacle Beasts!" : ""));
    if (exploration.exploredLake > 0)
        addButton(2, "Lake", Areas.Lake.explore, null, null, null, "Visit the lake and explore the beach. <br><br>Recommended level: 2");
    if (exploration.exploredDesert > 0)
        addButton(3, "Desert", Areas.Desert.explore, null, null, null, "Visit the dry desert. <br><br>Recommended level: 3");
    if (exploration.exploredMountain > 0)
        addButton(4, "Mountain", Areas.Mountain.explore, null, null, null, "Visit the mountain. <br><br>Recommended level: 5");
