...
magicMenu = function () {
    ...
    if (player.spells.blind)
        addButton(0, "Blind", spellBlind);
    if (player.spells.chargeWeapon)
        addButton(1, "Charge Weapon", spellChargeWeapon);
    if (player.spells.whitefire)
        addButton(2, "Whitefire", spellWhitefire);
    //Black Spells
    if (player.spells.arouse)
        addButton(5, "Arouse", spellArouse);
    if (player.spells.heal)
        addButton(6, "Heal", spellHeal);
    if (player.spells.might)
