...
pregnancyProgression.updatePregnancy = function () {
    ...
    if (player.pregnancyType == PREGNANCY_AMILY) {
        ...
        if (player.pregnancyIncubation == 0 && player.pregnancyType == PREGNANCY_AMILY) {
            ...
            if (gameFlags[AMILY_FOLLOWER] == 2 || gameFlags[AMILY_CORRUPTION_PATH] > 0)
                player.knockUpForce(PREGNANCY_MOUSE, player.pregnancyIncubationFlag);
            if (gameFlags[AMILY_VISITING_URTA] == 1 || gameFlags[AMILY_VISITING_URTA] == 2)
                player.knockUpForce(PREGNANCY_MOUSE, player.pregnancyIncubationFlag);
    ...
    if (player.pregnancyType == PREGNANCY_IMP) {
        ...
        if (player.pregnancyIncubation <= 216 * 60 && player.pregnancyIncubation >= 180 * 60) {
            ...
            if (player.cor < 40)
                outputText("You are distressed by your unwanted pregnancy, and your inability to force this thing out of you.</b><br><br>");
            if (player.cor >= 40 && player.cor < 75)
                outputText("Considering the size of the creatures you've fucked, you hope it doesn't hurt when it comes out.</b><br><br>");
            if (player.cor >= 75)
                outputText("You think dreamily about the monstrous cocks that have recently been fucking you, and hope that your offspring inherit such a pleasure tool.</b><br><br>");
            if (statControl == 0) {
                statControl = 1;
        ...
        if (player.pregnancyIncubation <= 72 * 60 && player.pregnancyIncubation >= 48 * 60) {
            ...
            if (player.cor < 40)
                outputText("making it difficult to function.</b>");
            if (player.cor >= 40 && player.cor < 75)
                outputText("and you wonder how much longer you have to wait.</b>");
            if (player.cor >= 75)
                outputText("and you're eager to give birth, so you can get impregnated again by corrupted or monstrous cum filling out your eager womb.</b>");
            outputText("<br><br>");
            if (statControl == 1) {
                statControl = 2;
    ...
    if (player.buttPregnancyIncubation == 0 && player.buttPregnancyType == PREGNANCY_BEE_EGGS) {
        ...
        if (player.vaginas.length > 0)
            outputText("Your " + player.vaginaDescript(0) + " becomes engorged and sensitive.  ", false);
        ...
        if (player.cor >= 90)
            outputText("You lick your lips, savoring the honeyed residue on them as you admire your thousands of children.  If only every night could be like this...<br>", false);
        buttStatControl = 0;
