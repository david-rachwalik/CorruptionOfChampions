...
GoblinScene.victoryAgainstGoblin = function () {
    clearOutput()
    if (monster.HP <= 0) outputText("The goblin falls down and smashes her titties against the ground. She looks up at you and sniffles.")
    else {
        outputText(
...
GoblinScene.gobboGetsRapedMaleFits = function () {
    ...
    if (player.cockArea(x) > monster.vaginalCapacity() * 0.8) {
        ...
        if (player.cocks[0].cockType == ENUM.CockType.DEMON) outputText("rubbing painfully against your demonic nubs")
        else if (player.hasKnot(0)) outputText("stretching painfully around your knot")
        else if (player.cocks[0].cockType == ENUM.CockType.HORSE || player.cocks[0].cockType > 3) outputText("feeling painfully tight around you")
    ...
    //(FITS – Get ridden)
        ...
        if (player.cocks[0].cockType == ENUM.CockType.DEMON) outputText("rubbing perfectly against your demonic nubs")
        else if (player.hasKnot(0)) outputText("stretching tightly around your knot")
        else if (player.cocks[0].cockType == ENUM.CockType.HORSE || player.cocks[0].cockType > 3) outputText("feeling absolutely perfect around you")
...
GoblinScene.manRapesGoblinTooBig = function () {
    ...
    outputText(".  The ")
    if (player.cocks[0].cockType == ENUM.CockType.HORSE) outputText("flare")
