...
SandTrapScene.sandTrapPregChance = function () {
    ...
    if (gameFlags[FERTILE_SANDTRAP] == 1) player.buttKnockUp(PREGNANCY_SANDTRAP_FERTILE, INCUBATION_SANDTRAP)
    else player.buttKnockUp(PREGNANCY_SANDTRAP, INCUBATION_SANDTRAP)
}
...
SandTrapScene.birfSandTarps = function () {
    ...
    //Libido <30:
    if (player.lib < 33)
        outputText("<br><br>You pick yourself up wearily, flap the flytraps you have birthed away and make your way back to camp.  This whole experience has been deeply unnerving, and you vow to make sure you don't have to repeat it.")
    //Libido 30-65:
