    ...
    static wandererEpilogue() {
        if (liveData.gameFlags[FLAG.WANDERER_DEMON] == 1) {
            ...
            if (liveData.gameFlags[FLAG.WANDERER_EPILOGUE] == 0) {
                ...
                else GUI.outputText("You openly leer at the crude display, whistling lewdly at the blissful couple. Marcus looks up and gives a cocky smile, while Lucia licks her lips and gives you a predatory grin.")
