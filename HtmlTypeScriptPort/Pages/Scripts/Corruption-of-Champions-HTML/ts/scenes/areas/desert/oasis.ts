...
DemonPack.packAttack = function () {
    ...
    //Determine if cat'ed
        ...
        if (temp <= 0) {
            temp = 0
            if (!monster.plural) outputText("You deflect and block every " + monster.weapon.verb + " " + monster.a + monster.name + " throw at you.")
            else outputText("You deflect " + monster.a + monster.name + " " + monster.weapon.verb + ".")
        } else {
            if (temp <= 5) outputText("You are struck a glancing blow by " + monster.a + monster.name + "! ")
            else if (temp <= 10) outputText(monster.a + monster.name + " wound you! ")
            else if (temp <= 20) outputText(monster.a + monster.name + " stagger you with the force of " + monster.pronoun3 + " " + monster.weapon.verb + "s! ")
...
DemonPack.lustAttack = function () {
    if (player.lust < 35) {
        ...
        if (player.cocks.length > 0) outputText(player.multiCockDescriptLight() + " hardening ")
