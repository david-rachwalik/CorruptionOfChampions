...
GreenSlimeScene.rapeOozeWithMilk = function () {
    ...
    //[If Herm-
        ...
        outputText("caressing your " + player.multiCockDescriptLight(), false)
        if (player.balls > 0) outputText("and slipping slightly further down to engulf your " + player.ballsDescriptLight() + " as well. ", false)
    ...
    if (player.tallness < 82) {
        ...
        //female or herm version (if the herm didn't trigger male)
            ...
            //Small clitties
                ...
                outputText(
                    "You moan and lean back slightly as you start to flick your " + player.clitDescript() + ", the slime's fluid providing excellent lubrication and a luxurious warming feeling as you make small circles around your nub.  ",
                    false
                )
            ...
            if (player.cockTotal() > 0) {
                ...
                //Single prick
                    ...
                    if (player.biggestTitSize() == 0)
                        outputText(
                            "You delicately grasp the head of your " + player.cockDescript(0) + ", your hand slick with the fluids of yourself and of the creature.  The combination of the creature's movements and your own quickly overwhelms you.",
                            false
                        )
                }
            }
    ...
    //PHEW! that was a big one.  now...  we do it all again for large players, whee! and this is why this thing is so goddamn long.
        ...
        if (player.gender == 1 || (player.gender == 3 && rand(2) == 0)) {
            ...
            //SingleCock
                ...
                //Compare cocks
                if (player.cocks[0].cockType == ENUM.CockType.HUMAN) outputText("a near exact replica of your own " + player.cockDescript(0) + "!  ", false)
        ...
        //Female/Herm Masturbation
            ...
            //Just clits, no cocks.
                ...
                if (player.biggestTitSize() == 0 || player.breastRows.length == 0)
                    outputText(
                        "You begin to moan as the creature rubs your " + player.vaginaDescript(0) + ", working you with incredible skill, but what comes next is an utter surprise, making you unconsciously wring the head of the slime's cock.  ",
                        false
                    )
                //Clit engulph'ed!
                outputText(
