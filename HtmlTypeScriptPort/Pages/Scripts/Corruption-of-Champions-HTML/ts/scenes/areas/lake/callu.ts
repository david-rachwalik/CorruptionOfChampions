...
CalluScene.ottergirlLikesDongs = function () {
    ...
    //[equine]
    if (player.cocks[x].cockType == ENUM.CockType.HORSE) outputText("to your flare, sucking, teasing and ")
    //[canine]
    else if (player.hasKnot(x)) outputText("to the base of your cock, planting sloppy kisses on your knot, ")
    //[demonic]
    else if (player.cocks[x].cockType == ENUM.CockType.DEMON) outputText("to the demonic nodules ringing your cock, ")
    //[anemone]
    else if (player.cocks[x].cockType == ENUM.CockType.ANEMONE) outputText("to the little wriggling tentacles ringing the head and base of your cock, ")
