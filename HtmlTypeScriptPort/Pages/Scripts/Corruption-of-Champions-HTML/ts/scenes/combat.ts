...
flee = function (callHook) {
    ...
    if (monster.refName == "Marae") {
        ...
        else outputText("You grit your teeth with effort as you try to fly away but the tentacles grab your " + player.legs() + " and pull you down. ")
    ...
    //FAIL FLEE
        ...
        if (player.canFly()) {
            ...
            if (monster.plural) outputText(capitalize(monster.a) + monster.refName + " manage to grab your " + player.legs() + " and drag you back to the ground before you can fly away!")
            else outputText(capitalize(monster.a) + monster.refName + " manages to grab your " + player.legs() + " and drag you back to the ground before you can fly away!")
        } else if (player.tailType == TAIL_TYPE_RACCOON && player.earType == EARS_RACCOON && player.findPerk(PerkLib.Runner) >= 0)
            // >>>>>>[P] FAIL
