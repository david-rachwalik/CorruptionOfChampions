...
abstract class AmilyScene {
    ...
    static start() {
        ...
        // Female Meeting
            ...
            if (liveData.gameFlags[FLAG.AMILY_MET] == 0) {
                ...
                if (liveData.player.humanScore() > 4) outputText("Are you ")
        ...
        // Herm meeting.
            ...
            if (liveData.gameFlags[FLAG.AMILY_MET] == 0) {
                ...
                if (liveData.player.biggestTitSize() < 1) outputText("sniffs the air intensely, her whiskers quivering. ")
    ...
    static amilyStandardMeeting() {
        ...
        switch (liveData.amily.pregnancyEventNum) {
            ...
            case 5: //Amily is slightly pregnant
                ...
                if (liveData.gameFlags[FLAG.AMILY_AFFECTION] < 15 || liveData.player.gender == 0)
                    outputText('"<i>Well, I guess despite whatever other faults you may have, you can get the job done.</i>" She says, not looking directly at you.<br><br>')
                //[Medium Affection]
                else if (liveData.gameFlags[FLAG.AMILY_AFFECTION] < 40)
                    outputText('"<i>Thank you. With your help, my people will soon live again.</i>" She strokes her belly, grinning happily. "<i>Is there something you want to talk about?</i>"<br><br>')
                //[High Affection]
                else
                    outputText(
        ...
        if (liveData.gameFlags[FLAG.AMILY_AFFECTION] < 15 || liveData.player.gender == 0) {
            ...
            if (liveData.gameFlags[FLAG.AMILY_MET_AS] == 2 && liveData.player.gender == 2) outputText('She crosses her arms and smiles at you. "<i>So you came back huh?  Did you want to chat with little old me?</i>" she asks.<br><br>')
        ...
        // Amily is starting to REALLY like you... AMILY AFFECTION 40+
            ...
            outputText('She grins at you with open delight. "<i>Hey there, ' + liveData.player.name + "! It's great to see you again... ")
            // If player is male...
            if (liveData.player.hasCock()) {
                outputText("Have you come to knock me up?")
                if (liveData.gameFlags[FLAG.AMILY_WANG_LENGTH] > 0 && liveData.player.pregnancyIncubation == 0) outputText(" Or have you come to get knocked up?")
            } else if (liveData.player.hasVagina()) {
                if (liveData.gameFlags[FLAG.AMILY_WANG_LENGTH] > 0 && liveData.player.pregnancyIncubation == 0) outputText("Have you come back so I could stuff another bun in your oven?")
        ...
        if (liveData.player.hasItem(Items.Consumables.IncubiDraftPurified) && liveData.gameFlags[FLAG.AMILY_WANG_LENGTH] == 0 && liveData.gameFlags[FLAG.AMILY_HERM_QUEST] == 2 && liveData.gameFlags[FLAG.AMILY_AFFECTION] >= 40 && player.gender == 3) {
    ...
    static amilyNewGenderConfrontation() {
        ...
        //Genderless tooo
            ...
            if (liveData.gameFlags[FLAG.AMILY_AFFECTION] < 15) {
                ...
                if (liveData.player.hasCock()) {
                    outputText(liveData.player.cockDescript(0))
                    if (liveData.player.hasVagina()) outputText(" and ")
                }
                if (liveData.player.hasVagina()) outputText(liveData.player.vaginaDescript())
            ...
            //[High Affection]
                ...
                if (liveData.player.hasCock()) outputText("bringing your " + liveData.player.cockDescript(0) + " to erection")
                if (liveData.player.hasVagina() && liveData.player.hasCock()) outputText(" and ")
                if (liveData.player.hasVagina()) outputText("earning a clench from your " + liveData.player.vaginaDescript(0))
    ...
    static talkToAmily() {
        ...
        if (liveData.gameFlags[FLAG.AMILY_MET_AS] == 2 && liveData.player.gender == 2) outputText("You tell Amily that you came here because you wanted to talk with her.<br><br>")
        ...
        //[Medium Affection]
            ...
            outputText('"<i>Of course, ' + liveData.player.name + ', I always enjoy our talks.  What shall we discuss this time?</i>" she asks happily.<br><br>')
        }
        //[High Affection]
        else {
    ...
    static amilyConversationStart() {
        ...
        if (convo == 0) {
            ...
            if (liveData.player.hasItem(Items.Consumables.PigTruffle)) {
                ...
                outputText("\"<i>The skull of an imp? I hunt imps and sometimes, I would cut their head off and take their skulls as trophy. " + (liveData.gameFlags[CAMP_WALL_PROGRESS] >= 100 ? "I'll hang some the skulls on the wall around your camp. You did a good job with the wall though." : "") + "</i>\"<br><br>");
                }*/
        ...
        //Conversation: Minotaurs
            ...
            if (liveData.gameFlags[FLAG.AMILY_FUCK_COUNTER] == 0) outputText('"<i>I am still a virgin, after all.</i>"<br><br>')
            ...
            if (this.sexForced) outputText(".<br><br>")
        ...
        //Conversation: Fetish Cultists & Zealouts
            ...
            if (this.sexForced) outputText(" and sigh.<br><br>")
        ...
        //Conversation: Imps
            ...
            if (this.sexForced) outputText("to regain her composure before your sexplay.<br><br>")
            else {
                outputText("and leaves.")
                if (liveData.gameFlags[FLAG.AMILY_FOLLOWER] == 0) outputText("  As you set off back to camp,")
        ...
        //Conversation: Shark Girls
            ...
            if (!this.sexForced) outputText("Thanking her for her time, you take your leave of her.<br><br>")
        ...
        //Conversation: Goblins
            ...
            if (!this.sexForced) {
                if (liveData.gameFlags[FLAG.AMILY_FOLLOWER] == 0) outputText("Thanking her for her time, and the warning, you head back to your own camp.<br><br>")
        ...
        //Conversation: What was life in her village like?
            ...
            if (!this.sexForced) outputText(", and, embarrassed and unable to explain why you did that, you politely take your leave.")
        ...
        //Conversation: Who was she before it was all lost?
            ...
            if (!this.sexForced) outputText("  Then you leave her, giving her the chance to mourn her lost family.<br><br>")
        }
        ...
        //Conversation: How will she care for her children?
            ...
            if (!this.sexForced) {
                if (liveData.gameFlags[FLAG.AMILY_FOLLOWER] == 0) outputText("  Then, as if realising you are still here, she waves at you to go, getting up and leaving herself.  Wondering what that was about, you return to camp.<br><br>")
        ...
        switch (liveData.amily.pregnancyEventNum) {
            ...
            case 7: //Amily is heavily pregnant
                ...
                //[Medium Affection]
                    ...
                    outputText("\"<i>It's not that I don't like you, " + liveData.player.name + ", it's just... well, I don't feel comfortable doing that,</i>\" she explains apologetically.<br><br>")
    ...
    static amilyHighAffectionSex() {
        ...
        if (liveData.amily.isPregnant()) outputText("  Even in a slightly pregnant state, she goes surprisingly fast, though she's also rather cautious of her small bump.")
        outputText("<br><br>")
        ...
        if (liveData.amily.isPregnant()) outputText("  Really it seems the only thing between you two now is Amily's small stomach bulge.")

        //(If Amily is herm:
        if (liveData.gameFlags[FLAG.AMILY_WANG_LENGTH] > 0) outputText("  You can feel her erection, hot and solid, pressed between your two bodies.")
        outputText("<br><br>")
        ...
        if (liveData.gameFlags[FLAG.AMILY_WANG_LENGTH] == 0) outputText("sucking on her sensitive clit")
        ...
        if (liveData.amily.isPregnant()) outputText("  As you move your head across her beautiful form, you stop at her growing baby bump and give it a small kiss.")
        outputText("  Your head hovers at her breasts")
        if (liveData.amily.isPregnant()) outputText(", which seem to have grown from the pregnancy,")
        ...
        outputText("As an apology you quickly push your " + liveData.player.cockDescript(x) + " past her dampened nether-lips, and set to work thrusting in and out of your mousegirl lover.")
        ...
        if (!liveData.amily.isPregnant()) outputText("Fill me up with everything you have... I want to be a mother for your children, just as much as I want to be a mother of my own people,")
        ...
        //(if Amily is herm:
        if (liveData.gameFlags[FLAG.AMILY_WANG_LENGTH] > 0) outputText(" and cum spurts into the air between you, splattering on you both")

        outputText("<br><br>")

        if (!liveData.amily.isPregnant()) outputText("\"<i>If that didn't knock me up... I don't care as much as you'd think. It was magnificent either way,")
        ...
        if (!liveData.amily.isPregnant()) outputText("Okay... Well, I'm sure you'll be back. I will need your help again if this doesn't set,")
    ...
    static fuckAmilyPreg() {
        ...
        if (liveData.gameFlags[FLAG.AMILY_WANG_LENGTH] > 0) outputText("  The erection tenting her pants isn't helping.")
        outputText("<br><br>")
        ...
        if (liveData.player.tailType > ENUM.TailType.TAIL_TYPE_NONE) outputText("You even feel Amily wrap her mousy tail around your own, making you chuckle softly into your lovers mouth.  ")
        ...
        if (liveData.gameFlags[FLAG.AMILY_WANG_LENGTH] > 0) outputText(", her own mouse-cock spewing futa-cum all over her belly")
        outputText(".<br><br>")

        if (liveData.gameFlags[FLAG.AMILY_WANG_LENGTH] > 0)
            outputText('"<i>Remember when you said this cock was a bad thing?</i>" you tease, causing Amily to blush and playfully punch you in the shoulder.  "<i>Sh-shut up!  It\'s... it\'s pretty incredible, there, I said it.</i>"<br><br>')
    ...
    static girlyGirlMouseSex() {
        ...
        if (liveData.gameFlags[FLAG.AMILY_TIMES_FUCKED_FEMPC] == 0)
            outputText('Amily stops and lets go of your hand, blushing faintly and looking embarrassed. "<i>So, ah... how do we do this? I... I\'ve never been attracted to another woman before, how does sex even work between us?</i>"<br><br>')
        ...
        if (liveData.gameFlags[FLAG.AMILY_TIMES_FUCKED_FEMPC] == 0)
            outputText('"<i>...I\'m supposed to lick you there, right?</i>" Amily asks, hesitantly. You smirk and promptly give her own sex a long, sloppy lick of your own. She squeaks in shock and then clumsily licks you in return.<br><br>')
        ...
        if (liveData.gameFlags[FLAG.AMILY_TIMES_FUCKED_FEMPC] == 0) outputText('"<i>...I didn\'t know it could feel so good with another woman.... But I was never attracted to women before.</i>" Amily murmurs to herself.<br><br>')
        else
            outputText(
    ...
    static amilyHermOnFemalePC() {
        ...
        if (liveData.player.gender == 3) {
            ...
            //else
            else outputText('"<i>You know, it\'s not all bad, us both being this way... but remember that I want a turn at that, too.</i>" She states, staring hungrily at your ' + liveData.player.multiCockDescriptLight() + ".<br><br>")
        }
        ...
        if (liveData.player.isBiped()) outputText(liveData.player.legs() + " in readiness for her.")
        ...
        //(First time:
        if (liveData.gameFlags[FLAG.AMILY_HERM_TIMES_FUCKED_BY_FEMPC] == 0) outputText('"<i>...I had no idea it would feel like that,</i>" she gasps softly.<br><br>')
        ...
        if (liveData.player.isPregnant()) {
            if (liveData.player.pregnancyType == PREGNANCY_AMILY) outputText("\"<i>Boy, this is weird.  I'm a woman and I'm going to be a dad.")
        ...
        //not preg yet!
            ...
            //PREGGO CHECK HERE
            liveData.player.knockUp(PREGNANCY_AMILY, FLAG.INCUBATION_MOUSE)
    ...
    static amilySexFirstTime() {
        ...
        if (liveData.player.tallness < 60) outputText("Fortunately, being smaller than average means you have less difficulty following her than you might.")
        else if (liveData.player.tallness >= 84) outputText("Your considerable size makes it surprisingly tricky to get around, but you manage to stay with her.")
        outputText(
    ...
    static amilySexFirstTimeTakeCharge() {
        ...
        if (liveData.player.cocks[0].cockLength >= 14) outputText("failing to fit in more than a foot of your cock's length, ")
    ...
    static amilySexFirstTimeKiss() {
        ...
        if (liveData.gameFlags[FLAG.AMILY_NOT_FURRY] == 0) outputText("it's almost like the fur on her cheeks has turned red.")
    ...
    static amilyPreggoChance() {
        ...
        if (UTIL.rand(4) == 0 || liveData.player.cumQ() > UTIL.rand(1000)) {
            liveData.amily.knockUpForce(PREGNANCY_PLAYER, FLAG.INCUBATION_MOUSE - 182, FLAG.INCUBATION_AMILY_EVENT)
        }
    }
    ...
    static amilyLaborWatch() {
        ...
        if (liveData.gameFlags[FLAG.AMILY_NOT_FURRY] == 0) outputText(", mousy figure – pink, hairless and ")
        ...
        if (liveData.gameFlags[FLAG.AMILY_NOT_FURRY] == 0) outputText(" Though hairless like regular infant mice,")
        ...
        if (liveData.gameFlags[FLAG.AMILY_NOT_FURRY] == 0) outputText(" and fur has already begun to cover their formerly-naked bodies.")
    ...
    static amilyLaborHelp() {
        ...
        //([horsecock]
        if (liveData.gameFlags[FLAG.AMILY_NOT_FURRY] == 0) outputText("turns her little muzzle skywards and hisses in pain")
        else outputText("hissing in pain") // This sound a bit wrong for what should look like a human...
        ...
        //([horsecock]
        if (liveData.gameFlags[FLAG.AMILY_NOT_FURRY] == 0) outputText("fur")
        ...
        //([horsecock]
        if (liveData.gameFlags[FLAG.AMILY_NOT_FURRY] == 0) outputText("Their fur has come in too, something triggered by the first drink of their mother's milk.")
        else outputText("Their hair is also starting to grow in an accelerated rate.")
    ...
    static postBirthingEndChoices() {
        ...
        //(if player is female:
        if (liveData.player.gender == 2) outputText("another woman")
        //, if player is herm:
    ...
    static meetAmilyAsACorruptAsshat() {
        ...
        //-(if PC's int >= 40)
        if (liveData.player.inte >= 40) outputText("You begin to formulate a plan, but to put this plan into motion you'll require a Lust Draft and some Goblin Ale. That damn rat is going to rue the day she denied you.<br><br>")
        //-(else)
    ...
    static cookAmilyASnack() {
        ...
        if (liveData.gameFlags[FLAG.CREATE_POTENT_MIXTURE] > 0) {
            ...
            //(else)
                ...
                if (liveData.player.hasCock()) {
                    outputText(liveData.player.sMultiCockDesc() + " jumps to attention ")
                    if (liveData.player.hasVagina()) outputText("and ")
                }
                if (liveData.player.hasVagina()) outputText("your " + liveData.player.vaginaDescript() + " moistens itself ")
                ...
                if (liveData.player.hasCock()) {
                    ...
                    //[(If PC is a herm.)
                    if (liveData.player.hasVagina()) outputText("  Not yet fully sated, you decide that it couldn't hurt to add something 'girly' to the mixture...")
                    outputText("<br><br>")
                }
                //[Female]
        ...
        //First Time Cooking the Drug
            ...
            //(else)
                ...
                if (liveData.player.hasItem(Items.Consumables.LustDraft)) outputText("Lust Draft ")
                ...
                if (liveData.player.hasCock()) outputText(liveData.player.cockDescript(0) + " jumps up to attention")
                if (liveData.player.hasCock() && liveData.player.hasVagina()) outputText(", and your ")
                if (liveData.player.hasVagina()) outputText(liveData.player.vaginaDescript() + " nearly juices itself")
                ...
                if (liveData.player.hasCock()) outputText(liveData.player.cockDescript(0))
                if (liveData.player.hasCock() && liveData.player.hasVagina()) outputText(" and ")
                if (liveData.player.hasVagina()) outputText(liveData.player.vaginaDescript())
                ...
                liveData.player.destroyItems(Items.Consumables.GoblinAle, 1)
                liveData.player.createKeyItem(KeyItem.PotentMixture, 0, 0, 0, 0)
    ...
    static amilyCorrupt1() {
        ...
        //(if PC's speed >= 65)
            ...
            outputText("Panicked, she takes her knife and prepares to fight you. You ready your " + liveData.player.weapon.equipmentName + " and prepare to teach the foolish mouse a lesson.<br><br>")
            //[Proceed to battle.]
    ...
    static amilyCorrupt2() {
        ...
        //(else)
            ...
            if (liveData.player.hasCock()) {
                outputText(liveData.player.cockDescript(0) + " getting hard")
                if (liveData.player.hasVagina()) outputText(" and your ")
            }
            if (liveData.player.hasVagina()) outputText(liveData.player.vaginaDescript() + " growing wet")
            outputText(".<br><br>")
            ...
            outputText("You begin stripping off your " + liveData.player.armor.equipmentName + " and show her your ")
            if (liveData.player.hasCock()) {
                outputText("erect " + liveData.player.cockDescript(0))
                if (liveData.player.hasVagina()) outputText(" and ")
            }
            if (liveData.player.hasVagina()) outputText(" dripping " + liveData.player.vaginaDescript())
    ...
    static amilyCorrupt3() {
        ...
        if (liveData.player.hasCock()) {
            outputText("driving your " + liveData.player.cockDescript(0) + " into erection")
            if (liveData.player.hasVagina()) outputText(" and ")
        }
        if (liveData.player.hasVagina()) outputText(" moistening your " + liveData.player.vaginaDescript())
    ...
    static rapeCorruptAmily1() {
        ...
        if (liveData.player.cockTotal() > 0) {
            if (liveData.player.cockTotal() > 1) outputText(liveData.player.multiCockDescriptLight() + " are")
            else outputText(liveData.player.cockDescript(0) + " is")
            outputText(" already hard")
            if (liveData.player.hasVagina()) outputText(", and your ")
        }
        if (liveData.player.hasVagina()) outputText(liveData.player.vaginaDescript() + " is already wet")
    ...
    static rapeCorruptAmily1Male() {
        ...
        //[(if PC is huge)
        if (liveData.player.cockThatFits(61) == -1) outputText("- you're quite surprised she managed to fit it in at all.")
        else outputText(".")
        outputText(
        ...
        if (liveData.player.balls > 0) outputText(liveData.player.ballsDescriptLight() + " churn")
        else outputText(liveData.player.cockDescript(x) + " throb")
    ...
    static rapeCorruptAmily1Female() {
        ...
        //[(If PC's a squirter)
        if (liveData.player.wetness() >= 5) outputText(", a jet of fluids escape your lower lips and hit her straight in the face; but she pays no mind")
        outputText(
        ...
        if (liveData.player.wetness() >= 5) outputText("She tries to gulp down everything she can, but ultimately a lot of it escapes her mouth and ends up on her face and all around her.  ")
    ...
    static rapeCorruptAmily2Male() {
        ...
        var x = liveData.player.cockThatFits(61)
        if (x < 0) x = 0
        outputText("You unceremoniously shove your " + liveData.player.cockDescript(x) + " into her maw. ")
        //[(if PC has a huge dick)
        if (liveData.player.cockThatFits(61) < 0) outputText("Despite your size, she presses forward to take in as much of you as possible.  ")
        ...
        if (liveData.player.cockThatFits(61) < 0) outputText("is possible.")
        //(else)
        ...
        //[(If PC is huge.)
        if (liveData.player.cockThatFits(61) < 0) outputText("  One of Amily's hands settles on your " + liveData.player.cockDescript(x) + ", stroking whatever she doesn't manage to swallow.")
        outputText("<br><br>")
        ...
        //[(if PC has balls)
        if (liveData.player.balls > 0) outputText("Amily grabs your balls and begins kneading them.  ")
        //(else if PC has a pussy)
        else if (liveData.player.hasVagina()) outputText("Amily shoves her fingers into your " + liveData.player.vaginaDescript() + ".  ")
        ...
        //[(if PC has balls)
        if (liveData.player.balls > 0) outputText("  Just the thought of it is enough to make your balls churn.")
        ...
        if (liveData.player.cumQ() >= 750) outputText("  You feel your enourmous load coming back through her throat and spilling from her mouth and nose, smearing your crotch as you pull away to let her breathe.")
        outputText("<br><br>")
    ...
    static rapeCorruptAmily2Female() {
        ...
        //[(if PC is a squirter)
        if (liveData.player.wetness() >= 5) outputText("  Your juices rocket into her face, painting her " + (liveData.gameFlags[FLAG.AMILY_NOT_FURRY] == 0 ? "muzzle" : "face") + " in your femcum as she giggles with happiness and pleasure.")
        outputText(
        ...
        //[(if PC is a squirter)
        if (liveData.player.wetness() >= 5) outputText(", giving Amily a juice bath; even if the mousy cunt did get better at drinking, there is no way she'd be able to drink all of your fluids")
        outputText(".")
        //(else)
        ...
        //[(if PC is a squirter)
        if (liveData.player.wetness() >= 5) outputText("  Your orgasm lasts much longer than usual. Eventually you release Amily and finish off on top of her head.<br><br>")
    ...
    static rapeCorruptAmily3Male() {
        ...
        //[(if PC is huge)
        if (liveData.player.cockArea(0) >= 61) outputText("  She can't get her breasts all the way around though, still she doesn't stop, determined to do as you ordered.")
        outputText("<br><br>")

        outputText("Amily begins moving her ")
        if (liveData.gameFlags[FLAG.AMILY_NOT_FURRY] == 0) outputText("furry ")
        outputText(
        ...
        outputText("Amily jumps up and rushes to nuzzle at your still erect " + liveData.player.cockDescript(0) + '. "<i>Thank you! Thank you! Thank you!</i>" she says excitedly. Then with a lick of her lips, she opens wide to accept your meat.  ')
        //[(if PC is huge)
        if (liveData.player.cockArea(0) > 50) outputText("You didn't think it was possible, but somehow ")
        ...
        if (liveData.player.balls > 0) outputText("your " + liveData.player.ballsDescriptLight())
        else if (liveData.player.hasVagina()) outputText("your " + liveData.player.vaginaDescript())
        ...
        outputText('"<i>Enough teasing. Get to work now,</i>" you order.  She complies by beginning to move and suckle on your ' + liveData.player.cockDescript(0) + ".<br><br>")
        ...
        //[(if PC has balls)
        if (liveData.player.balls > 0) outputText("  Your " + liveData.player.ballsDescriptLight() + " churn with cum, growing heavier with every nasty detail that goes through your mind.")
        outputText(
        ...
        //[(if PC has large cum amount)
        if (liveData.player.cumQ() >= 750) outputText("  You keep pumping and she keeps drinking; her distended belly doesn't stop growing until she looks heavily pregnant and you're spent.")
        outputText("<br><br>")
    ...
    static rapeCorruptAmily3Female() {
        ...
        //[(if PC is a squirter)
        if (liveData.player.wetness() >= 5) outputText("you show her your enjoyment by spurting a jet of femcum all over her breasts, washing them with sexual lubricant. Amily can't help but smile as she looks at her now glistening breasts.")
        //(else)
        ...
        //[(if PC is a squirter)
        if (liveData.player.wetness() >= 5) outputText("  Her nose bumps against your clit, causing you to release a jet of juices up the mousette's throat. To your surprise, she doesn't spill even a single drop and happily gulps all of it down.")
        outputText(
    ...
    static rapeCorruptAmily3Epilogue() {
        ...
        outputText('"<i>Please! Wait, ' + liveData.player.mf("master", "mistress") + ', please!</i>" Amily yells, you turn around and look back at her. "<i>I want more. Please,</i>" she begs.<br><br>')
    ...
    static rapeCorruptAmily4Male() {
        ...
        //[(if pc has balls)
        if (liveData.player.balls > 0) outputText(" and " + liveData.player.ballsDescriptLight())
        outputText(".<br><br>")
        ...
        if (liveData.player.balls > 0) outputText("your balls")
        else if (liveData.player.hasVagina()) outputText("your pussy")
        ...
        //[(if PC has balls)
        if (liveData.player.balls > 0) outputText("  Sometimes you even feel her nipples brush your balls teasingly.")
        ...
        //[(if PC has balls)
        if (liveData.player.balls > 0) outputText("  One of her hands even begins kneading your balls, attempting to coax even more out of you.")
        outputText("<br><br>")
        ...
        if (liveData.player.cor < 80) {
            ...
            if (liveData.player.cumQ() >= 750) outputText("her belly distended to the point that she looks pregnant and just about ready to give birth.")
            //(else)
        ...
        outputText("Moaning, she drops on fours and crawls toward you to grovel at your " + liveData.player.feet() + ", rubbing her face on the very ground you stand on, and begging all the while.<br><br>")
        ...
        if (liveData.player.isNaga()) outputText("coil your serpentine tail around her head.")
        else if (liveData.player.lowerBody == ENUM.LowerBodyType.LOWER_BODY_TYPE_GOO) outputText("engulf her maw in slime.")
        else outputText("put a " + liveData.player.foot() + " on her head.")
        outputText(
        ...
        //[(if PC has balls)
        if (liveData.player.balls > 0) outputText(" and balls")
        outputText(".<br><br>")
    ...
    static rapeCorruptAmily4Female() {
        ...
        //[(if PC has balls)
        if (liveData.player.balls > 0) outputText("  Pulling back enough to give your balls a teasing lick.")
        outputText("<br><br>")
        ...
        //[(if PC is a squirter)
        if (liveData.player.wetness() >= 5) outputText("wet her face with a small jet of juices.")
        //(else)
        ...
        if (liveData.player.clitLength >= 4) outputText("  One of her hands begins stroking your erect clit as if it was a cock. The pleasure of the act nearly overloads your senses.")
        outputText("<br><br>")
        ...
        //[(if PC is a squirter)
        if (liveData.player.wetness() >= 5) outputText("  Amily barely has to work to drink your juices, your pussy jets them forth with such force that all of them go straight through Amily's mouth and into her throat.")
        //(else)
        ...
        if (liveData.player.cor < 80) {
            ...
            //[(if PC is a squirter)
            if (liveData.player.wetness() >= 5) outputText("her belly distended from the immense amount of femcum she just drank.")
            //(else)
        ...
        outputText("Moaning, she drops on all fours and crawls toward you to grovel at your " + liveData.player.feet() + ", rubbing her face on the very ground you stand on, and begging all the while.<br><br>")
        ...
        outputText("Amily wastes no time and gets to work.  She licks your " + liveData.player.vaginaDescript() + " adoringly, like it was a holy relic for her to worship.")
        //[(if PC has balls)
        if (liveData.player.balls > 0) outputText("  She ignores your balls for the moment, so concentrated in her task, that she barely notices them resting on top of her head.")
        outputText(
    ...
    static rapeCorruptAmily4Epilogue() {
        ...
        if (liveData.gameFlags[FLAG.AMILY_NOT_FURRY] == 0) outputText("her feet warp into a mix of mousy foot-paws and demonic claws, complete with ebony claws and a fourth joint")
        ...
        outputText('Amily grins and replies seductively, "<i>Yes, ' + liveData.player.mf("master", "mistress") + '... Your orders are my pleasure.</i>"<br><br>')
        ...
        if (liveData.player.pregnancyType == PREGNANCY_AMILY) liveData.player.knockUpForce(PREGNANCY_MOUSE, liveData.player.pregnancyIncubation)
    ...
    static amilyBadEnding() {
        ...
        outputText('"<i>This is goodbye, ' + liveData.player.name + '. You may not have been the most noble of [men]... but you did help me in my quest, and I am grateful – no matter how selfish your reasons may have been.</i>"<br><br>')
        outputText(
    ...
    static amilyBecomesFollower() {
        ...
        if (liveData.gameFlags[FLAG.AMILY_MET_AS] == 1) outputText("When we first met, you were just sperm to me, a pure male to father the children I needed. ")
