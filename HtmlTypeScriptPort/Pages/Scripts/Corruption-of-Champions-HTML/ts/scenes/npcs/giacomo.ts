...
abstract class GiacomoScene {
    ...
    static eroticaMenu() {
        ...
        if (liveData.player.hasVagina()) GUI.addButton(1, "Stim-Belt", this.pitchSelfStimulationBelt)
        if (liveData.player.hasVagina()) GUI.addButton(2, "AN Stim-Belt", this.pitchAllNaturalSelfStimulationBelt)
        if (liveData.player.hasCock()) GUI.addButton(3, "Onahole", this.pitchOnahole)
        if (liveData.player.hasCock()) GUI.addButton(4, "D Onahole", this.pitchDeluxeOnahole)
        if (liveData.player.hasCock() && liveData.player.hasVagina()) GUI.addButton(5, "Dual Belt", this.pitchDualStimulationBelt)
        if (liveData.player.hasCock() && liveData.player.hasVagina()) GUI.addButton(6, "AN Onahole", this.pitchAllNaturalOnahole)
    ...
    static ceruleanSuccubusEncounterPart2() {
        GUI.clearOutput();
    spriteSelect(8);
    if (player.gender == 1) {
    ...
    static ceruleanSuccubusEncounterPart3() {
        GUI.clearOutput();
    spriteSelect(8);
    if (player.gender == 1) {
    ...
    static ceruleanSuccubusEncounterPart4() {
        spriteSelect(8);
    if (player.gender == 1) {
        GUI.clearOutput();
    ...
    if (player.gender == 0) {
        ...
        //REPEAT
            ...
            GUI.outputText("\"<i>Ahem.</i>\", the woman says meekly, \"<i>I hate to bother you, but I was sent by the CoC writers and staff to hand you this.</i>\"<br><br>");
