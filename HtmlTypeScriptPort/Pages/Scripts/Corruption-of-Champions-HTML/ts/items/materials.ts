...
class ItemMaterials {
    ...
    constructor() {
        ...
        this.GreenGel.useText = function () {
            outputText("You examine the gel thoroughly, noting it is tough and resiliant, yet extremely pliable. Somehow you know eating it would not be a good idea.")
            return false
        }
        ...
        this.BeeChitin.useText = function () {
            outputText("You look over the chitin carefully but cannot find a use for it. Maybe someone else will know how to use it.")
            return false
        }
