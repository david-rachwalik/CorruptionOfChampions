...
function settingsScreenMain() {
    ...
    clearOutput()
    //Silly Mode
    if (silly) outputText('Silly Mode: <b><font color="#008000">ON</font></b><br>&nbsp; Crazy, nonsensical, and possibly hilarious things may occur.<br><br>')
    else outputText('Silly Mode: <b><font color="#800000">OFF</font></b><br>&nbsp; You\'re an incorrigable stick-in-the-mud with no sense of humour.<br><br>')
    //Time Format
    if (use12Hours) outputText("Time Format: <b>12 hours</b><br>&nbsp; 12-hour format will be used. Time will use AM/PM.<br><br>")
    else outputText("Time Format: <b>24 hours</b><br>&nbsp; 24-hour format will be used.<br><br>")
    //Set buttons
    menu()
...
function toggleSilly() {
    if (silly) silly = false
    else silly = true
    settingsScreenMain()
}
function toggleTimeFormat() {
    if (use12Hours) use12Hours = false
    else use12Hours = true
    settingsScreenMain()
}
//Font settings
