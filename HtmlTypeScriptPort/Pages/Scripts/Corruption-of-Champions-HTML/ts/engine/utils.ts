...
//Format string
function formatStringArray(stringList: string[]) {
...
//Number to words
function num2Text(num: number) {
    if (num >= 0 && num <= 10) return NUMBER_WORDS_NORMAL[num]
    return num.toString()
}
function num2Text2(num: number) {
...
//Capitalize letters
function capitalizeFirstLetter(msg: string) {
...
function lookupKeyItem(id: string) {
    return KeyItemIDs[id]
}

function lookupPerk(id: string) {
    return PerkIDs[id]
}

function lookupStatusEffects(id: string) {
    return StatusEffectIDs[id]
}

//Function
function createCallBackFunction(func: any, arg1: any = undefined, arg2: any = undefined, arg3: any = undefined) {
    if (arg1 != undefined) {
        if (arg2 != undefined) {
            if (arg3 != undefined) {
                return function () {
