...
abstract class GUI {
    ...
    static showUpDown(arrowToDisplay: string, upDown: string): void {
    ...
    static displaySprite(spriteId = ""): void {
    ...
    static removeButton(pos: number): void {
        const buttonEl = document.getElementById("button" + pos)
        if (buttonEl) {
            buttonEl.style.visibility = "hidden"
        }
    ...
    static isButtonVisible(index: number): boolean {
    ...
    static hideMenuButton(menuButton: string): void {
        const menuButtonEl = document.getElementById(menuButton)
        if (menuButtonEl) {
            menuButtonEl.style.visibility = "hidden"
        }
    }
    static showMenuButton(menuButton: string): void {
        const menuButtonEl = document.getElementById(menuButton)
        if (menuButtonEl) {
            menuButtonEl.style.visibility = "visible"
        }
    }
    static setMenuButton(menuButton: string, text: string, func: () => void): void {
        const menuButtonEl = document.getElementById(menuButton)
        if (menuButtonEl) {
    ...
    //Tooltip
    static initializeTooltipEvents(): void {
        for (let i = 0; i < 15; i++) {
