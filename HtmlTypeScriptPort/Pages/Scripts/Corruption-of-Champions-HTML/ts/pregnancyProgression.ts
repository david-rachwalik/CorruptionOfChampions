        ...
        if (player.buttPregnancyIncubation <= 20 * 60) {
            ...
            if (player.cockTotal() == 1) {
                ...
                if (player.dogCocks() == 1)
                    outputText(
                        ", each inhalation making it thicker, harder, and firmer.  You suck in huge lungfuls of air, desperate for more, until your " + player.cockDescript(0) + " is twitching and dripping, its knot swollen to the max.  ",
                        false
                    )
