...
class Goblin extends Creature {
    ...
    goblinTeaseAttack() {
        ...
        if (liveData.monster.refName == "goblin" || liveData.monster.refName == "goblin assassin" || liveData.monster.refName == "Tamani") {
            if (det == 0) GUI.outputText(UTIL.capitalize(liveData.monster.a) + liveData.monster.refName + ' runs her hands along her leather-clad body and blows you a kiss. "<i>Why not walk on the wild side?</i>" she asks.')
            if (det == 1) GUI.outputText(UTIL.capitalize(liveData.monster.a) + liveData.monster.refName + " grabs her heel and lifts it to her head in an amazing display of flexibility.  She caresses her snatch and gives you a come hither look.")
            if (det == 2)
            ...
            if (det == 0) GUI.outputText(UTIL.capitalize(liveData.monster.a) + liveData.monster.refName + ' runs her hands along her metal-clad body and blows you a kiss. "<i>Why not walk on the wild side?</i>" she asks.')
            if (det == 1)
                GUI.outputText(
            ...
            if (det == 1)
                GUI.outputText(
                    UTIL.capitalize(liveData.monster.a) + liveData.monster.refName + " grabs her heel and lifts it to her head in an amazing display of flexibility.  She lifts her loincloth and caresses her snatch and gives you a come hither look."
                )
            if (det == 2)
                GUI.outputText(UTIL.capitalize(liveData.monster.a) + liveData.monster.refName + " bends over, putting on a show and jiggling her heart-shaped ass at you.  She looks over her shoulder and sucks on her finger, batting her eyelashes.")
        } else if (liveData.monster.refName == "goblin elder") {
            if (det == 0) GUI.outputText(UTIL.capitalize(liveData.monster.a) + liveData.monster.refName + ' runs her hands along her bone-clad body and blows you a kiss. "<i>Why not walk on the wild side?</i>" she asks.')
            if (det == 1)
                GUI.outputText(
                    UTIL.capitalize(liveData.monster.a) + liveData.monster.refName + " grabs her heel and lifts it to her head in an amazing display of flexibility.  She lifts her loincloth and caresses her snatch and gives you a come hither look."
                )
    ...
    goblinDrugAttack() {
        ...
        if (color != "blue") {
            if (liveData.monster.refName == "Tamani's daughters") GUI.outputText("Tamani uncorks a glass bottle full of " + color + " fluid and swings her arm, flinging a wave of fluid at you.")
            else GUI.outputText(UTIL.capitalize(liveData.monster.a) + liveData.monster.refName + " uncorks a glass bottle full of " + color + " fluid and swings her arm, flinging a wave of fluid at you.")
        }
        //Drink blue pots
        ...
        if ((liveData.player.findPerk(PerkLib.Evade) >= 0 && UTIL.rand(10) <= 3) || UTIL.rand(100) < liveData.player.spe / 5) {
            ...
            if (color == "red") {
                ...
                if (liveData.player.findStatusEffect(StatusEffects.TemporaryHeat) < 0) liveData.player.createStatusEffect(StatusEffects.TemporaryHeat, 0, multiplier, 0, 0)
            } else if (color == "green") {
                //Green poison
...
abstract class GoblinScene {
    ...
    static victoryAgainstGoblin() {
        ...
        if (liveData.player.canOvipositSpider() || liveData.player.findStatusEffect(StatusEffects.Feeder) >= 0) {
            ...
            if (liveData.player.findStatusEffect(StatusEffects.Feeder) >= 0) GUI.outputText("your nipples ache with the desire to feed her your milk.  Do you feed her milk or leave?</b>")
    ...
    static gatsGoblinBoners() {
        ...
        else if (liveData.player.cockTotal() == 2) GUI.outputText("both of your dicks inside of the panting whore, pushing her forwards violently as you enter her tight snatch and asshole")
        else {
    ...
    static gobboGetsRapedMaleFits() {
        ...
        if (liveData.player.cockArea(x) > liveData.monster.vaginalCapacity() * 0.8) {
            ...
            else if (liveData.player.cocks[0].cockType == ENUM.CockType.HORSE || liveData.player.cocks[0].cockType > 3) GUI.outputText("feeling painfully tight around you")
            ...
            if (liveData.player.cumQ() >= 100)
                GUI.outputText(
                    "  Your enhanced body easily stuffs her full of cream, pudging her belly out slightly, your seed staying embedded in her womb with nowhere to escape, her cunt plugged tightly with your " + liveData.player.cockDescript(x) + "."
                )
        ...
        //(FITS – Get ridden)
            ...
            else if (liveData.player.cocks[0].cockType == ENUM.CockType.HORSE || liveData.player.cocks[0].cockType > 3) GUI.outputText("feeling absolutely perfect around you")
            ...
            GUI.outputText(
                "It's all the encouragement you need, and you break into a run, feeling her lithe form bounce on your " + liveData.player.cockDescript(x) + ", drawing out a cacophony of happy wails and moans.  Her tiny fists dig into your "
            )
            if (liveData.player.biggestTitSize() >= 1) GUI.outputText("tits")
            else GUI.outputText("skin")
            GUI.outputText(
    ...
    static goblinFemaleRape() {
        ...
        // Are you a naga?
            ...
            //[Has fangs:
            if (liveData.player.faceType == ENUM.FaceType.FACE_SNAKE_FANGS) GUI.outputText("You bare your fangs at her and the curiosity disappears. She turns to run, but your tail is faster than she is.")
            //[No fangs:
            else GUI.outputText("You smile at her and the fear disappears. She's still wary though, and you make sure to grab her with your tail before she changes her mind about you.")
            GUI.outputText("<br><br>")
        ...
        // Normal female rape.
            ...
            else if (liveData.player.vaginas[0].vaginalWetness > ENUM.VaginalWetnessType.VAGINA_WETNESS_SLICK) GUI.outputText("coating her face with the proof of your pleasure")
            else if (liveData.player.vaginas[0].vaginalWetness > ENUM.VaginalWetnessType.VAGINA_WETNESS_WET) GUI.outputText("leaving her sticky with your nether-juices")
    ...
    static rapeAGoblinCorruptTooBig() {
        ...
        if (liveData.player.cockTotal() > 1) GUI.outputText("one of your " + liveData.player.multiCockDescriptLight() + " comes to rest on top of her and the fact that it's ")
        ...
        if (liveData.player.cockTotal() > 2) GUI.outputText("Your remaining " + liveData.player.multiCockDescriptLight() + " blast geysers into the air, coating you both in your spunk. ")
    ...
    static goblinCondomed(mode: number) {
        //spriteSelect(24);
        var x = liveData.player.cockThatFits(liveData.monster.vaginalCapacity())
        GUI.clearOutput()
        ...
        if (mode == 0) {
            ...
            GUI.outputText(
                "you tear open the packet and slide the latex condom over your " + liveData.player.cockDescript(x) + ", marveling at how transparent and shiny it is. You don't think the goblin will be able to notice that until it's too late!"
            )
        }
    ...
    static goblinDriderEggs() {
        ...
        //[if (femininity > 50)
        if (liveData.player.femininity > 50) GUI.outputText("<br><br>\"<i>W-what?  You- I haven't got any, you stupid bitch!  This your idea of fun, jackass?  Kicking people when they're down?!</i>\"")
        //[if (femininity < 51)
        else GUI.outputText("<br><br>\"<i>W-what?  You- I haven't got any, you stupid bastard!  This your idea of fun, jackass?  Kicking people when they're down?!</i>\"")
    ...
    static goblinRapesPlayer() {
        ...
        if (liveData.player.findPerk(PerkLib.BimboBrains) >= 0 || liveData.player.findPerk(PerkLib.FutaFaculties) >= 0) {
            ...
            if (liveData.player.hasVagina()) {
                ...
                //--[If nipplecunts]
                if (liveData.player.hasFuckableNipples()) GUI.outputText(", fingering your wet nipplecunts and pinching the now-puffy areolas tightly, sending uncontrollable waves of pleasure from your chest to your groin.")
                //-[If not]
        ...
        if (liveData.player.cockTotal() > 0) {
            ...
            else if (liveData.player.cocks[0].cockLength <= 14) GUI.outputText("as your bulge grows upwards between her ass-cheeks and lays against the small of her back")
        ...
        if (liveData.player.hasVagina()) {
            ...
            if (liveData.player.vaginas[0].vaginalWetness <= ENUM.VaginalWetnessType.VAGINA_WETNESS_NORMAL) GUI.outputText("The lips of your sex engorge, becoming almost as puffy as the goblin's.  ")
            else if (liveData.player.vaginas[0].vaginalWetness < ENUM.VaginalWetnessType.VAGINA_WETNESS_DROOLING) GUI.outputText("Feminine lubricant soaks into the back of your " + liveData.player.armorName + ".  ")
        ...
        if (liveData.player.totalCocks() > 0 && (!liveData.player.hasVagina() || UTIL.rand(2) == 0)) {
            ...
            if (liveData.player.cockArea(0) > liveData.monster.vaginalCapacity()) {
                ...
                if (liveData.player.cumQ() > 100) GUI.outputText("  Your loads keep coming, until the jism begins to backwash out of her love tunnel to soak her body and your midsection.")
                if (liveData.player.cumQ() >= 250) GUI.outputText("  Her belly distorts visibly as her uterus is packed full of cum, making her look heavily pregnant already.  She coos in delight at the sight of her swollen abdomen.")
            ...
            //Dick fits...
                ...
                if (liveData.player.cor < 50) GUI.outputText("You shake your head, trying to get away from the sweet-smelling drug, but she tilts it up, pouring most of it into your throat.")
                ...
                if (liveData.player.balls > 0) GUI.outputText("cup your " + liveData.player.ballsDescriptLight() + " in one hand, squeezing gently as the drug begins to affect them")
        ...
        // Female rape, or herm pussy rape.
            ...
            if (liveData.player.cor < 33) GUI.outputText("You shake your head violently, clearly indicating 'No', but when you open your mouth to vocalize your complaint, your lips are swiftly plugged with bulging sex-toy.")
            else if (liveData.player.cor < 66) GUI.outputText("You open your mouth to stammer out your concerns, but she plugs the hole with the floppy artificial dong, turning your speech into surprised muffles.")
            else GUI.outputText("You lick your lips coyly then open your mouth into a welcoming 'O'.  The sex-toy slips straight into the hole, muffling the sounds of your happiness with the arrangement.")
            GUI.outputText(
