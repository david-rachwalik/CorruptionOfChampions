...
abstract class CombatTeases {
    static teaseMain(justText = false) {
        ...
        if (liveData.monster.refName.indexOf("minotaur") != -1) {
            if (liveData.player.hasVagina() && liveData.player.lactationQ() >= 500 && liveData.player.biggestTitSize() >= 6 && liveData.player.cowScore() >= 3 && liveData.player.tailType == ENUM.TailType.TAIL_TYPE_COW) select = 43
        }
        switch (select) {
            //0 butt shake
            case 0:
            ...
            case 1:
                ...
                if (liveData.player.breastRows.length == 1) {
                    ...
                    if (liveData.player.lust >= 50) GUI.outputText(" Your " + liveData.player.nippleDescript(0) + "s seem to demand " + liveData.monster.hisHer + " attention.")
                }
                //Multirow
                if (liveData.player.breastRows.length > 1) {
            ...
            case 6:
                ...
                if (liveData.monster.plural) GUI.outputText(UTIL.capitalizeFirstLetter(liveData.monster.a) + liveData.monster.refName + "' gazes are riveted on your groin as you run your fingers up and down your folds seductively.")
                else GUI.outputText(UTIL.capitalizeFirstLetter(liveData.monster.a) + liveData.monster.refName + "'s gaze is riveted on your groin as you run your fingers up and down your folds seductively.")
                if (liveData.player.clitLength > 3) GUI.outputText(" You smile as your " + liveData.player.clitDescript() + " swells out from the folds and stands proudly, begging to be touched.")
                ...
                if (liveData.player.cockTotal() > 0) GUI.outputText(" Meanwhile, " + liveData.player.sMultiCockDesc() + " bobs back and forth with your gyrating hips, adding to the display.")
                //BONUSES!
                if (liveData.player.hasCock()) {
                    if (liveData.player.findPerk(PerkLib.BulgeArmor) >= 0) damage += 5
                    penis = true
            ...
            case 8:
                ...
                else GUI.outputText(UTIL.capitalizeFirstLetter(liveData.monster.a) + liveData.monster.refName + " will probably enjoy the show, but you feel a bit silly doing this.")
            ...
            case 9:
                ...
                if (liveData.player.findPerk(PerkLib.BroBrains) >= 0) GUI.outputText(UTIL.capitalizeFirstLetter(liveData.monster.a) + liveData.monster.refName + " can't resist such a heroic pose!")
            ...
            //11 Show off dick
            case 11:
                if (liveData.silly && UTIL.rand(2) == 0) GUI.outputText('You strike a herculean pose and flex, whispering, "<i>Do you even lift?</i>" to ' + liveData.monster.a + liveData.monster.refName + ".")
                else {
                    GUI.outputText(
                        "You open your " +
                            liveData.player.armor.equipmentName +
            ...
            case 13:
                ...
                if (liveData.player.biggestLactation() >= 1) {
                    GUI.outputText(
                        " Your other hand moves to expose your " + liveData.player.chestDesc() + ", cupping and squeezing a stream of milk to leak down the front of your " + liveData.player.armor.equipmentName + '. "<i>Help a mommy out.</i>"<br><br>'
                    )
                    chance += 2
                    damage += 4
                }
            ...
            case 40:
                ...
                else GUI.outputText(" Your tails fan out, twisting and whipping sensually, sliding up and down your " + liveData.player.legs() + " and framing your rear nicely as you slowly lift your " + liveData.player.armor.equipmentName + ".")
        ...
        if (UTIL.rand(100) <= chance + UTIL.rand(bonusChance)) {
            ...
            if (liveData.gameFlags[FLAG.PC_FETISH] >= 1 /* && !urtaQuest.isUrta()*/) {
                ...
                else GUI.outputText("<br>If you keep exposing yourself you're going to get too horny to fight back. This exhibitionism fetish makes it hard to resist just stripping naked and giving up. ")
