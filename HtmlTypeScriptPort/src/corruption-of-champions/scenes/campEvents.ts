...
export function slimeBadEnd2() {
  ...
  GUI.outputText(
    "<br><br>Every year thereafter the new champion is greeted with a slippery prison, forced to orgasm and feed the slime-queen for the rest of their natural life.  Most of them stop minding by the second day, too drunk on her breast-milk and all the drugs she's mixed into it.",
  );
  COMBAT.gameOver();
}
