// The export functions in this file allow for keyboard input.
...
export function keyDepress(e: KeyboardEvent) {
  // let event = window.event ? window.event : e
  // switch (event.key) {
  switch (e.key) {
    case 'Shift':
...
export function pressButtonByKey(index: number): void {
...
export function pressNextByKey(): void {
...
export function pressYesByKey(): void {
  const button = document.getElementById('button0');
...
export function pressNoByKey(): void {
